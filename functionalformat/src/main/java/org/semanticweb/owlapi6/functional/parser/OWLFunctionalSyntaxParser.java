...
import org.semanticweb.owlapi6.vocab.*;
import java.net.*;
import java.util.*;
import org.semanticweb.owlapi6.utilities.*;
import org.semanticweb.owlapi6.utility.*;
...
OWLOntologyID id = df.getOWLOntologyID(ontologyIRI, versionIRI);
