...
public class RioOntologyStorer extends AbstractOWLOntologyStorer
{
    ...
    /**
     * If the {@link Writer} is null, then it is acceptable to return an in memory
     * {@link StatementCollector}.
     * 
     * This method will only be called from storeOntology if setRioHandler is not called with a
     * non-null argument.
     * 
     * @param format
     *            The {@link RDFFormat} for the resulting {@link RDFHandler}, if the writer
     *            parameter is not null.
     * @param writer
     *            The {@link Writer} for the resulting RDFHandler, or null to create an in-memory
     *            collection.
    ...
    /**
     * If the {@link OutputStream} is null, then it is acceptable to return an in memory
     * {@link StatementCollector}.
     * 
     * This method will only be called from storeOntology if setRioHandler is not called with a
     * non-null argument.
     ...
     *            parameter is not null.
     * @param outputStream
     *            The {@link OutputStream} for the resulting RDFHandler, or null to create an
    ...
    @Override
    protected void storeOntology(final OWLOntology ontology, final Writer writer, final OWLOntologyFormat format)
