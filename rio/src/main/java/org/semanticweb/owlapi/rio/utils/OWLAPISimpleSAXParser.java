 ...
 * of XML documents. The OWLAPISimpleSAXParser can parse simple XML documents;
 * it doesn't support processing instructions or elements that contain both
...
public class OWLAPISimpleSAXParser {
     ...
     *        whether leading and trailing whitespace characters in text
     *        elements should be preserved. Such whitespace characters are
    ...
    /**
     * @return Checks whether leading and trailing whitespace characters in text
