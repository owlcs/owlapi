 ...
 * OWLAPISimpleSAXParser can parse simple XML documents; it doesn't support processing instructions
...
public class OWLAPISimpleSAXParser {
     ...
     * Such whitespace characters are discarded by default.
     * 
     * @param preserveWhitespace preserve white spaces
     */
