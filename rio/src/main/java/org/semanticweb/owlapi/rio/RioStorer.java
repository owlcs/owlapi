...
public class RioStorer extends AbstractOWLStorer {
   ...
   * @param outputStream The {@link OutputStream} for the resulting RDFHandler, or null to create an
   * in-memory collection.
   * @return An implementation of the {@link RDFHandler} interface, based on the parameters given to
   * this method.
