...
public class OWLAPIRDFFormat extends RDFFormat {
    ...
    public static final OWLAPIRDFFormat MANCHESTER_OWL =
        new OWLAPIRDFFormat("Manchester OWL Syntax", Arrays.asList("text/owl-manchester"),
            Charset.forName("UTF-8"), Arrays.asList("omn"), SUPPORTS_NAMESPACES, NO_CONTEXTS,
    ...
    public static final OWLAPIRDFFormat OWL_XML = new OWLAPIRDFFormat("OWL/XML Syntax",
        Arrays.asList("application/owl+xml"), Charset.forName("UTF-8"), Arrays.asList("owx"),
    ...
    public static final OWLAPIRDFFormat OWL_FUNCTIONAL =
        new OWLAPIRDFFormat("OWL Functional Syntax", Arrays.asList("text/owl-functional"),
            Charset.forName("UTF-8"), Arrays.asList("ofn"), SUPPORTS_NAMESPACES, NO_CONTEXTS,
