...
public class OWLRDFVocabularyTestCase {
    ...
    public void getPrefixedName_shouldStartWithOWLRDFPrefixName() {
        assertThat(vocabulary.getPrefixedName(), startsWith(vocabulary.getNamespace().getPrefixName()));
    }

    @Test
    public void getIRI_shouldReturnAnIRIThatStartsWithOWLRDFPrefix() {
        assertThat(vocabulary.getIRI().toString(), startsWith(vocabulary.getNamespace().getPrefixIRI()));
    }
}
