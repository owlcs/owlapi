...
public class OWLOntologyChangeRecordTest {
    ...
    public void testSerializeChangeRecord() throws Exception {
        OWLOntologyID id1 = new OWLOntologyID(optional(IRI.create("urn:test#", "a")), optional(IRI.create("urn:test#",
            "v1")));
        OWLOntologyID id2 = new OWLOntologyID(optional(IRI.create("urn:test#", "a")), optional(IRI.create("urn:test#",
            "v2")));
