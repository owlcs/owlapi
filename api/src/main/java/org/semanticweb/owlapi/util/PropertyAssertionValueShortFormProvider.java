...
public class PropertyAssertionValueShortFormProvider implements ShortFormProvider {
   ...
   * given data property there may be a list of preferred languages for the values of that property
   * Languages at the start of the list have a higher priority over languages at the end of the
   * list. This parameter may be empty but it must not be {@code null}.
