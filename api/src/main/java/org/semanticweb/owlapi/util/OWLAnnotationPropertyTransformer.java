...
public class OWLAnnotationPropertyTransformer implements OWLObjectVisitor, SWRLObjectVisitor {
  ...
  public void visit(OWLClassAssertionAxiom ax) {
    obj = df
        .getOWLClassAssertionAxiom(dup(ax.getClassExpression()), dup(ax.getIndividual()), anns(ax));
  }
  ...
  public void visit(OWLAnnotationAssertionAxiom ax) {
    ...
    obj = df
        .getOWLAnnotationAssertionAxiom(prop.asOWLAnnotationProperty(), subject, value, anns(ax));
  }
  ...
  public void visit(OWLInverseObjectPropertiesAxiom ax) {
    obj = df
        .getOWLInverseObjectPropertiesAxiom(dup(ax.getFirstProperty()), dup(ax.getSecondProperty()),
            anns(ax));
  }
  ...
  public void visit(OWLNegativeDataPropertyAssertionAxiom ax) {
    obj = df.getOWLNegativeDataPropertyAssertionAxiom(dup(ax.getProperty()), dup(ax.getSubject()),
        dup(ax
            .getObject()), anns(ax));
  }
  ...
  public void visit(OWLNegativeObjectPropertyAssertionAxiom ax) {
    obj = df.getOWLNegativeObjectPropertyAssertionAxiom(dup(ax.getProperty()), dup(ax.getSubject()),
        dup(ax
            .getObject()), anns(ax));
  }
  ...
  public void visit(OWLSubPropertyChainOfAxiom ax) {
    obj = df
        .getOWLSubPropertyChainOfAxiom(asList(ax.getPropertyChain().stream().map(this::dup)), dup(ax
  ...
  public void visit(OWLSubObjectPropertyOfAxiom ax) {
    obj = df.getOWLSubObjectPropertyOfAxiom(dup(ax.getSubProperty()), dup(ax.getSuperProperty()),
        anns(ax));
  }
  ...
  public void visit(OWLDataMaxCardinality ce) {
    obj = df
        .getOWLDataMaxCardinality(ce.getCardinality(), dup(ce.getProperty()), dup(ce.getFiller()));
  }

  @Override
  public void visit(OWLDataMinCardinality ce) {
    obj = df
        .getOWLDataMinCardinality(ce.getCardinality(), dup(ce.getProperty()), dup(ce.getFiller()));
  }
  ...
  public void visit(SWRLObjectPropertyAtom node) {
    obj = df
        .getSWRLObjectPropertyAtom(dup(node.getPredicate()), dup(node.getFirstArgument()), dup(node
            .getSecondArgument()));
  }
  ...
  public void visit(SWRLDataPropertyAtom node) {
    obj = df
        .getSWRLDataPropertyAtom(dup(node.getPredicate()), dup(node.getFirstArgument()), dup(node
            .getSecondArgument()));
  }
  ...
  public void visit(OWLHasKeyAxiom ax) {
    obj = df
        .getOWLHasKeyAxiom(dup(ax.getClassExpression()), set(ax.propertyExpressions()), anns(ax));
  }
  ...
  public void visit(OWLAnnotationPropertyDomainAxiom ax) {
    ...
    if (prop.isObjectPropertyExpression()) {
      ...
      LOGGER.warn(
          ...
          domain);
      obj = df
          .getOWLObjectPropertyDomainAxiom(prop.asOWLObjectProperty(), d, asList(ax.annotations()));
      return;
    } else if (prop.isDataPropertyExpression()) {
  ...
  public void visit(OWLAnnotationPropertyRangeAxiom ax) {
    ...
    if (prop.isObjectPropertyExpression()) {
      ...
      LOGGER.warn(
          ...
          range);
      obj = df
          .getOWLObjectPropertyRangeAxiom(prop.asOWLObjectProperty(), d, asList(ax.annotations()));
      return;
    } else if (prop.isDataPropertyExpression()) {
      // turn to data property domain
  ...
  public void visit(OWLSubAnnotationPropertyOfAxiom ax) {
    ...
    if (sub.isObjectPropertyExpression() || sup.isObjectPropertyExpression()) {
      ...
      if (sub.isOWLObjectProperty() && sup.isOWLObjectProperty()) {
        obj = df
            .getOWLSubObjectPropertyOfAxiom(sub.asOWLObjectProperty(), sup.asOWLObjectProperty(),
                asList(ax
                    .annotations()));
      } else {
