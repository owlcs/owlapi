...
public class OntologyIRIShortFormProvider implements IRIShortFormProvider {
   ...
   * @return The short form with the extension removed if it was present, or the original short form
   ...
   * @return {@code true} if the specified path element is a candidate short form, otherwise {@code
   * false}.
   */
