...
public class AnnotationValueShortFormProvider implements ShortFormProvider {
   ...
   * have a higher priority and are selected over annotations with properties that appear towards or
   * at the end of the list.
   * @param preferredLanguageMap A map which maps annotation properties to preferred languages. For
   * any given annotation property there may be a list of preferred languages. Languages at the
   * start of the list have a higher priority over languages at the end of the list. This parameter
   ...
   * short form for an entity that does not have any annotations. This provider will also be used in
   * the case where the value of an annotation is an {@code OWLIndividual} for providing the short
