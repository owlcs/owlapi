...
public class BidirectionalShortFormProviderAdapter extends CachingBidirectionalShortFormProvider {
   ...
   * @param shortFormProvider The short form provider that should be used to generate the short
   * forms of the referenced entities.
   * @param man This short form provider will track changes to ontologies. The provider will listen
   * for ontology changes and update the cache of entity--shortform mappings based on whether the
   * specified ontologies contain references to entities or not.
   */
