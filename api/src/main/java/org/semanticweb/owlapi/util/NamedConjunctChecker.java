...
public class NamedConjunctChecker {
   ...
   * @return A set containing the named conjuncts of the specified expression. If the expression is
   * not a named class or an intersection then the set will definitely be empty.
   */
