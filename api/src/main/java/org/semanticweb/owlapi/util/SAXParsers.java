...
public final class SAXParsers {
   ...
   * @return new SaxParser, intialized with optional declaration handler and larger entity expansion
   * limit
   */
  ...
  protected static void addHandler(@Nullable DeclHandler handler, SAXParser parser) {
    if (handler != null) {
      try {
        ...
        LOGGER.warn(
            DECLARATION_HANDLER + ERROR_TEMPLATE + " Entity declarations will not be roundtripped.",
