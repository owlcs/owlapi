...
public abstract class RDFNode implements Serializable, Comparable<RDFNode>,
   ...
   *
   * @return {@code true} if this is a resource node (i.e. {@code isLiteral} returns {@code false})
   * and the node is anonymous, or {@code false} if this is a resource node and is not anonymous.
   */
