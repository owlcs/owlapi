...
public interface OWLParser extends Serializable {
   ...
   * through {@link OWLOntologyManager#makeLoadImportRequest(org.semanticweb.owlapi.model.OWLImportsDeclaration,
   * OWLOntologyLoaderConfiguration) makeLoadImportRequest()}.
   *
   ...
   * @throws OWLOntologyChangeException if there was a problem updating {@code ontology}. Typically
   * this depends on the document being parsed containing an ontology with an ontology IRI clashing
   ...
   * axioms to {@code ontology}. Implementors of this method should load imported ontologies through
   * {@link OWLOntologyManager#makeLoadImportRequest(org.semanticweb.owlapi.model.OWLImportsDeclaration,
   * OWLOntologyLoaderConfiguration) makeLoadImportRequest()}.
   *
   ...
   * OWLOntologyChangeException if there was a problem updating {@code ontology}. Typically this
   * depends on the document being parsed containing an ontology with an ontology IRI clashing with
   * one already loaded.
   * @throws UnloadableImportException if one or more imports could not be loaded.
   */
