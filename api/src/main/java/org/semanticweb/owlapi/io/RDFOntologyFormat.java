...
public abstract class RDFOntologyFormat extends PrefixOWLOntologyFormat {
     ...
     * @return {@code false} if the entity is built in. {@code false} if the ontology doesn't contain
     *         the entity in its signature. {@code false} if the entity is already declared in the imports closure
     *         of the ontology. {@code false} if the transitive imports does not contain the ontology but the entity
     *         is contained in the signature of one of the imported ontologies, {@code true} if none of the previous conditions
     *         are met.
     */
     ...
     * @param addMissingTypes {@code true} if untyped entities should automatically be typed during rendering,
     * otherwise {@code false}.
     */
