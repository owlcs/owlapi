...
public abstract class AbstractOWLRenderer implements OWLRenderer {
   ...
   * @param writer The writer that should be used to write the ontology. Note that this writer need
   * not be wrapped with a {@code BufferedWriter} because this is taken care of by this abstract
   * implementation.
