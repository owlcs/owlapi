...
public final class XMLUtils {
  ...
  public static boolean isXMLNameStartCharacter(int codePoint) {
    return codePoint == ':' || codePoint >= 'A' && codePoint <= 'Z' || codePoint == '_'
        || codePoint >= 'a'
        && codePoint <= 'z' || codePoint >= 0xC0 && codePoint <= 0xD6
   ...
   *
   * @param codePoint The code point of the character to be tested. For UTF-8 and UTF-16 characters
   * the code point corresponds to the value of the char that represents the character.
   * @return {@code true} if {@code codePoint} is an XML name start character, otherwise {@code
   * false}
   */
   ...
   * @param codePoint The code point of the character to be tested. For UTF-8 and UTF-16 characters
   * the code point corresponds to the value of the char that represents the character.
   * @return {@code true} if {@code codePoint} is a NCName start character, otherwise {@code false}.
   */
   ...
   * @return {@code true} if the character sequence {@code s} has a suffix that is an NCName.
   */
   ...
   * an NCName, or -1 if the character sequence {@code s} does not have a suffix that is an NCName.
   */
   ...
   */
  public static StringBuilder escapeXML(char[] chars, int start, int count,
   ...
   *
   * @param sb The string builder to escape.
   */
