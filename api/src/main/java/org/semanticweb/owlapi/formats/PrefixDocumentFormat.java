 ...
 * @since 2.0.0
 */
public class PrefixDocumentFormat extends OWLDocumentFormat implements
        PrefixManager {
     ...
     */
    public PrefixDocumentFormat(@Nonnull PrefixManager manager) {
