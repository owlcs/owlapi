...
public class MakeClassesMutuallyDisjoint extends AbstractCompositeOntologyChange {
   ...
   * @param targetOntology The target ontology which the changes will be applied to. {@code true} if
   * multiple disjoint classes axioms should be used to make the class expressions pairwise disjoint
   * (for backwards compatibility with OWL 1.0), or {@code false} if one disjoint classes axiom
