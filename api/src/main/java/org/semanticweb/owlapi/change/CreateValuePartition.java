...
public class CreateValuePartition extends AbstractCompositeOntologyChange {
    ...
    public CreateValuePartition(@Nonnull OWLDataFactory dataFactory,
        @Nonnull OWLClass valuePartitionClass, @Nonnull Set<OWLClass> valuePartionClasses,
        @Nonnull OWLObjectProperty valuePartitionProperty, @Nonnull OWLOntology targetOntology) {
        super(dataFactory);
    ...
    private void generateChanges(@Nonnull OWLOntology targetOntology,
        @Nonnull Set<OWLClass> valuePartitionClasses, @Nonnull OWLClass valuePartitionClass,
        ...
        addChange(new AddAxiom(targetOntology,
            getDataFactory().getOWLDisjointClassesAxiom(valuePartitionClasses)));
        // 3) Add a covering axiom to the value partition
        OWLClassExpression union = getDataFactory().getOWLObjectUnionOf(valuePartitionClasses);
        addChange(new AddAxiom(targetOntology,
            getDataFactory().getOWLSubClassOfAxiom(valuePartitionClass, union)));
        ...
        addChange(new AddAxiom(targetOntology, getDataFactory()
            .getOWLObjectPropertyRangeAxiom(valuePartitionProperty, valuePartitionClass)));
    }
}
