...
public class EntitySearcher {
  ...
  public static <P extends OWLPropertyExpression> Stream<P> getDisjointProperties(P e,
    ...
    if (e.isObjectPropertyExpression()) {
      return Searcher
          .different(ontology.disjointObjectPropertiesAxioms(e.asObjectPropertyExpression()));
    }
    if (e.isDataPropertyExpression()) {
   ...
   * @param e entity
   * @param ontology The ontology that will be searched for axioms
   * @param includeImports If {@code true} then axioms in the imports closure will also be returned,
   * if {@code false} then only the axioms in the specified ontology will be returned.
   * @return The axioms in the specified ontology whose signature contains this entity.
   */
  public static Stream<OWLAxiom> getReferencingAxioms(OWLEntity e, OWLOntology ontology,
   ...
   * property
   * @return A set of {@code OWLClassExpression}s corresponding to the domains of this property (the
   * domain of the property is essentially the intersection of these class expressions).
   */
   ...
   *
   * @param e entity
   * @param ontology The ontology to be searched for axioms which assert a range for this property.
   ...
   * @return A set of ranges for this property, which have been asserted by axioms in the specified
   * ontologies.
   */
