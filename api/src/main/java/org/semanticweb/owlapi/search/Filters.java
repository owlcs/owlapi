...
public class Filters {
   ...
   * key.
   */
  public static final OWLAxiomSearchFilter subClassWithSuper = new AxiomFilter<>(
   ...
   * key.
   */
  public static final OWLAxiomSearchFilter subClassWithSub = new AxiomFilter<>(
      AxiomType.SUBCLASS_OF,
   ...
   * input key.
   *
   * @deprecated use the OWLOntology:getAnnotationAssertionAxioms() in place of this filter as it is
   * much faster, thanks to indexing.
   */
  @Deprecated
