...
public interface NodeSet<E extends OWLObject> extends Iterable<Node<E>> {
   ...
   * @return {@code true} if this {@code NodeSet} contains a {@code Node} that contains the entity,
   * {@code e}, and {@code false} if this {@code NodeSet} does not contain a {@code Node} that
   * contains the entity, {@code e}.
   */
   ...
   *
   * @return The set of {@code Node}s contained in this {@code NodeSet}. Note that this set will be
   * an unmodifiable set.
