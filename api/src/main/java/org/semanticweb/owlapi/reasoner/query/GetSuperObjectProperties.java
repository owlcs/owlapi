...
import org.semanticweb.owlapi.reasoner.query.HierarchyNode;
 ...
 * Date: 18-Mar-2009
 */
public class GetSuperObjectProperties extends GetSupersQuery<OWLObjectPropertyExpression, OWLObjectPropertyExpression> {

    public GetSuperObjectProperties(OWLObjectPropertyExpression subject,
                                    boolean direct) {
