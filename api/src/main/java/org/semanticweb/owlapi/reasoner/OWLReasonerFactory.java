...
public interface OWLReasonerFactory {
   ...
   * is created.
   * @return The reasoner that reasons over the imports closure of the specified ontology. Note that
   * calling this method multiple times with the same manager and ontology will return <b>fresh</b>
   ...
   * @throws NullPointerException if any of {@code manager}, {@code ontology} or {@code config} are
   * {@code null}.
   */
