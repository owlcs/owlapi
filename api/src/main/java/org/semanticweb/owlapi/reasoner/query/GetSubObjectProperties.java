 ...
 * Date: 18-Mar-2009
 */
public class GetSubObjectProperties extends GetSubsQuery<OWLObjectPropertyExpression, OWLObjectPropertyExpression> {

    public GetSubObjectProperties(OWLObjectPropertyExpression subject,
                                       boolean direct) {
