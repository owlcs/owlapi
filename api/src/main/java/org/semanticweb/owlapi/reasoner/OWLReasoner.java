 ...
 * {@link org.semanticweb.owlapi.reasoner.BufferingMode} of the reasoner is
 * {@link org.semanticweb.owlapi.reasoner.BufferingMode#BUFFERING} then ontology changes are stored
 ...
 * {@link org.semanticweb.owlapi.reasoner.Node}s. A {@code Node} contains entities. <br>
 ...
 * convenience methods on {@link NodeSet} and {@link org.semanticweb.owlapi.reasoner.Node} that can
 * be used to directly access the entities in a {@code NodeSet} without having to iterate over the
 * nodes and entities in a {@code NodeSet}. For example, a "plain" set of classes contained inside
 * the {@code Nodes} contained inside a {@code NodeSet} can easily be obtained using the
 ...
 * boolean=true) method on {@code OWLReasoner} and then we could use the
 * {@link NodeSet#getFlattened()} method on the returned {@code NodeSet} . <br>
 ...
 * </ul>
 * Note that {@link org.semanticweb.owlapi.reasoner.ReasonerInternalException} may be throw by any
...
public interface OWLReasoner {
     ...
     * buffering mode is {@link org.semanticweb.owlapi.reasoner.BufferingMode#NON_BUFFERING} then
    ...
    /**
     * Returns the set of {@link org.semanticweb.owlapi.reasoner.InferenceType}s that are
     ...
     * an {@link org.semanticweb.owlapi.reasoner.InconsistentOntologyException} even if the root
     * ontology imports closure is inconsistent.
     * 
     * @return {@code true} if the imports closure of the root ontology is consistent, or
     *         {@code false} if the imports closure of the root ontology is inconsistent.
     * @throws ReasonerInterruptedException if the reasoning process was interrupted for any
     *         particular reason (for example if reasoning was cancelled by a client process).
     * @throws TimeOutException if the reasoner timed out during a basic reasoning operation. See
     *         {@link #getTimeOut()}.
     ...
     */
    @Nonnull
    NodeSet<OWLClass> getSubClasses(@Nonnull OWLClassExpression ce, boolean direct);
     ...
     */
    @Nonnull
    NodeSet<OWLClass> getSuperClasses(@Nonnull OWLClassExpression ce, boolean direct);
     ...
     *         axioms then the node representing and containing {@code owl:Thing}, i.e. the top
     ...
     *         {@code EquivalentClasses(D, ObjectComplementOf(ce))} or
     ...
     *         entails {@code DirectSubObjectPropertyOf(P, pe)}. <br>
     ...
     *         axioms entails {@code DirectSubObjectPropertyOf(pe, P)}. <br>
     *         If direct is {@code false}, a {@code NodeSet} of <a href="#SPE">simplified object
     *         property expressions</a>, such that for each <a href="#SPE">simplified object
     *         property expression</a>, {@code P}, in the {@code NodeSet}, the set of reasoner
     ...
     *         {@code EquivalentObjectProperties(P, ObjectPropertyComplementOf(pe))} or
     ...
     *         {@code getSuperClasses(ObjectSomeValuesFrom(pe owl:Thing), true)} . <br>
     ...
     */
    @Nonnull
    NodeSet<OWLClass> getObjectPropertyDomains(@Nonnull OWLObjectPropertyExpression pe,
        boolean direct);
     ...
     */
    @Nonnull
    NodeSet<OWLClass> getObjectPropertyRanges(@Nonnull OWLObjectPropertyExpression pe,
        boolean direct);
     ...
     *         the {@code NodeSet} the set of reasoner axioms entails
     *         {@code DirectSubDataPropertyOf(P, pe)}. <br>
     ...
     */
    @Nonnull
    NodeSet<OWLDataProperty> getSubDataProperties(@Nonnull OWLDataProperty pe, boolean direct);
     ...
     * @return If direct is {@code true}, a {@code NodeSet} such that for each property {@code P} in
     *         the {@code NodeSet} the set of reasoner axioms entails
     *         {@code DirectSubDataPropertyOf(pe, P)}. <br>
     *         If direct is {@code false}, a {@code NodeSet} such that for each property {@code P}
     *         in the {@code NodeSet} the set of reasoner axioms entails
     ...
     */
    @Nonnull
    NodeSet<OWLDataProperty> getSuperDataProperties(@Nonnull OWLDataProperty pe, boolean direct);
     ...
     *         {@code EquivalentDataProperties(pe P)}. <br>
     ...
     *         {@code owl:topDataProperty}, i.e. the top node, will be returned <br>
     *         .
     * @throws InconsistentOntologyException if the imports closure of the root ontology is
     *         inconsistent
     ...
     */
    @Nonnull
    Node<OWLDataProperty> getEquivalentDataProperties(@Nonnull OWLDataProperty pe);
     ...
     *         the {@code NodeSet} the set of reasoner axioms entails
     *         {@code EquivalentDataProperties(P, DataPropertyComplementOf(pe))} or
     ...
     */
    @Nonnull
    NodeSet<OWLDataProperty> getDisjointDataProperties(@Nonnull OWLDataPropertyExpression pe);
     ...
     *         If {@code direct} is {@code true}: then if {@code N} is not empty then the return
     *         value is {@code N}, else the return value is the result of
     *         {@code getSuperClasses(DataSomeValuesFrom(pe rdfs:Literal), true)} . <br>
     *         If {@code direct} is {@code false}: then the result of
     ...
     */
    @Nonnull
    NodeSet<OWLClass> getDataPropertyDomains(@Nonnull OWLDataProperty pe, boolean direct);
     ...
     *         If {@code direct} is {@code false}, a {@code NodeSet} containing named classes such
     *         that for each named class {@code C} in the node set, the set of reasoner axioms
     ...
     */
    @Nonnull
    NodeSet<OWLNamedIndividual> getInstances(@Nonnull OWLClassExpression ce, boolean direct);
     ...
     *        individual
     * @return A {@code NodeSet} containing named individuals such that for each individual
     *         {@code j} in the node set, the set of reasoner axioms entails
     *         {@code ObjectPropertyAssertion(pe ind j)}.
     * @throws InconsistentOntologyException if the imports closure of the root ontology is
     *         inconsistent
     ...
     */
    @Nonnull
    NodeSet<OWLNamedIndividual> getObjectPropertyValues(@Nonnull OWLNamedIndividual ind,
        @Nonnull OWLObjectPropertyExpression pe);
     ...
     */
    @Nonnull
    Node<OWLNamedIndividual> getSameIndividuals(@Nonnull OWLNamedIndividual ind);
     ...
     *         individual {@code i} in the {@code NodeSet} the set of reasoner axioms entails
     *         {@code DifferentIndividuals(ind, i)}.
     * @throws InconsistentOntologyException if the imports closure of the root ontology is
     *         inconsistent
     * @throws FreshEntitiesException if the signature of the individual is not contained within the
     *         signature of the imports closure of the root ontology and the undeclared entity
     ...
     */
    @Nonnull
    NodeSet<OWLNamedIndividual> getDifferentIndividuals(@Nonnull OWLNamedIndividual ind);
     ...
     * {@link org.semanticweb.owlapi.reasoner.TimeOutException} in the thread that is executing the
