...
public interface OWLReasoner {
     ...
     *         {@code NodeSet} the set of reasoner axioms entails {@code StrictSubClassOf(C, ce)}.
     *         <br>
     *         If {@code ce} is equivalent to {@code owl:Nothing} then the empty {@code NodeSet}
     *         will be returned.
     */
     ...
     *         such that for each named individual {@code j} in the node set, the set of reasoner
     *         axioms entails {@code DirectClassAssertion(ce, j)}. <br>
     *         If {@code depth} is {@code ALL}, a {@code NodeSet} containing named individuals such
     *         that for each named individual {@code j} in the node set, the set of reasoner axioms
     *         entails {@code ClassAssertion(ce, j)}. <br>
     *         If ce is unsatisfiable with respect to the set of reasoner axioms then the empty
     *         {@code NodeSet} is returned.
     */
