...
/**
 * An enumeration that denotes various types of inference task. Each inference task has a name that
 * is associated with it - reasoners may use these names when reporting progress.
 *
...
public enum InferenceType {
    ...
    /**
     * Denotes the computation of relationships between individuals in the signature of the imports
    ...
    /**
     * Denotes the computation of sets of classes that are disjoint for each class in the signature
