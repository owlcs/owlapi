...
public interface ReasonerProgressMonitor extends Serializable {
    ...
    /**
     * A standard name for the task of loading a reasoner with axioms. Note that there is no
     * guarantee that the reasoner will use this name for loading.
     */
    String LOADING = "Loading";
    /**
     * A standard name for the task of computing the class hierarchy. Note that there is no
     * guarantee that the reasoner will use this name for the task of computing the class hierarchy.
     */
    String CLASSIFYING = "Classifying";
    /**
     * A standard name for the task of computing the types of individual. Note that there is no
     * guarantee that the reasoner will use this name for the task of realising.
     */
    String REALIZING = "Realizing";
    /**
     * A standard name for the task of classifying and realising at the same time. Note that there
     ...
     * classification, realisation etc. has started. When the task has finished the
     * {@link #reasonerTaskStopped()} method will be called. Once this method has been called it
    ...
    /**
     * Indicates that the reasoner is busy performing a task whose size cannot be determined. This
     * method will only be called after the {@link #reasonerTaskStarted(String)} method has been
     * called. It will not be called after the {@link #reasonerTaskStopped()} method has been
     * called. <br>
     * Note that this method may be called from a thread that is not the event dispatch thread.
     */
