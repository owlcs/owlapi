 ...
 * hierarchy (directed acyclic graph - DAG) of <code>Nodes</code>. Each node
 * contains entities that are equivalent to each other. A hierarchy contains a
 * <i>top node</i>, which is the ancestor of all nodes in the hierarchy, and a
 * <i>bottom node</i> which is the descendant of all nodes in the hierarchy. <br>
 * In a class hierarchy, the nodes contain <code>OWLClass</code> objects. The
 * top node contains <code>owl:Thing</code> (and any other named classes that
 * are equivalent to <code>owl:Thing</code>). The bottom node contains
 * <code>owl:Nothing</code> (and any other named classes that are equivalent to
 * <code>owl:Nothing</code> - these classes are <i>unsatisfiable</i> classes). <br>
 * In an object property hierarchy, the nodes contain
 * <code>OWLObjectProperty</code> objects. The top node contains
 * <code>owl:topObjectProperty</code> (and any other named object properties
 * that are equivalent to <code>owl:topObjectProperty</code>). The bottom node
 * contains <code>owl:bottomObjectProperty</code> (and any other named object
 * properties that are equivalent to <code>owl:bottomObjectProperty</code>). <br>
 * In a data property hierarchy, the nodes contain <code>OWLDataProperty</code>
 * objects. The top node contains <code>owl:topDataProperty</code> (and any
 * other data properties that are equivalent to <code>owl:topDataProperty</code>
 * ). The bottom node contains <code>owl:bottomDataProperty</code> (and any
 * other data properties that are equivalent to
 * <code>owl:bottomDataProperty</code>). <h4>Class Hierarchy Example</h4> The
 * figure below shows an example class hierarchy. Each box in the hierarchy
 ...
 * appears as an entity in the top node. Similarly, class <code>K</code> is
 * unsatisfiable, so it is equivalent to <code>owl:Nothing</code> and therefore
 * appears in the bottom node containing <code>owl:Nothing</code>. <br>
...
public interface Node<E extends OWLObject> extends Iterable<E> {
     ...
     * <code>owl:Thing</code>. For an object property node, the top node is the
     * node that contains <code>owl:topObjectProperty</code>. For a data
     ...
     *         and it contains <code>owl:Thing</code>. <br>
     *         <code>true</code> if this node is an
     *         <code>OWLObjectProperty</code> node and it contains
     *         <code>owl:topObjectProperty</code>. <br>
     *         <code>true</code> if this node is an <code>OWLDataProperty</code>
     *         node and it contains <code>owl:topDataProperty</code>. <br>
     ...
     * <code>owl:Nothing</code>. For an object property node, the bottom node is
     * the node that contains <code>owl:bottomObjectProperty</code>. For a data
     * property node, the bottom node is the node that contains
     * <code>owl:bottomDataProperty</code>
     * 
     * @return <code>true</code> if this node is an <code>OWLClass</code> node
     *         and it contains <code>owl:Nothing</code>. <br>
     *         <code>true</code> if this node is an
     *         <code>OWLObjectProperty</code> node and it contains
     *         <code>owl:bottomObjectProperty</code>. <br>
     *         <code>true</code> if this node is an <code>OWLDataProperty</code>
     *         node and it contains <code>owl:bottomDataProperty</code>. <br>
     *         <code>false</code> if none of the above. */
     ...
     * <code>e</code>. This essentially returns the entities that are returned
     * by {@link #getEntities()} minus the specified entity <code>e</code>
     * 
     * @param e
     ...
     *         specified entity, <code>e</code>. If <code>e</code> is not
     ...
     * of named classes the top entity is <code>owl:Thing</code>. For a node of
     * object properties the top entity is <code>owl:topObjectProperty</code>.
     ...
     * node of named classes the bottom entity is <code>owl:Nothing</code>. For
     * a node of object properties the bottom entity is
     * <code>owl:bottomObjectProperty</code>. For a node of data properties the
     * bottom entity is <code>owl:bottomDataProperty</code>
     * 
