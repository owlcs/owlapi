...
public class ProfileVisitor extends ProfileVisitorBase {
    ...
    public void visit(OWLDatatypeRestriction node) {
        ...
        getCurrentOntology().getImportsClosure().stream()
            .flatMap(o -> o.getAxioms(AxiomType.DATATYPE_DEFINITION).stream())
        ...
        node.getFacetRestrictions().forEach(r -> illegalFacet(node, datatype, r));
    ...
    public void visit(OWLDisjointClassesAxiom axiom) {
        ...
        ql(() -> axiom.getClassExpressions().stream().filter(ce -> !isOWL2QLSubClassExpression(ce))
            .forEach(this::nonSubclass));
        rl(() -> axiom.getClassExpressions().stream()
    ...
    public void visit(OWLDisjointObjectPropertiesAxiom axiom) {
        dl(() -> insufficientProperties(axiom), () -> axiom.getProperties().stream()
    ...
    public void visit(OWLSubPropertyChainOfAxiom axiom) {
        ...
        el(() -> getCurrentOntology().getAxioms(AxiomType.OBJECT_PROPERTY_RANGE, INCLUDED)
