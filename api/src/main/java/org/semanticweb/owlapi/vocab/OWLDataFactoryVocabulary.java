...
public class OWLDataFactoryVocabulary {
	private static final OWLDataFactory factory = NonCachingOWLDataFactoryImpl
			.getInstance();
	/**
	...
	public static final OWLDataProperty OWLTopDataProperty = factory
			.getOWLTopDataProperty();
	public static final OWLObjectProperty OWLBottomObjectProperty = factory
			.getOWLBottomObjectProperty();
	public static final OWLDataProperty OWLBottomDataProperty = factory
