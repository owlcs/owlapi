...
public enum OWLRDFVocabulary implements HasShortForm, HasIRI, HasPrefixedName {
     ...
     */
    public static final Set<IRI> BUILT_IN_VOCABULARY_IRIS = asSet(
        Stream.of(values()).map(i -> i.getIRI()));
    /**
    ...
    public static final Set<IRI> BUILT_IN_AP_IRIS = asSet(
        Stream.of(RDFS_LABEL, RDFS_COMMENT, OWL_VERSION_INFO,
            OWL_BACKWARD_COMPATIBLE_WITH, OWL_PRIOR_VERSION, RDFS_SEE_ALSO, RDFS_IS_DEFINED_BY,
