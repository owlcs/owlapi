...
public interface OWLOntologyLoaderListener extends Serializable {
  ...
  class LoadingEvent {
     ...
     * statement.
     *
     * @return {@code true} if the ontology was loaded because it was imported by another ontology,
     * or {@code false} if the ontology was loaded by a direct load request on OWLOntologyManager.
     */
  ...
  class LoadingFinishedEvent extends LoadingEvent {
     ...
     *
     * @return {@code true} if the ontology was successfully loaded, {@code false} if the ontology
     * was not successfully loaded. Note that an ontology being successfully loaded does not imply
     * that any ontologies that the ontology imports were successfully loaded.
     */
     ...
     * loaded successfully.
     *
     * @return The exception that describes why the ontology was not loaded successfully, or {@code
     * null} if the ontology was loaded successfully.
     */
    @Nullable
