...
/**
 * An exception which describes an error during the creation of an ontology. If an ontology cannot
 * be created then subclasses of this class will describe the reasons.
 *
