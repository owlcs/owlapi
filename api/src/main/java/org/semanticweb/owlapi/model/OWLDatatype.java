...
public interface OWLDatatype extends OWLDataRange, OWLEntity {
    ...
    /**
     * Determines if this datatype has the IRI {@code xsd:long}.
     *
     * @return {@code true} if this datatype has the IRI {@code xsd:long}.
     */
    boolean isLong();
     ...
     *
     * @return {@code true} if this datatype has the IRI {@code rdf:PlainLiteral}.
     */
