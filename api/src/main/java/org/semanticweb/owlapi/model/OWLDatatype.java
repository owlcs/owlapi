...
public interface OWLDatatype extends OWLDataRange, OWLLogicalEntity, OWLNamedObject {
     ...
     * 
     * @return {@code true} if this datatype has the IRI {@code xsd:string}, otherwise
     *         {@code false}.
     */
    boolean isString();
     ...
     * 
     * @return {@code true} if this datatype has the IRI {@code xsd:integer}, otherwise
     *         {@code false}.
     */
    boolean isInteger();
     ...
     * 
     * @return {@code true} if this datatype has the IRI {@code xsd:double}, otherwise
     *         {@code false}.
     */
    boolean isDouble();
     ...
     * 
     * @return {@code true} if this datatype has the IRI {@code xsd:boolean}, otherwise
     *         {@code false}.
     */
    boolean isBoolean();
     ...
     * 
     * @return {@code true} if this datatype has the IRI {@code rdf:PlainLiteral} otherwise
     *         {@code false}
     */
