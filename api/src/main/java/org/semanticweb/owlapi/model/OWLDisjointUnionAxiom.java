...
public interface OWLDisjointUnionAxiom extends OWLClassAxiom {
     ...
     *         {@code EquivalentClasses(CE, CEUnion)} where {@code CEUnion} is the union of the
     *         classes returned by the {@link #getClassExpressions()} method and {@code CE} is the
     ...
     *         {@code DisjointClasses(CE1, ..., CEn)} where {@code CEi in (CE1, ..., CEn)} is
