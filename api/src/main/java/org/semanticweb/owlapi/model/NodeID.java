...
public final class NodeID implements Comparable<NodeID>, Serializable {
  ...
  public static boolean isAnonymousNodeIRI(@Nullable IRI iri) {
    return iri != null && iri.getNamespace().startsWith(PREFIX) && iri.getNamespace()
        .contains(NODE_ID_PREFIX);
  }
   ...
   *
   * @param id The String that identifies the node. If the String doesn't start with "_:" then this
   * will be concatenated to the front of the specified id String; if the string is empty or null,
   * an autogenerated id will be used.
   * @return A NodeID
   */
