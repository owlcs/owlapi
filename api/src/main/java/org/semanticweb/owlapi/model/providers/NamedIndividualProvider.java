...
public interface NamedIndividualProvider extends Serializable {
   ...
   * IRIs.
   * @return An OWLNamedIndividual that has the IRI obtained by expanding the specified abbreviated
   ...
   * the IRI of the OWLNamedIndividual obtained by this method.
