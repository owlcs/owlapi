 ...
 * ontologies by their {@code AxiomType}. For example, see {@link org.semanticweb.owlapi.model.OWLOntology#axioms(AxiomType)}
 * and {@link org.semanticweb.owlapi.model.OWLOntology#getAxiomCount(AxiomType,
...
public final class AxiomType<C extends OWLAxiom> implements Serializable, Comparable<AxiomType<?>> {
   ...
   * Declaration.
   */
  public static final AxiomType<OWLDeclarationAxiom> DECLARATION = getInstance(
      OWLDeclarationAxiom.class, 0, "Declaration", true, true, false);
  /**
   * EquivalentClasses.
   */
  public static final AxiomType<OWLEquivalentClassesAxiom> EQUIVALENT_CLASSES = getInstance(
      OWLEquivalentClassesAxiom.class, 1, "EquivalentClasses", false, false, true);
  /**
   * SubClassOf.
   */
  public static final AxiomType<OWLSubClassOfAxiom> SUBCLASS_OF = getInstance(
      OWLSubClassOfAxiom.class, 2, "SubClassOf", false, false, true);
  /**
   * DisjointClasses.
   */
  public static final AxiomType<OWLDisjointClassesAxiom> DISJOINT_CLASSES = getInstance(
      OWLDisjointClassesAxiom.class, 3, "DisjointClasses", false, false, true);
  /**
   * DisjointUnion.
   */
  public static final AxiomType<OWLDisjointUnionAxiom> DISJOINT_UNION = getInstance(
      OWLDisjointUnionAxiom.class, 4, "DisjointUnion", true, false, true);
  /**
   * ClassAssertion.
   */
  public static final AxiomType<OWLClassAssertionAxiom> CLASS_ASSERTION = getInstance(
      OWLClassAssertionAxiom.class, 5, "ClassAssertion", false, false, true);
  //@formatter:off
  /**
   * SameIndividual.
   */
  public static final AxiomType<OWLSameIndividualAxiom> SAME_INDIVIDUAL = getInstance(
      OWLSameIndividualAxiom.class, 6, "SameIndividual", false, false, true);
  /**
   * DifferentIndividuals.
   */
  public static final AxiomType<OWLDifferentIndividualsAxiom> DIFFERENT_INDIVIDUALS = getInstance(
      OWLDifferentIndividualsAxiom.class, 7, "DifferentIndividuals", false, false, true);
  /**
   * ObjectPropertyAssertion.
   */
  public static final AxiomType<OWLObjectPropertyAssertionAxiom> OBJECT_PROPERTY_ASSERTION = getInstance(
      OWLObjectPropertyAssertionAxiom.class, 8, "ObjectPropertyAssertion", false, false, true);
  /**
  ...
  public static final AxiomType<OWLAnnotationPropertyRangeAxiom> ANNOTATION_PROPERTY_RANGE = getInstance(
      OWLAnnotationPropertyRangeAxiom.class, 36, "AnnotationPropertyRangeOf", true, true, false);
  /**
   * AnnotationPropertyDomain.
   */
  public static final AxiomType<OWLAnnotationPropertyDomainAxiom> ANNOTATION_PROPERTY_DOMAIN = getInstance(
      OWLAnnotationPropertyDomainAxiom.class, 37, "AnnotationPropertyDomain", true, true, false);
  /**
   * Axiom types.
   */
   ...
   * Axiom types.
   */
  public static final Set<AxiomType<?>> LOGICAL_AXIOM_TYPES = asSet(
      AXIOM_TYPES.stream().filter(AxiomType::isLogical));
  /**
   * Logical axioms and declarations
   */
  public static final Set<AxiomType<? extends OWLAxiom>> LOGICAL_AXIOMS_AND_DECLARATIONS_TYPES = asSet(
      Stream.concat(LOGICAL_AXIOM_TYPES.stream(), Stream.of(DECLARATION)));
  /**
  ...
  private static final Map<String, AxiomType<? extends OWLAxiom>> NAME_TYPE_MAP = Maps
      .uniqueIndex(AXIOM_TYPES, AxiomType::getName);
  private static final Map<Class<?>, AxiomType<? extends OWLAxiom>> CLASS_TYPE_MAP = Maps
      .uniqueIndex(AXIOM_TYPES, AxiomType::getActualClass);
...
//@formatter:off
   ...
   * @return A set of axioms that represents the sourceAxioms without the specified types. Note that
   * sourceAxioms will not be modified. The returned set is a copy.
   */
   ...
   * @return The axiom type with the specified name, or {@code null} if there is no such axiom type
   ...
   *
   * @return {@code true} if this axiom is an OWL 2 axiom, {@code false} if this axiom is not an OWL
   * 2 axiom and it can be represented using OWL 1.
   */
   ...
   *
   * @return {@code true} if this axiom is a pure OWL 2 axiom and cannot be represented using OWL 1
