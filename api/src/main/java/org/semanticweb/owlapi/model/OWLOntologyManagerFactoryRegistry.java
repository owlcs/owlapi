 ...
 * Date: 15-Nov-2006<br>
 * <br>
 * The {@link OWLOntologyManagerFactory} provides a central point for the registration of
 * storer factories that create storers to store OWL ontologies. The registry is typically used by
 * at least one type of ontology factory for storing ontologies whose concrete representations are
 * to be contained in some kind of document.
 */
public class OWLOntologyManagerFactoryRegistry extends AbstractServiceLoader<String, OWLOntologyManagerFactory>
{
    ...
    /**
     * Returns the class name of the service as its unique key, to prevent multiple instances of the
     * one service being present in the registry.
     */
    @Override
