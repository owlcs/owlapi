...
public interface OWLSignatureBooleanArgs extends OWLSignature {
   ...
   *
   * @param includeImportsClosure if true, include imports closure.
   * @return the set of object properties in the signature, optionally including the import closure.
   ...
   *
   * @param includeImportsClosure if true, include imports closure.
   * @return the set of datatypes in the signature of this ontology, optionally including the import
   ...
   * @param includeImportsClosure if true, include imports closure.
   * @return true if the signature or the import closure contains an entity with the specified IRI.
   * @deprecated use the stream method
   */
  @Deprecated
   ...
   */
  @Deprecated
  default boolean containsObjectPropertyInSignature(IRI owlObjectPropertyIRI,
      boolean includeImportsClosure) {
   ...
   * @param includeImportsClosure if true, include imports closure.
   * @return true if the signature or the import closure contains a data property with the specified
   * IRI.
   * @deprecated use the stream method
   */
  @Deprecated
  default boolean containsDataPropertyInSignature(IRI owlDataPropertyIRI,
      boolean includeImportsClosure) {
   ...
   */
  @Deprecated
  default boolean containsAnnotationPropertyInSignature(IRI owlAnnotationPropertyIRI,
      boolean includeImportsClosure) {
   ...
   * @param includeImportsClosure if true, include imports closure.
   * @return true if the signature or the import closure contains a datatype with the specified IRI.
   * @deprecated use the stream method
   */
  @Deprecated
   ...
   */
  @Deprecated
  default boolean containsIndividualInSignature(IRI owlIndividualIRI,
      boolean includeImportsClosure) {
   ...
   * @param includeImportsClosure if true, include imports closure.
   * @return the set of entities with the specified IRI, optionally including the ones in the import
   * closure.
   * @deprecated use the stream method
   */
  @Deprecated
