...
public interface ImpendingOWLOntologyChangeListener {
     ...
     *            A list of ontology changes that will be applied to an
     *            ontology. Note that the list of changes represents the
     *            requested changes. Not all change might be applied.
