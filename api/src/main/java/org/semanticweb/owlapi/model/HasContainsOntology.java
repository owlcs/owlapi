...
public interface HasContainsOntology {
     ...
     *
     * @param id The {@link OWLOntologyID} to test for.  Not {@code null}.
     * @return {@code true} if this object contains an ontology that has the specified Id, otherwise, {@code false}.
     */
