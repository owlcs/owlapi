 ...
 * differs from OWLAxiomCollection because its methods take no arguments for
 * imports closure, and are equivalent to calling the corresponding method from
 * OWLAxiomCollection with argument Imports.EXCLUDED.
 * 
 * @author ignazio
 * @since 4.0.0
 */
