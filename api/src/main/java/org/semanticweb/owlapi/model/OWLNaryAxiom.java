...
public interface OWLNaryAxiom<C extends OWLObject> extends OWLAxiom, HasOperands<C> {
   ...
   * @param visitor visitor to apply to all pairwise elements in this axiom; pairs are not ordered,
   * i.e., only (i,j) will be considered, for i!=j; (j, i) is not considered.
