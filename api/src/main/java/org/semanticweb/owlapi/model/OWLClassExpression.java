...
public interface OWLClassExpression extends OWLObject, OWLPropertyRange, SWRLPredicate {
     ...
     * expression as an {@code OWLClass} without the need for casting. The general pattern of use is
     * to use the {@code isAnonymous} or the {@code isNamed} methods to first check
     * 
     * @return This class expression as an {@code OWLClass}.
     * @throws OWLRuntimeException if this class expression is not an {@code OWLClass}.
     */
    @Nonnull
    OWLClass asOWLClass();
     ...
     *         expression is an {@code ObjectIntersectionOf} (possibly nested withing another
     *         {@code ObjectIntersectionOf}) that contains {@code ce}, otherwise {@code false}.
     */
