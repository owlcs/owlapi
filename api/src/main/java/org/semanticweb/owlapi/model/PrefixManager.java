...
public interface PrefixManager extends Serializable {
   ...
   * ":"
   *
   * @return The default prefix, or {@code null} if there is no default prefix.
   */
  @Nullable
   ...
   * this prefix
   *
   * @param defaultPrefix The namespace to be used as the default namespace. Note that the value may
   * be {@code null} in order to clear the default namespace.
   */
   ...
   * @return {@code true} if the manager knows about this prefix and there is a non-null mapping for
   * this prefix.
   */
   ...
   *
   * @return The map of prefix names to prefixes. Note that modifying the contents of this map will
   * not change the prefix name - prefix mappings
   */
