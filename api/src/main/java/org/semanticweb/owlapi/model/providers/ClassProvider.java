...
public interface ClassProvider extends Serializable {
   ...
   * PREFIX_NAME may be the empty string (the default prefix).<br> Note that abbreviated IRIs always
   ...
   * IRIs.
   * @return An OWLClass that has the IRI obtained by expanding the specified abbreviated IRI using
   * the specified prefix manager. <br> For example, suppose "m:Cat" was specified as the
   ...
   * the IRI of the OWLClass obtained by this method.
