...
public interface ClassProvider extends Serializable {
    ...
    /**
     * Gets an instance of {@link OWLClass} that has the specified {@code IRI}. This is the same as
     * calling {@code getOWLClass(IRI.create(iri))}. No prefix resolution is attempted.
     *
     ...
     * remainder. This is the same as calling {@code getOWLClass(IRI.create(namespace, remainder))}.
     * No prefix resolution is attempted.
     *
     ...
     * appropriate prefix mapping. See
