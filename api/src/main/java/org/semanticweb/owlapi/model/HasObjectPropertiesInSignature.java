...
public interface HasObjectPropertiesInSignature {
   ...
   *
   * @return A set containing the object properties that are in the signature of this object.The set
   * is a subset of the signature, and is not backed by the signature; it is a modifiable collection
