...
public interface ExistentialProvider {
   ...
   * @return An OWLDataSomeValuesFrom restriction that acts along the specified property and has the
   * specified filler
   */
   ...
   * @return An OWLObjectSomeValuesFrom restriction along the specified property with the specified
   * filler
   */
