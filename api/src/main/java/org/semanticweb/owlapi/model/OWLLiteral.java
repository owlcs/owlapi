...
public interface OWLLiteral
   ...
   *
   * @return The lexical value of this literal. If the datatype is {@code rdf:PlainLiteral} then the
   * return values are as follows: If the literal is of the form {@code "abc@"^^rdf:PlainLiteral}
   * then the return value will be "abc" (without the language tag included). If the literal is of
   * the form {@code "abc@langTag"^^rdf:PlainLiteral} then the return value will be "abc" (without
   ...
   * empty.
   * @return {@code true} if this literal has a language tag equal to {@code lang}, otherwise {@code
   * false}.
   */
   ...
   * @throws NumberFormatException if the lexical form could not be parsed into a boolean because it
   ...
   * @throws NumberFormatException if the lexical form could not be parsed into a double because it
