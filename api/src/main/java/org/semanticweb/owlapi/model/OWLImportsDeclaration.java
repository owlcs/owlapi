...
public interface OWLImportsDeclaration extends Comparable<OWLImportsDeclaration>, HasIRI,
   ...
   * Gets the import IRI.
   *
   * @return The import IRI that points to the ontology to be imported. The imported ontology might
   * have this IRI as its ontology IRI but this is not mandated. For example, an ontology with a non
