...
public class OntologyConfigurator implements Serializable {
   ...
   *
   * @param ontologyDocumentIRI The ontology document IRI that will be ignored if it is encountered
   * as an imported ontology during loading.
   ...
   *
   * @param ontologyDocumentIRI The ontology document IRI that would be ignored if it is encountered
   * as an imported ontology during loading.
  ...
  /**
   * @param l new timeout Note: the timeout is an int and represents milliseconds. This is necessary
   * for use in {@code URLConnection}
  ...
  /**
   * @param b True if ids for blank nodes should always be written (axioms and anonymous individuals
   * only).
