...
public interface OWLOntologyManager extends OWLOntologySetProvider, HasDataFactory,
    HasGetOntologyById, HasApplyChanges,
    HasApplyChange, HasAddAxioms, HasAddAxiom, HasRemoveAxioms, HasRemoveAxiom, HasContainsOntology,
    HasOntologyChangeListeners, HasOntologyConfigurator, HasOntologyLoaderConfiguration,
   ...
   *
   * @param ontologyIRI The IRI of the ontology to test for (the version IRI is assumed to be {@code
   * null})
   ...
   *
   * @param ontologyVersionIRI The version IRI of the ontology to test for (the ontology IRI may be
   * anything)
   * @return {@code true} if there is an ontology with the specified version IRI, that is managed by
   * this manager, otherwise {@code false}.
   */
   ...
   * @return A set of OWLOntologyIDs where the version matches the given version or the empty set if
   * none match.
   * @deprecated use the stream method
   */
  @Deprecated
   ...
   * @return The ontology that has the specified ID, or {@code null} if this manager does not manage
   * an ontology with the specified ontology ID.
   */
  @Nullable
  @Override
   ...
   * @return The set of <em>loaded</em> ontologies that the specified ontology is related to via the
   * directlyImports relation. If the ontology is not managed by this manager then the empty set
   * will be returned.
   * @deprecated use the stream method
   */
  @Deprecated
   ...
   *
   * @param ontology The ontology whose direct imports are to be retrieved.
   * @return Stream of <em>loaded</em> ontologies that the specified ontology is related to via the
   * directlyImports relation. If the ontology is not managed by this manager then the empty set
   * will be returned.
   */
   ...
   * imports relation of this ontology. If, for what ever reason, an imported ontology could not be
   * loaded, then it will not be contained in the returned set of ontologies. If the ontology is not
   ...
   * @return A list that represents a topological ordering of the imports closure. The first element
   * in the list will be the specified ontology. If the ontology is not managed by this manager then
   ...
   * @throws OWLOntologyChangeException if there was a problem copying the axioms.
   * @throws OWLOntologyAlreadyExistsException if the manager already contains an ontology with the
   ...
   *
   * @param ontologyIRI The IRI of the ontology to be created. The ontology IRI will be mapped to a
   * document IRI in order to determine the type of ontology factory that will be used to create the
   * ontology. If this mapping is {@code null} then a default (in memory) implementation of the
   ...
   * @throws OWLOntologyDocumentAlreadyExistsException if the specified {@code ontologyID} is mapped
   * to a ontology document IRI for which there already exists a mapping in this manager.
   */
   ...
   * @param copyLogicalAxiomsOnly If set to {@code true} only logical axioms are copied into the new
   * ontology. If set to {@code false} then all axioms (including annotation axioms) are copied into
   * the new ontology.
   ...
   * IRI.
   *
   * @param ontologyIRI The IRI that identifies the ontology. It is expected that the ontology will
   * also have this IRI (although the OWL API will tolerated situations where this is not the
   * case).
   ...
   * ontology.
   * @throws org.semanticweb.owlapi.io.UnparsableOntologyException if the ontology was being parsed
   * from a document and the document contained syntax errors.
   ...
   * triggered the import and the cause of this exception is an {@code OWLOntologyCreationException}
   ...
   * @throws OWLOntologyAlreadyExistsException if the manager already contains an ontology with the
   * specified {@code ontologyIRI} (where the ontology doesn't have a version IRI).
   * @throws OWLOntologyDocumentAlreadyExistsException if the specified {@code ontologyIRI} is
   * mapped to a ontology document IRI for which there already exists a mapping in this manager.
   */
   ...
   * ontologies via imports statements.
   *
   * @param ontologyID The ontology to be removed. If this manager does not manage the ontology then
   * nothing happens.
   */
  ...
  default OWLDocumentFormat getNonnullOntologyFormat(OWLOntology ontology) {
    return verifyNotNull(getOntologyFormat(ontology),
        (Supplier<String>) () -> "There is no format specified for ontology " + ontology
            .getOntologyID()
  ...
  /**
   * @return the collection of IRI mappers. This allows for iteration and modification of the list.
   */
  ...
  /**
   * @return the collection of ontology factories. This allows for iteration and modification of the
   * list.
   */
