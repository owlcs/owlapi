...
public interface OWLOntologyManager extends OWLOntologySetProvider,
     ...
     */
    OWLOntology createOntology(Set<OWLAxiom> axioms)
            throws OWLOntologyCreationException;
     ...
     * 
     * @param b
     *        {@code true} if loading should continue when an imported ontology
     *        cannot be loaded, other wise {@code false}. The default value is
     *        {@code false}.
