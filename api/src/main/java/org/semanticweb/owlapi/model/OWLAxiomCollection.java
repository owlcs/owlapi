...
public interface OWLAxiomCollection
   ...
   * @return stream of All of the axioms in this collection, and optionally in the import closure.
   */
   ...
   *
   * @param imports if INCLUDED, include imports closure.
   * @return A stream of axioms which are of type {@code OWLLogicalAxiom}, optionally including the
   * imports closure.
   */
   ...
   * @param includeImportsClosure if INCLUDED, include imports closure.
   * @param ignoreAnnotations if IGNORE_ANNOTATIONS, annotations are ignored when searching for the
   * axiom. For example, if the collection contains {@code SubClassOf(Annotation(p V) A B)} then
   * this method will return {@code true} if the ontology contains {@code SubClassOf(A B)} or {@code
   * SubClassOf(Annotation(q S) A B)} for any annotation property {@code q} and any annotation value
   * {@code S}.
   ...
   * contains the specified property</li> <li>Equivalent property axioms that contain the inverse of
   * the specified property</li> <li>Disjoint property axioms that contain the specified property
   * </li> <li>Domain axioms that specify a domain of the specified property </li> <li>Range axioms
   * that specify a range of the specified property </li> <li>Any property characteristic axiom
   * (i.e. Functional, Symmetric, Reflexive etc.) whose subject is the specified property</li>
   * <li>Inverse properties axioms that contain the specified property </li> </ul> The set that is
   ...
   * @param property The property whose defining axioms are to be retrieved.
   * @param imports if INCLUDED, include imports closure.
   * @return A stream of object property axioms that includes <ul> <li>Sub-property axioms where the
   * sub property is the specified property</li> <li>Equivalent property axioms where the axiom
   * contains the specified property</li> <li>Equivalent property axioms that contain the inverse of
   * the specified property</li> <li>Disjoint property axioms that contain the specified property
   * </li> <li>Domain axioms that specify a domain of the specified property </li> <li>Range axioms
   * that specify a range of the specified property </li> <li>Any property characteristic axiom
   * (i.e. Functional, Symmetric, Reflexive etc.) whose subject is the specified property</li>
   * <li>Inverse properties axioms that contain the specified property </li> </ul>
   */
   ...
   *
   * @param property The property whose defining axioms are to be retrieved.
   * @return A set of data property axioms that includes <ul> <li>Sub-property axioms where the sub
   * property is the specified property</li> <li>Equivalent property axioms where the axiom contains
   * the specified property</li> <li>Disjoint property axioms that contain the specified property
   * </li> <li>Domain axioms that specify a domain of the specified property </li> <li>Range axioms
   * that specify a range of the specified property </li> <li>Any property characteristic axiom
   * (i.e. Functional, Symmetric, Reflexive etc.) whose subject is the specified property</li> </ul>
   ...
   * specified property is the sub property</li> <li>Annotation property domain axioms that specify
   * a domain for the specified property</li> <li>Annotation property range axioms that specify a
   * range for the specified property</li> </ul> The set is a copy of the data.
   * @deprecated use the stream method
   */
  @Deprecated
   ...
   * specified property is the sub property</li> <li>Annotation property domain axioms that specify
   * a domain for the specified property</li> <li>Annotation property range axioms that specify a
   * range for the specified property</li> </ul>
   */
  default Stream<OWLAnnotationAxiom> axioms(OWLAnnotationProperty property) {
    return Stream
        .of(axioms(AxiomType.SUB_ANNOTATION_PROPERTY_OF)
   ...
   * @return The set of datatype definition axioms for the specified datatype. The set is a copy of
   * the data.
   * @deprecated use the stream method
   */
  @Deprecated
