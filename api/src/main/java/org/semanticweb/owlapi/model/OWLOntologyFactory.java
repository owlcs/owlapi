...
public interface OWLOntologyFactory extends Serializable {
   ...
   * @return {@code true} if the factory can create an ontology given the specified document IRI, or
   * {@code false} if the factory cannot create an ontology given the specified document IRI.
   */
