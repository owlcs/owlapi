...
public interface AnnotationPropertyProvider {
  ...
  /**
   * Gets an instance of {@link OWLAnnotationProperty} with the same IRI as
   * the input.
   *
   * @param iri The HasIRI instance.
   * @return An {@link OWLAnnotationProperty} that has iri.getIRI() as IRI.
   */
  default OWLAnnotationProperty getOWLAnnotationProperty(HasIRI iri) {
    return getOWLAnnotationProperty(iri.getIRI());
  }

  /**
   * Gets an instance of {@link OWLAnnotationProperty} that has the specified
   * {@code IRI}. This is the same as
   * {@code getOWLAnnotationProperty(IRI.create(iri))}.
   *
   ...
   * Gets an instance of {@link OWLAnnotationProperty} that has the specified
   * {@code IRI}. This is the same as
   * {@code getOWLAnnotationProperty(IRI.create(namespace, remainder))}.
   *
   ...
   * expanding an abbreviated name using an appropriate prefix mapping. See
   ...
   * specified as the abbreviated IRI, the prefix manager would be used to obtain the IRI prefix for
   * the "m:" prefix name, this prefix would then be concatenated with "Cat" to obtain the full IRI
