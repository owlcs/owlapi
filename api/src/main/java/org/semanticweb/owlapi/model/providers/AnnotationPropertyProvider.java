...
public interface AnnotationPropertyProvider {
     ...
     */
    @Nonnull
    default OWLAnnotationProperty getOWLAnnotationProperty(@Nonnull HasIRI iri) {
     ...
     */
    @Nonnull
    default OWLAnnotationProperty getOWLAnnotationProperty(@Nonnull String iri) {
     ...
     */
    @Nonnull
    default OWLAnnotationProperty getOWLAnnotationProperty(
            @Nonnull String namespace, @Nullable String remainder) {
