...
public interface AnonymousIndividualByIdProvider {
     ...
     * 
     * @param nodeId A String that represents the {@link NodeID} of the generated
     *        {@link OWLAnonymousIndividual}. Note: {@code nodeId} will be prefixed with "_:" if it
     *        is not specified with an "_:" prefix.
