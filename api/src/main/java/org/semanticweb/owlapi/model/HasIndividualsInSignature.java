...
public interface HasIndividualsInSignature {
   ...
   *
   * @return A set containing the individuals that are in the signature of this object.The set is a
   * subset of the signature, and is not backed by the signature; it is a modifiable collection and
