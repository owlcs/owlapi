 ...
 * @since 6.0.0
 */
public interface OntologyIDProvider extends Serializable {
    ...
    default OWLOntologyID getOWLOntologyID(@Nullable IRI iri) {
        return getOWLOntologyID(iri, null);
    }
    ...
    /**
     * @return an ontology identifier specifying that the ontology IRI (and hence the version IRI)
     *         is not present.
     */
    default OWLOntologyID getOWLOntologyID() {
        return getOWLOntologyID(Optional.empty(), Optional.empty());
    }
}
