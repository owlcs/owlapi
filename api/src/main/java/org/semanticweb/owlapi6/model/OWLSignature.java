...
public interface OWLSignature extends HasGetEntitiesInSignature, HasClassesInSignature, HasObjectPropertiesInSignature,
    ...
    /**
     * Determine whether the instance has entities of the specified type in its
     * signature - e.g., whether an ontology has classes, object propertyies, or
     * named individuals in its signature. Anonymous individuals are not
     * included.
     * 
     * @param type
    ...
    /**
     * Determine whether the instance has entities of the specified type in its
     * signature or in its import closure - e.g., whether an ontology has
     * classes, object propertyies, or named individuals in its signature.
