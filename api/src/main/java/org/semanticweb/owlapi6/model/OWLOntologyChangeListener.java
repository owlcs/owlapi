...
public interface OWLOntologyChangeListener {
    ...
    /**
     * Called when some changes have been applied to various ontologies. These may be an axiom added
     * or an axiom removed changes.
     *
     ...
     */
    void ontologiesChanged(Collection<? extends OWLOntologyChange> changes);
}
