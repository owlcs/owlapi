...
public interface HasApplyDirectChange {
    ...
    /**
     * A convenience method that applies just one change to this ontology. Note: ontology ID changes
     * should not be passed directly to this method but applied through OWLOntologyManager. This is
     * because the manager needs to update its internal structures for id changes.
     *
     ...
     *         {@link org.semanticweb.owlapi6.model.SetOntologyID} where the new
