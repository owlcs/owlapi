...
public interface LiteralProvider extends DatatypeProvider {
    ...
    /**
     * Gets an {@code OWLLiteral}, which has the specified lexical value, and is typed with the
     * specified datatype.
     *
    ...
    /**
     * Gets a literal that has the specified lexical value, and has the datatype xsd:string. The
     * literal will not have a language tag.
     *
    ...
    /**
     * Gets an OWLLiteral with a language tag. The datatype of this literal will have an IRI of
     * rdf:PlainLiteral ( {@link org.semanticweb.owlapi6.vocab.OWLRDFVocabulary#RDF_PLAIN_LITERAL}).
     *
