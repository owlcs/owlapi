...
public interface OWLOntologyManager
     ...
     * @return Sorted stream of {@code OWLOntology}ies that are in the transitive closure of the
     ...
     * @return Sorted stream of ontologies that contains the imports closure for the specified
     *         ontology. It includes the specified ontology.
     */
     ...
     * have a version IRI). A document IRI will automatically be generated.
     *
    ...
    /**
     * Creates a new ontology that is initialised to contain specific axioms. The ontology will not
     * have an IRI. The document IRI of the created ontology will be auto-generated.
     *
     ...
     *                    The ontology document IRI of the created ontology will be set to the value
     *                    returned by any installed
     *                    {@link org.semanticweb.owlapi6.model.OWLOntologyIRIMapper}s. If no mappers
     ...
     * @throws OWLOntologyCreationException              if there was a problem creating the new
     *                                                   ontology, if the new ontology already
     *                                                   exists in this manager.
     * @throws OWLOntologyChangeException                if there was a problem copying the axioms.
     * @throws OWLOntologyAlreadyExistsException         if the manager already contains an ontology
     *                                                   with the specified {@code ontologyIRI}.
     * @throws OWLOntologyDocumentAlreadyExistsException if the specified {@code ontologyIRI} is
     *                                                   mapped to a ontology document IRI for which
     *                                                   there already exists a mapping in this
     *                                                   manager.
     */
    ...
    /**
     * Creates a new (empty) ontology that has the specified ontology IRI (and no version IRI). <br>
     * The ontology document IRI of the created ontology will be set to the value returned by any
     * installed {@link org.semanticweb.owlapi6.model.OWLOntologyIRIMapper}s. If no mappers are
     ...
     *                    a document IRI in order to determine the type of ontology factory that
     *                    will be used to create the ontology. If this mapping is {@code null} then
     *                    a default (in memory) implementation of the ontology will most likely be
     *                    created.
     ...
     * @throws OWLOntologyAlreadyExistsException         if the manager already contains an ontology
     *                                                   with the specified {@code ontologyIRI} (and
     *                                                   no version IRI).
     * @throws OWLOntologyDocumentAlreadyExistsException if the specified {@code ontologyIRI} is
     *                                                   mapped to a ontology document IRI for which
     *                                                   there already exists a mapping in this
     ...
     *                   {@link org.semanticweb.owlapi6.model.OWLOntologyIRIMapper}s. If no mappers
     *                   are installed or the ontology IRI was not mapped to a document IRI by any
     *                   of the installed mappers, then the ontology document IRI will be set to the
     *                   value of {@code ontologyIRI}.
     * @return The newly created ontology, or if an ontology with the specified IRI already exists
     *         then this existing ontology will be returned.
     * @throws OWLOntologyCreationException              If the ontology could not be created.
     * @throws OWLOntologyAlreadyExistsException         if the manager already contains an ontology
     *                                                   with the specified {@code ontologyID} (and
     *                                                   no version IRI).
     ...
     * axioms that are contained in the specified ontologies. Note that the specified ontologies
     * need not be managed by this manager. <br>
     * The ontology document IRI of the created ontology will be set to the value returned by any
     * installed {@link org.semanticweb.owlapi6.model.OWLOntologyIRIMapper}s. If no mappers are
     * installed or the ontology IRI was not mapped to a document IRI by any of the installed
     * mappers, then the ontology document IRI will be set to the value of {@code ontologyIRI}.
     ...
     * @param ontologies            The ontologies whose axioms should be copied into the new
     *                              ontology
     * @param copyLogicalAxiomsOnly If set to {@code true} only logical axioms are copied into the
     *                              new ontology. If set to {@code false} then all axioms (including
     ...
     */
    OWLOntology copyOntology(OWLOntology toCopy, OntologyCopy settings)
        throws OWLOntologyCreationException;

    // Loading

    /**
     * Loads an ontology that is assumed to have the specified {@code ontologyIRI} as its IRI or
     * version IRI. <br>
     * The ontology IRI will be mapped to an ontology document IRI. The mapping will be determined
     * using one of the loaded {@link OWLOntologyIRIMapper} objects. By default, if no custom
     * {@code OWLOntologyIRIMapper}s have been registered using the {@link #getIRIMappers()}
     * PriorityCollection {@link PriorityCollection#add(Serializable...)} method, or no mapping can
     ...
     *                    will also have this IRI (although the OWL API will tolerated situations
     *                    where this is not the case).
     * @return The {@code OWLOntology} representation of the ontology that was loaded.
     * @throws OWLOntologyCreationException                              If there was a problem in
     *                                                                   creating and loading the
     *                                                                   ontology.
     * @throws org.semanticweb.owlapi6.io.UnparsableOntologyException    if the ontology was being
     *                                                                   parsed from a document and
     *                                                                   the document contained
     *                                                                   syntax errors.
     * @throws UnloadableImportException                                 if the ontology imports
     *                                                                   ontologies and one of the
     *                                                                   imports could not be loaded
     *                                                                   for what ever reason. If
     *                                                                   the
     *                                                                   {@link MissingImportHandlingStrategy}
     *                                                                   is set to
     *                                                                   {@link MissingImportHandlingStrategy#SILENT}
     *                                                                   then this exception will
     *                                                                   not be thrown. The
     *                                                                   {@code UnloadableImportException}
     *                                                                   contains information about
     *                                                                   the import declaration that
     *                                                                   triggered the import and
     *                                                                   the cause of this exception
     *                                                                   is an {@code
     * OWLOntologyCreationException}                                  which contains information
     *                                                                   about why the import could
     *                                                                   not be loaded.
     * @throws org.semanticweb.owlapi6.io.OWLOntologyCreationIOException if there was an {@code
     * IOException}                                                   when trying to load the
     *                                                                   ontology.
     * @throws OWLOntologyAlreadyExistsException                         if the manager already
     *                                                                   contains an ontology with
     *                                                                   the specified
     *                                                                   {@code ontologyIRI} (where
     *                                                                   the ontology doesn't have a
     *                                                                   version IRI).
     * @throws OWLOntologyDocumentAlreadyExistsException                 if the specified
     *                                                                   {@code ontologyIRI} is
     *                                                                   mapped to a ontology
     *                                                                   document IRI for which
     *                                                                   there already exists a
     *                                                                   mapping in this manager.
     */
    OWLOntology loadOntology(IRI ontologyIRI) throws OWLOntologyCreationException;

    /**
     * Loads an ontology from an ontology document specified by an IRI. In contrast the the
     * {@link #loadOntology(IRI)} method, <i>no mapping</i> is performed on the specified IRI.
     *
     ...
     * @throws OWLOntologyDocumentAlreadyExistsException                 if the specified
     *                                                                   {@code documentIRI} is
     *                                                                   already the document IRI
     *                                                                   for a loaded ontology.
     * @throws OWLOntologyAlreadyExistsException                         if the manager already
     *                                                                   contains an ontology whose
     *                                                                   ontology IRI and version
     *                                                                   IRI is the same as the
     *                                                                   ontology IRI and version
     *                                                                   IRI of the ontology
     ...
     * will be assigned a document IRI that corresponds to the file IRI.
     *
     ...
     *                                                                   creating and loading the
     *                                                                   ontology.
     * @throws org.semanticweb.owlapi6.io.UnparsableOntologyException    if the ontology could not
     *                                                                   be parsed.
     * @throws UnloadableImportException                                 if the ontology imports
     *                                                                   ontologies and one of the
     *                                                                   imports could not be loaded
     ...
     * IOException}                                                   when trying to load the
     *                                                                   ontology.
     * @throws OWLOntologyDocumentAlreadyExistsException                 if the IRI of the specified
     *                                                                   file is already the
     *                                                                   document IRI for a loaded
     *                                                                   ontology.
     * @throws OWLOntologyAlreadyExistsException                         if the manager already
     *                                                                   contains an ontology whose
     *                                                                   ontology IRI and version
     ...
     * IOException}                                                   when trying to load the
     *                                                                   ontology.
     * @throws OWLOntologyDocumentAlreadyExistsException                 if the document IRI of the
     *                                                                   input source is already the
     *                                                                   document IRI for a loaded
     *                                                                   ontology.
     * @throws OWLOntologyAlreadyExistsException                         if the manager already
     *                                                                   contains an ontology whose
    ...
    /**
     * Gets the document IRI for a given ontology. This will either be the document IRI from where
     * the ontology was obtained from during loading, or the document IRI which was specified (via a
     * mapper) when the (empty) ontology was created. Note that this may not correspond to the first
     * document IRI found in the list of mappings from ontology IRI to document IRI. The reason for
     * this is that it might not have been possible to load the ontology from the first document IRI
    ...
    /**
     * Overrides the current document IRI for a given ontology. This method does not alter the IRI
     * mappers which are installed, but alters the actual document IRI of an ontology that has
     * already been loaded.
     *
     ...
     * thrown if the ontology has no format). Do not use this method to check if an ontology has a
     * format associated with it; prefer {@link #getOntologyFormat(OWLOntology)}.
     *
     * @param ontology The ontology whose format is to be obtained.
     * @return The format of the ontology
     */
    default OWLDocumentFormat getNonnullOntologyFormat(OWLOntology ontology) {
        OWLDocumentFormat f = getOntologyFormat(ontology);
        if (f == null) {
            throw new IllegalStateException("There is no format specified for ontology "
    ...
    /**
     * Set the collection of IRI mappers. The mappers are used to obtain ontology document IRIs for
     * ontology IRIs. If their type is annotated with a HasPriority type, this will be used to
     * decide the order they are used. Otherwise, the order in which the collection is iterated will
     * determine the order in which the mappers are used.
     *
    ...
    /**
     * Set the collection of parsers. If the parsers are annotated with a HasPriority type, this
     * will be used to decide the order they are used. Otherwise, the order in which the collection
     * is iterated will determine the order in which the parsers are used.
     *
    ...
    /**
     * Set the collection of ontology factories. If the factories are annotated with a HasPriority
     * type, this will be used to decide the order they are used. Otherwise, the order in which the
     * collection is iterated will determine the order in which the parsers are used.
     *
    ...
    /**
     * Set the list of ontology storers. If their type is annotated with a HasPriority type, this
     * will be used to decide the order they are used. Otherwise, the order in which the collection
     * is iterated will determine the order in which the storers are used.
     *
    ...
    /**
     * Adds an ontology change listener, which listens to ontology changes. An ontology change
     * broadcast strategy must be specified, which determines the changes that are broadcast to the
     * listener.
     *
     ...
     * @see org.semanticweb.owlapi6.model.DefaultChangeBroadcastStrategy
     */
     ...
     * statement. This method is generally used by parsers and other kinds of loaders. For simply
     * loading an ontology, use the loadOntologyXXX methods. The method respects the list of ignored
     * imports in the specified configuration. In other words, if this methods is called for an
     * ignored import as specified by the configuration object then the import won't be loaded. The
     * ontology loader configuration used is the default one for this manager.
     *
     ...
     *                                   missing import handling is turned on then this exception
     *                                   will not be thrown.
     */
     ...
     * loading an ontology, use the loadOntologyXXX methods. The method respects the list of ignored
     * imports in the specified configuration. In other words, if this methods is called for an
     * ignored import as specified by the configuration object then the import won't be loaded.
     *
     * @param declaration   The declaration that describes the import to be loaded.
