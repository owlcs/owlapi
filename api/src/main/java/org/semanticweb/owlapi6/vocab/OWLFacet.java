 ...
 * @see org.semanticweb.owlapi6.model.OWLFacetRestriction
 * @see org.semanticweb.owlapi6.model.OWLDatatypeRestriction
 * @since 2.0.0
 */
...
//@formatter:on
    ...
    OWLFacet(Namespaces ns, String shortForm, String symbolicForm) {
        iri = VocabFactory.df.getIRI(ns.toString(), shortForm);
