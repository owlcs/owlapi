...
public class InferredAxiomGeneratorException extends OWLException {
    ...
    public InferredAxiomGeneratorException(InferredAxiomGenerator generator,
        ...
        super(getMessage(generator), reasonerException);
        this.generator = generator;
        this.reasonerException = reasonerException;
    }

    private static String getMessage(InferredAxiomGenerator gen) {
        return "Could not generate inferred axioms for " + gen +
                " because there was a problem when querying the reasoner for these axioms";
    }
