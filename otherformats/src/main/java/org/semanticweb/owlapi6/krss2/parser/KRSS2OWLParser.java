...
/**
 * The KRSS2OWLParser differs from the {@link org.semanticweb.owlapi6.krss1.parser.KRSSOWLParser
 ...
 */
public class KRSS2OWLParser implements OWLParser {
    ...
    protected OWLDocumentFormat parse(OWLOntology o, Provider provider) {
        new KRSS2Parser(provider).setOntology(o).parse();
