...
import org.semanticweb.owlapi6.formats.KRSSDocumentFormat;
...
/**
 * See {@link org.semanticweb.owlapi6.krss2.renderer.KRSSObjectRenderer KRSSObjectRenderer} for
 * definition/explanation of the syntax.
 *
...
public class KRSSSyntaxStorer implements OWLStorer {
    ...
    public boolean canStoreOntology(OWLDocumentFormat ontologyFormat) {
        return ontologyFormat instanceof KRSSDocumentFormat;
    }
    ...
    public void storeOntology(OWLOntology ontology, PrintWriter writer, OWLDocumentFormat format,
        ...
        try {
            ...
            writer.flush();
        } catch (OWLRuntimeException io) {
            throw new OWLOntologyStorageException(io);
        }
    }
}
