...
public class OWLTypedConstantTestCase extends AbstractOWLDataFactoryTest {
    ...
    public void testCreation() throws Exception {
        ...
        OWLLiteral conA = getOWLDataFactory().getOWLLiteral("3", dt);
        assertNotNull(conA);
    }
    ...
    public void testEqualsPositive() throws Exception {
        OWLDatatype dt = getOWLDataFactory().getOWLDatatype(createIRI());
        OWLLiteral conA = getOWLDataFactory().getOWLLiteral("3", dt);
        OWLLiteral conB = getOWLDataFactory().getOWLLiteral("3", dt);
    ...
    public void testEqualsNegative() throws Exception {
        ...
        OWLLiteral conA = getOWLDataFactory().getOWLLiteral("3", dtA);
        OWLDatatype dtB = getOWLDataFactory().getOWLDatatype(createIRI());
        OWLLiteral conB = getOWLDataFactory().getOWLLiteral("3", dtB);
        assertNotEquals(conA, conB);
        // Different literals - same datatype
        OWLDatatype dtC = getOWLDataFactory().getOWLDatatype(createIRI());
        OWLLiteral conC = getOWLDataFactory().getOWLLiteral("3", dtC);
        OWLLiteral conD = getOWLDataFactory().getOWLLiteral("4", dtC);
