...
package org.semanticweb.owlapi.impl.builders.test;
...
import org.semanticweb.owlapi.builders.BuilderEntity;
...
import org.semanticweb.owlapi.builders.BuilderImportsDeclaration;
...
import org.semanticweb.owlapi.builders.BuilderSWRLIndividualArgument;
import org.semanticweb.owlapi.builders.BuilderSWRLLiteralArgument;
...
import org.semanticweb.owlapi.impl.OWLOntologyFactoryImpl;
...
public class BuildersTestCase<Q> {
    ...
    protected static @Nonnull OWLAnnotationProperty ap =
    ...
    protected static @Nonnull IRI iri = df.getIRI("urn:test#", "iri");
    ...
    protected static @Nonnull Set<OWLDataProperty> dps =
        new HashSet<>(Arrays.asList(df.getOWLDataProperty(iri), dp));
    protected static @Nonnull Set<OWLObjectProperty> ops =
        new HashSet<>(Arrays.asList(df.getOWLObjectProperty(iri), op));
    protected static @Nonnull Set<OWLClass> classes =
        new HashSet<>(Arrays.asList(df.getOWLClass(iri), ce));
    protected static @Nonnull Set<OWLNamedIndividual> inds =
    ...
    protected static @Nonnull SWRLAtom v1 = df.getSWRLBuiltInAtom(df.getIRI("urn:test#", "v1"),
        Arrays.asList((SWRLDArgument) df.getSWRLVariable("urn:test#", "var3"),
            df.getSWRLVariable("urn:test#", "var4")));
    protected static @Nonnull SWRLAtom v2 = df.getSWRLBuiltInAtom(df.getIRI("urn:test#", "v2"),
