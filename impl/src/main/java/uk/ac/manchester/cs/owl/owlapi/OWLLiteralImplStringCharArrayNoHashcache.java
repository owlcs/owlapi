 ...
 */
public class OWLLiteralImplStringCharArrayNoHashcache implements OWLLiteral, CharSequence {
     ...
     */
    public OWLLiteralImplStringCharArrayNoHashcache(@Nonnull String literal) {
    ...
    public int compareTo(OWLObject o) {
        ...
        if (o instanceof OWLLiteralImplStringCharArrayNoHashcache) {
            otherTypeIndex = ((OWLLiteralImplStringCharArrayNoHashcache) o).index();
        } else {
