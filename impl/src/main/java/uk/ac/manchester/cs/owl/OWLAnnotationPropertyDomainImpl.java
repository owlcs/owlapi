 ...
 * Date: 17-Jan-2009
 */
public class OWLAnnotationPropertyDomainImpl extends OWLAxiomImpl implements OWLAnnotationPropertyDomain {
    ...
    protected int compareObjectOfSameType(OWLObject object) {
        OWLAnnotationPropertyDomain other = (OWLAnnotationPropertyDomain) object;
