 ...
 * @since 2.0.0
 */
public class OWLAnnotationAssertionAxiomImplByteArrayStringValue extends
     ...
     */
    public OWLAnnotationAssertionAxiomImplByteArrayStringValue(
    ...
    public OWLAnnotationAssertionAxiom getAxiomWithoutAnnotations() {
        ...
        return new OWLAnnotationAssertionAxiomImplByteArrayStringValue(getSubject(), getProperty(),
                value, NO_ANNOTATIONS);
    }
    ...
    public OWLAnnotationAssertionAxiom getAnnotatedAxiom(
        ...
        return new OWLAnnotationAssertionAxiomImplByteArrayStringValue(getSubject(), getProperty(),
                value, mergeAnnos(annotations));
    }

    @Override
    public OWLAnnotationValue getValue() {
       OWLAnnotationValue tmp = new  OWLLiteralImplStringByteArrayNoHashcache(value);
        return tmp;
    }
    ...
    public OWLAnnotation getAnnotation() {
        return new OWLAnnotationImpl(property, getValue(), NO_ANNOTATIONS);
    }
    ...
    protected int compareObjectOfSameType(OWLObject object) {
        ...
        if(other instanceof OWLAnnotationAssertionAxiomImplByteArrayStringValue) {
            OWLAnnotationAssertionAxiomImplByteArrayStringValue tmp = (OWLAnnotationAssertionAxiomImplByteArrayStringValue)other;
            int i=0;
            while(i < value.length) {
                if(i == tmp.value.length) {
                    return 1;
                }
                int cmp = value[i] - tmp.value[i];
                if(cmp != 0) {
                    return cmp;
                }
                i++;
    ...
    public boolean equals(Object obj) {
        if (super.equals(obj)) {
            ...
            if(!property.equals(other.getProperty())) {
                return false;
            }
            if (other instanceof OWLAnnotationAssertionAxiomImplByteArrayStringValue) {
                OWLAnnotationAssertionAxiomImplByteArrayStringValue tmp = (OWLAnnotationAssertionAxiomImplByteArrayStringValue) other;
                return Arrays.equals(tmp.value,value);
            }  else {
