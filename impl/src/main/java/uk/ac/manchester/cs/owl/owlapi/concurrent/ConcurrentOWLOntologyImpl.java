...
public class ConcurrentOWLOntologyImpl implements OWLMutableOntology, HasTrimToSize {
   ...
   * @param readWriteLock The {@link java.util.concurrent.locks.ReadWriteLock} that will provide the
   * locking.
  ...
  @Override
  public <T extends OWLAxiom> Collection<T> filterAxioms(OWLAxiomSearchFilter owlAxiomSearchFilter,
      Object o,
      Imports imports) {
    readLock.lock();
    try {
