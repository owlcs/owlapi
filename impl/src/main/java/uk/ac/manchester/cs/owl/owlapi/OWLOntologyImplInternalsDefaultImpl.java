...
public class OWLOntologyImplInternalsDefaultImpl implements
	...
	protected enum Maps {
			...
			public void initMap(OWLOntologyImplInternalsDefaultImpl impl) {
				if (impl.differentIndividualsAxiomsByIndividual == null) {
					impl.differentIndividualsAxiomsByIndividual = impl.fill(
							...
							DIFFERENT_INDIVIDUALS, individualsubnamed);
				}
			}
		},
		...
		public void initMap(OWLOntologyImplInternalsDefaultImpl impl, Lock l,
				Object field) {
			if (field == null) {
				l.lock();
				try {
