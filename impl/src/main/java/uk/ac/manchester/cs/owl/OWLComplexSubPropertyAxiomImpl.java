 ...
 */
public class OWLComplexSubPropertyAxiomImpl extends OWLPropertyAxiomImpl implements OWLComplextSubPropertyAxiom {
    ...
    public OWLComplexSubPropertyAxiomImpl(OWLDataFactory dataFactory,
