...
public class OWLDataFactoryImpl implements OWLDataFactory {
	...
	public OWLDatatypeRestriction getOWLDatatypeRestriction(OWLDatatype datatype,
		...
		return new OWLDatatypeRestrictionImpl(this, datatype,
				Collections.singleton(getOWLFacetRestriction(facet, typedConstant)));
	}
	...
	public OWLAsymmetricObjectPropertyAxiom getOWLAsymmetricObjectPropertyAxiom(
		...
		return new OWLAsymmetricObjectPropertyAxiomImpl(this, propertyExpression,
				annotations);
	}
	...
	public OWLDataPropertyRangeAxiom getOWLDataPropertyRangeAxiom(
		...
		checkNull(annotations, "annotations");
		return new OWLDataPropertyRangeAxiomImpl(this, property, owlDataRange,
				annotations);
	}
	...
	public OWLNegativeDataPropertyAssertionAxiom getOWLNegativeDataPropertyAssertionAxiom(
		...
		checkNull(subject, "subject");
		checkNull(annotations, "annotations");
		return new OWLNegativeDataPropertyAssertionImplAxiom(this, subject, property,
				object, annotations);
	}
	...
	public OWLNegativeObjectPropertyAssertionAxiom getOWLNegativeObjectPropertyAssertionAxiom(
		...
		checkNull(subject, "subject");
		checkNull(annotations, "annotations");
		return new OWLNegativeObjectPropertyAssertionAxiomImpl(this, subject, property,
				object, annotations);
	}
	...
	public OWLDisjointUnionAxiom getOWLDisjointUnionAxiom(OWLClass owlClass,
		...
		checkNull(classExpressions, "classExpressions");
		checkNull(annotations, "annotations");
		return new OWLDisjointUnionAxiomImpl(this, owlClass, classExpressions,
				annotations);
	}
	...
	public OWLObjectPropertyAssertionAxiom getOWLObjectPropertyAssertionAxiom(
		...
		checkNull(object, "object");
		checkNull(annotations, "annotations");
		return new OWLObjectPropertyAssertionAxiomImpl(this, individual, property,
				object, annotations);
	}
