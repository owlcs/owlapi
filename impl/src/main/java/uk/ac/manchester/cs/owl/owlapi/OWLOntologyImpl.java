...
public class OWLOntologyImpl extends OWLObjectImpl implements OWLMutableOntology, Serializable {
     ...
     * @param includeImportsClosure Specifies that the imports closure should be included when
     * counting axioms
    ...
    public boolean containsAxiom(OWLAxiom axiom) {
        return internals.contains(internals.getAxiomsByType(), axiom.getAxiomType(), axiom);
    }
    ...
    public Set<OWLAnnotationAssertionAxiom> getAnnotationAssertionAxioms(OWLAnnotationSubject subject) {
        ...
        //axioms.addAll(
        return internals.getValues(internals.getAnnotationAssertionAxiomsBySubject(), subject);
        //);
        //return axioms;
    }
     ...
     * @param includeImportsClosure if <code>true</code> the imports closure of this ontology will
    ...
    public boolean containsAxiomIgnoreAnnotations(OWLAxiom axiom) {
        Set<OWLAxiom> set = internals.getValues(internals.getAxiomsByType(), axiom.getAxiomType());
        for (OWLAxiom ax : set) {
...
//		}
     ...
     * specified axiom.
     * @param axiom The axiom that specifies the logical structure of the axioms
     * to retrieve
...
//		result.addAll(annotated);
    ...
    public boolean containsClassInSignature(IRI owlClassIRI) {
        return internals.contains(internals.getOwlClassReferences(), getOWLDataFactory().getOWLClass(owlClassIRI));
    }
    ...
    public boolean containsObjectPropertyInSignature(IRI propIRI) {
        return internals.contains(internals.getOwlObjectPropertyReferences(), getOWLDataFactory().getOWLObjectProperty(propIRI));
    }
    ...
    public boolean containsDataPropertyInSignature(IRI propIRI) {
        return internals.contains(internals.getOwlDataPropertyReferences(), getOWLDataFactory().getOWLDataProperty(propIRI));
    }
    ...
    public boolean containsAnnotationPropertyInSignature(IRI propIRI) {
        ...
        boolean b = internals.contains(internals.getOwlAnnotationPropertyReferences(), owlAnnotationProperty);
        if (b) {
            return true;
        }
        else {
    ...
    public boolean containsIndividualInSignature(IRI individualIRI) {
        return internals.contains(internals.getOwlIndividualReferences(), getOWLDataFactory().getOWLNamedIndividual(individualIRI));
    }
    ...
    public boolean containsDatatypeInSignature(IRI datatypeIRI) {
        return internals.contains(internals.getOwlDatatypeReferences(), getOWLDataFactory().getOWLDatatype(datatypeIRI));
    }
     ...
     * @param iri The IRI
     * @param includeImportsClosure Specifies if the imports closure signature should be taken
     * into account
    ...
    public boolean containsReference(OWLAnnotationProperty property) {
        return internals.contains(internals.getOwlAnnotationPropertyReferences(), property);
    }
    ...
    public Set<OWLAxiom> getReferencingAxioms(OWLEntity owlEntity) {
        return owlEntity.accept(new OWLEntityVisitorEx<Set<OWLAxiom>>() {
            ...
            public Set<OWLAxiom> visit(OWLObjectProperty property) {
                return internals.getValues(internals.getOwlObjectPropertyReferences(), property);
            }

            public Set<OWLAxiom> visit(OWLDataProperty property) {
                return internals.getValues(internals.getOwlDataPropertyReferences(), property);
            }

            public Set<OWLAxiom> visit(OWLNamedIndividual individual) {
                return internals.getValues(internals.getOwlIndividualReferences(), individual);
            }
            ...
            public Set<OWLAxiom> visit(OWLAnnotationProperty property) {
                return internals.getValues(internals.getOwlAnnotationPropertyReferences(), property);
            }
        });
    }
    ...
    public Set<OWLAxiom> getReferencingAxioms(OWLAnonymousIndividual individual) {
        return internals.getValues(internals.getOwlAnonymousIndividualReferences(), individual);
    }
    ...
    public Set<OWLNamedObject> getReferencedObjects() {
        ...
        for (OWLObjectPropertyExpression prop : internals.getKeyset(internals.getOwlObjectPropertyReferences())) {
            if (!prop.isAnonymous()) {
     ...
     * @param includeImportsClosure Specifies whether referenced classes should be drawn from this
     ...
     * @param includeImportsClosure Specifies whether referenced object properties should be drawn
     ...
     * @param includeImportsClosure Specifies whether referenced data properties should be drawn
     * from this ontology or the imports closure. If
     ...
     * ontology, and possibly the imports closure of this ontology.
     * @param includeImportsClosure Specifies whether referenced named individuals should be drawn
     * from this ontology or the imports closure. If
    ...
    public Set<OWLAnnotationProperty> getAnnotationPropertiesInSignature() {
        Set<OWLAnnotationProperty> props = createSet(internals.getKeyset(internals.getOwlAnnotationPropertyReferences()));
        for (OWLAnnotation anno : internals.getOntologyAnnotations()) {
    ...
    public Set<OWLDataPropertyDomainAxiom> getDataPropertyDomainAxioms(OWLDataProperty property) {
        return internals.getValues(internals.getDataPropertyDomainAxiomsByProperty(), property);
    }

    public Set<OWLDataPropertyRangeAxiom> getDataPropertyRangeAxioms(OWLDataProperty property) {
        return internals.getValues(internals.getDataPropertyRangeAxiomsByProperty(), property);
    }

    public Set<OWLEquivalentDataPropertiesAxiom> getEquivalentDataPropertiesAxioms(OWLDataProperty property) {
        return internals.getValues(internals.getEquivalentDataPropertyAxiomsByProperty(), property);
    }

    public Set<OWLDisjointDataPropertiesAxiom> getDisjointDataPropertiesAxioms(OWLDataProperty property) {
        return internals.getValues(internals.getDisjointDataPropertyAxiomsByProperty(), property);
    }

    ////
    public Set<OWLClassAssertionAxiom> getClassAssertionAxioms(OWLIndividual individual) {
        return internals.getValues(internals.getClassAssertionAxiomsByIndividual(), individual);
    }
    ...
    public Set<OWLDataPropertyAssertionAxiom> getDataPropertyAssertionAxioms(OWLIndividual individual) {
        return internals.getValues(internals.getDataPropertyAssertionsByIndividual(), individual);
    }

    public Set<OWLObjectPropertyAssertionAxiom> getObjectPropertyAssertionAxioms(OWLIndividual individual) {
        return internals.getValues(internals.getObjectPropertyAssertionsByIndividual(), individual);
    }

    public Set<OWLNegativeObjectPropertyAssertionAxiom> getNegativeObjectPropertyAssertionAxioms(OWLIndividual individual) {
        return internals.getValues(internals.getNegativeObjectPropertyAssertionAxiomsByIndividual(), individual);
    }

    public Set<OWLNegativeDataPropertyAssertionAxiom> getNegativeDataPropertyAssertionAxioms(OWLIndividual individual) {
        return internals.getValues(internals.getNegativeDataPropertyAssertionAxiomsByIndividual(), individual);
    }

    public Set<OWLSameIndividualAxiom> getSameIndividualAxioms(OWLIndividual individual) {
        return internals.getValues(internals.getSameIndividualsAxiomsByIndividual(), individual);
    }

    public Set<OWLDifferentIndividualsAxiom> getDifferentIndividualAxioms(OWLIndividual individual) {
        return internals.getValues(internals.getDifferentIndividualsAxiomsByIndividual(), individual);
    }
