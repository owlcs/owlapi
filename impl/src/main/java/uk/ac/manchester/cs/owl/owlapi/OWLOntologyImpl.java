...
//	}
	...
	private final class ReferencedAxiomsChecker implements OWLEntityVisitorEx<Boolean> {
		public Boolean visit(OWLClass cls) {
			return internals.hasValues(internals.getOwlClassReferences(), cls);
		}

		public Boolean visit(OWLObjectProperty property) {
			return internals.hasValues(internals.getOwlObjectPropertyReferences(),
					property);
		}

		public Boolean visit(OWLDataProperty property) {
			return internals
					.hasValues(internals.getOwlDataPropertyReferences(), property);
		}

		public Boolean visit(OWLNamedIndividual individual) {
			return internals
					.hasValues(internals.getOwlIndividualReferences(), individual);
		}

		public Boolean visit(OWLDatatype datatype) {
			return internals.hasValues(internals.getOwlDatatypeReferences(), datatype);
		}

		public Boolean visit(OWLAnnotationProperty property) {
			return internals.hasValues(internals.getOwlAnnotationPropertyReferences(),
					property);
		}
	}
