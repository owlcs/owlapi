...
import static org.semanticweb.owlapi6.rdf.rdfxml.parser.RDFConstants.ATTR_ABOUT;
import static org.semanticweb.owlapi6.rdf.rdfxml.parser.RDFConstants.ATTR_ABOUT_EACH;
import static org.semanticweb.owlapi6.rdf.rdfxml.parser.RDFConstants.ATTR_ABOUT_EACH_PREFIX;
import static org.semanticweb.owlapi6.rdf.rdfxml.parser.RDFConstants.ATTR_BAG_ID;
import static org.semanticweb.owlapi6.rdf.rdfxml.parser.RDFConstants.ATTR_DATATYPE;
import static org.semanticweb.owlapi6.rdf.rdfxml.parser.RDFConstants.ATTR_ID;
import static org.semanticweb.owlapi6.rdf.rdfxml.parser.RDFConstants.ATTR_NODE_ID;
import static org.semanticweb.owlapi6.rdf.rdfxml.parser.RDFConstants.ATTR_PARSE_TYPE;
import static org.semanticweb.owlapi6.rdf.rdfxml.parser.RDFConstants.ATTR_RESOURCE;
import static org.semanticweb.owlapi6.rdf.rdfxml.parser.RDFConstants.ELT_DESCRIPTION;
import static org.semanticweb.owlapi6.rdf.rdfxml.parser.RDFConstants.ELT_RDF;
import static org.semanticweb.owlapi6.rdf.rdfxml.parser.RDFConstants.ELT_TYPE;
import static org.semanticweb.owlapi6.rdf.rdfxml.parser.RDFConstants.PARSE_TYPE_COLLECTION;
import static org.semanticweb.owlapi6.rdf.rdfxml.parser.RDFConstants.PARSE_TYPE_LITERAL;
import static org.semanticweb.owlapi6.rdf.rdfxml.parser.RDFConstants.PARSE_TYPE_RESOURCE;
import static org.semanticweb.owlapi6.rdf.rdfxml.parser.RDFConstants.RDFNS;
import static org.semanticweb.owlapi6.rdf.rdfxml.parser.RDFConstants.RDF_BAG;
import static org.semanticweb.owlapi6.rdf.rdfxml.parser.RDFConstants.RDF_FIRST;
import static org.semanticweb.owlapi6.rdf.rdfxml.parser.RDFConstants.RDF_LI;
import static org.semanticweb.owlapi6.rdf.rdfxml.parser.RDFConstants.RDF_LIST;
import static org.semanticweb.owlapi6.rdf.rdfxml.parser.RDFConstants.RDF_NIL;
import static org.semanticweb.owlapi6.rdf.rdfxml.parser.RDFConstants.RDF_REST;
import static org.semanticweb.owlapi6.rdf.rdfxml.parser.RDFConstants.RDF_TYPE;
import static org.semanticweb.owlapi6.rdf.rdfxml.parser.RDFConstants.RDF_XMLLITERAL;
import static org.semanticweb.owlapi6.rdf.rdfxml.parser.RDFConstants.XMLLANG;
import static org.semanticweb.owlapi6.rdf.rdfxml.parser.RDFConstants.XMLNS;
...
abstract class AbstractState {
     ...
     */
    void propertyAttributes(String subjectIRI, Attributes atts,
        ReificationManager reificationManager) {
        ...
        for (int i = 0; i < length; i++) {
            ...
            if (!XMLNS.equals(nsIRI) && !XMLLANG.equals(localName)
                && !(RDFNS.equals(nsIRI) && (ATTR_ID.equals(localName)
                    || ATTR_NODE_ID.equals(localName) || ATTR_ABOUT.equals(localName)
                    || ELT_TYPE.equals(localName) || ATTR_RESOURCE.equals(localName)
                    || ATTR_PARSE_TYPE.equals(localName) || ATTR_ABOUT_EACH.equals(localName)
                    || ATTR_ABOUT_EACH_PREFIX.equals(localName)
                    || ATTR_BAG_ID.equals(localName)))) {
                String reificationID = reificationManager.getReificationID(null, parser);
                parser.statementWithLiteralValue(subjectIRI, nsIRI + localName, value, null,
                    reificationID);
            } else if (RDFNS.equals(nsIRI) && ELT_TYPE.equals(localName)) {
                String resolvedValue = parser.resolveIRI(value);
                String reificationID = reificationManager.getReificationID(null, parser);
                parser.statementWithResourceValue(subjectIRI, nsIRI + localName, resolvedValue,
                    reificationID);
            }
        }
    }
    ...
    /**
     * Extracts the IRI of the resource from rdf:resource or rdf:nodeID attribute. If no attribute
     ...
     * @return true if the character is other than a space, carriage return, or tabulator
     */
...
class EmptyPropertyElement extends AbstractState implements State {
    ...
    public void startElement(String namespaceIRI, String localName, String qName, Attributes atts) {
        ...
        parser.statementWithResourceValue(nodeElement.subjectIRI(), propertyIRI(), objectIRI,
            reificationID);
...
class NodeElement extends AbstractState implements State {
    ...
    public void startElement(String namespaceIRI, String localName, String qName, Attributes atts) {
        ...
        if (!isRDFNS || !ELT_DESCRIPTION.equals(localName)) {
            parser.statementWithResourceValue(subjectIRI(), RDF_TYPE, namespaceIRI + localName,
                verifyNotNull(reificationManager).getReificationID(null, parser));
        }
    ...
    /**
     * Extracts the IRI of the resource from rdf:ID, rdf:nodeID or rdf:about attribute. If no
     * attribute is found, an IRI is generated.
     *
     * @param atts atts
...
class ParseTypeCollectionElement extends AbstractState implements State {
    ...
    public void startElement(String namespaceIRI, String localName, String qName, Attributes atts)
        ...
        if (pIRI == null) {
            ...
            if (lastCellIRI == null) {
                parser.statementWithResourceValue(nodeElement.subjectIRI(), propertyIRI(),
                    newListCellIRI, reificationID);
            } else {
    ...
    public void endElement(String namespaceIRI, String localName, String qName) {
        if (lastCellIRI == null) {
            parser.statementWithResourceValue(nodeElement.subjectIRI(), propertyIRI(), RDF_NIL,
                reificationID);
        } else {
...
/**
 * Parses resourcePropertyElt or literalPropertyElt productions. m_text is {@code null} when
...
class ResourceOrLiteralElement extends AbstractState implements State {
    ...
    public void endElement(String namespaceIRI, String localName, String qName) {
        if (innerNode != null) {
            parser.statementWithResourceValue(nodeElement.subjectIRI(), propertyIRI(),
                verifyNotNull(innerNode).subjectIRI(), reificationID);
        } else {
            parser.statementWithLiteralValue(nodeElement.subjectIRI(), propertyIRI(),
                verifyNotNull(text).toString(), datatype, reificationID);
        }
        parser.popState();
    }
...
/**
 * Parses the propertyEltList production. The contents of the startElement method implements also
 * the propertyElt production.
 */
class PropertyElementList extends AbstractState implements State {
    ...
    public void startElement(String namespaceIRI, String localName, String qName, Attributes atts)
        ...
        if (PARSE_TYPE_LITERAL.equals(parseType)
            || RDF_XMLLITERAL.equals(atts.getValue(RDFNS, ATTR_DATATYPE))) {
...
class ReifiedStatementBag extends ReificationManager {
    ...
    protected String getReificationID(@Nullable String reificationID, RDFParser parser) {
        ...
        parser.statementWithResourceValue(iri, RDFNS + '_' + elements.getAndIncrement(), resultIRI,
            null);
        return resultIRI;
    }
}
