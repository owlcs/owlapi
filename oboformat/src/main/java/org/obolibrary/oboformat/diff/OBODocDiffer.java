...
public class OBODocDiffer {
    ...
    // FRAME LISTS
    @Nonnull
    private List<Diff> getDiffsAsym(String ftype, @Nonnull Collection<Frame> fl1,
    ...
    // FRAMES
    @Nonnull
    private List<Diff> getDiffsAsym(String ftype, @Nonnull Frame f1, @Nonnull Frame f2, int n) {
        List<Diff> diffs = new ArrayList<Diff>();
    ...
    @Nonnull
    private List<Diff> getDiffs(String ftype, @Nonnull Frame f1, @Nonnull Frame f2) {
