...
public class OBOFormatParser {
    ...
    private void addOboNamespace(@Nullable Collection<Frame> frames,
    ...
    private String mapDeprecatedTag(@Nonnull String tag) {
    ...
    private String removeTrailingWS(@Nonnull String s) {
