...
class OWLOBO12Parser extends AbstractOWLParser {
    ...
    private Reader reader(OWLOntologyDocumentSource source,
    ...
    private InputStream wrapInput(OWLOntologyDocumentSource source,
        ...
        return new BufferedInputStream(getInputStream(source.getDocumentIRI(),
                configuration));
    }

    @Override
    public OWLOntologyFormat parse(OWLOntologyDocumentSource source,
