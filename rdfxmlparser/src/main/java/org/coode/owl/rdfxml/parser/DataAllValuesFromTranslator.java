...
public class DataAllValuesFromTranslator extends AbstractDataQuantifiedRestrictionTranslator {
    ...
    protected OWLDescription createRestriction(OWLDataPropertyExpression prop, OWLDataRange filler) throws
                                                                                                    OWLException {

        return getDataFactory().getOWLDataAllRestriction(prop, filler);
    }
