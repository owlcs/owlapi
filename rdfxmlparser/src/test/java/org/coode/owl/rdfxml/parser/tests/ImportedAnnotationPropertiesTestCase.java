...
public class ImportedAnnotationPropertiesTestCase extends TestCase {
    ...
    public void testImportedAnnotationProperties() throws Exception {
        ...
        assertTrue(ontA.getIndividualsInSignature().contains(ind));
        assertTrue(ontA.containsAnnotationPropertyInSignature(IRI.create("http://www.semanticweb.org/owlapi/annotationprops#myProp")));
    }
}
