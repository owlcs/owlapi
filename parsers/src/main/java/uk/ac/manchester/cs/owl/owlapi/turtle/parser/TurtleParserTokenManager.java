...
private int jjMoveStringLiteralDfa0_0()
{
   switch(curChar)
   {
      ...
      case 97:
         return jjStartNfaWithStates_0(0, 29, 62);
      case 102:
...
private int jjMoveStringLiteralDfa3_0(long old0, long active0)
{
   ...
   switch(curChar)
   {
      ...
      case 101:
         if ((active0 & 0x100000000L) != 0L) {
            return jjStartNfaWithStates_0(3, 32, 62);
        }
   ...
   switch(curChar)
   {
      ...
      case 69:
         if ((active0 & 0x800000000L) != 0L) {
            return jjStartNfaWithStates_0(4, 35, 62);
        }
   ...
   switch(curChar)
   {
      case 82:
         if ((active0 & 0x1000000000L) != 0L) {
            return jjStartNfaWithStates_0(5, 36, 62);
        }
         break;
      case 84:
...
static final int[] jjnextStates = {
   24, 25, 28, 29, 43, 44, 46, 24, 28, 2, 48, 30, 33, 38, 30, 33, 
   39, 40, 38, 43, 44, 46, 50, 51, 52, 53, 54, 55, 59, 60, 5, 6, 
   11, 12, 26, 27, 31, 32, 36, 37, 41, 42, 
};
...
public TurtleParserTokenManager(JavaCharStream stream){
   if (uk.ac.manchester.cs.JavaCharStream.staticFlag) {
