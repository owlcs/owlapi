                ...
                do {
                    switch (jjstateSet[--i]) {
                        ...
                        case 4:
                            ...
                            break;
                        case 6:
                            if ((0x2400L & l) != 0L && kind > 14) kind = 14;
                            break;
                        default:
                            break;
                    }
                ...
                do {
                    switch (jjstateSet[--i]) {
                        case 2:
                            ...
                            break;
                        case 0:
                            if ((0xfffffffcffffd9ffL & l) == 0L) break;
                            kind = 15;
                            jjCheckNAdd(0);
                            break;
                        case 1:
            ...
            if (curChar < 64) {
                ...
                do {
                    switch (jjstateSet[--i]) {
                        ...
                        case 1:
                            ...
                            break;
                        case 2:
                            if ((0xfbffffffffffdbffL & l) == 0L) break;
                            if (kind > 9) kind = 9;
                            jjCheckNAdd(2);
                            break;
                        default:
                ...
                do {
                    switch (jjstateSet[--i]) {
                        case 0:
                        case 2:
                            if ((0xfffffffff7ffffffL & l) == 0L) break;
                            if (kind > 9) kind = 9;
                            jjCheckNAdd(2);
                            break;
                        case 1:
        ...
        for (;;) {
            ...
            if (curChar < 64) {
                ...
                do {
                    switch (jjstateSet[--i]) {
                        case 0:
                            if ((0xffffffffdfffffffL & l) == 0L) break;
                            kind = 7;
                            jjstateSet[jjnewStateCnt++] = 0;
                            break;
                        default:
