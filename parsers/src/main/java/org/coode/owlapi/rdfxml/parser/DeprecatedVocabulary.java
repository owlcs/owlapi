...
class DeprecatedVocabulary {
        ...
        static IRI OWL_DISJOINT_DATA_PROPERTIES = IRI.create(OWL,
        ...
        static IRI OWL_EQUIVALENT_DATA_PROPERTIES = IRI.create(OWL,
        ...
        static IRI OWL_FUNCTIONAL_DATA_PROPERTY = IRI.create(OWL,
