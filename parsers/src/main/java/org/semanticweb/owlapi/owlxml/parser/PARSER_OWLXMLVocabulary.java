...
//@formatter:off
   ...
   */PARSER_DISJOINT_OBJECT_PROPERTIES(DISJOINT_OBJECT_PROPERTIES, DisjointObjectPropertiesEH::new),
  /**
...
class OntologyEH extends OWLEH<OWLOntology, Builder<OWLOntology>> {
  ...
  void attribute(String localName, String value) {
    ...
    if ("ontologyIRI".equals(localName)) {
      o.applyChange(
          new SetOntologyID(o, new OWLOntologyID(optional(IRI.create(value)), o.getOntologyID()
              .getVersionIRI())));
    }
    if ("versionIRI".equals(localName)) {
      o.applyChange(
          new SetOntologyID(o, new OWLOntologyID(o.getOntologyID().getOntologyIRI(), optional(IRI
              .create(value)))));
    }
  }
