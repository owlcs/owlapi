...
public class FunctionalSyntaxForAxiomsOnlyParser {
     ...
     */
    public void parse(OWLOntology o, OWLOntologyLoaderConfiguration config, String content) {
        OWLFunctionalSyntaxParser parser =
            new OWLFunctionalSyntaxParser(new CustomTokenizer(new StringReader(content))) {
