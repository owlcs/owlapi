...
public class OWLFunctionalSyntaxParser implements OWLFunctionalSyntaxParserConstants {
  ...
  final public OWLFunctionalSyntaxOntologyFormat parse() throws ParseException, OWLParserException, UnloadableImportException {
    label_1:
    while (true) {
...
if(filler == null) {
            ...
            {if ("" != null) return dataFactory.getOWLObjectMinCardinality(cardinality, prop, filler);}
        }
    throw new Error("Missing return statement in function");
  }
...
if(filler == null) {
            ...
            {if ("" != null) return dataFactory.getOWLObjectExactCardinality(cardinality, prop, filler);}
        }
    throw new Error("Missing return statement in function");
  }
...
if(filler == null) {
            ...
            {if ("" != null) return dataFactory.getOWLObjectMaxCardinality(cardinality, prop, filler);}
        }
    throw new Error("Missing return statement in function");
  }
...
if(rng == null) {
            ...
            {if ("" != null) return dataFactory.getOWLDataMinCardinality(cardinality, prop, rng);}
        }
    throw new Error("Missing return statement in function");
  }
...
if(rng == null) {
            ...
            {if ("" != null) return dataFactory.getOWLDataExactCardinality(cardinality, prop, rng);}
        }
    throw new Error("Missing return statement in function");
  }
...
if(rng == null) {
            ...
            {if ("" != null) return dataFactory.getOWLDataMaxCardinality(cardinality, prop, rng);}
        }
    throw new Error("Missing return statement in function");
  }
...
{if ("" != null) return prop;}
  ...
  final public OWLObjectPropertyExpression InverseObjectProperty() throws ParseException {OWLObjectPropertyExpression prop;
...
String id = t.image.substring(2, t.image.length());
        {if ("" != null) return dataFactory.getOWLAnonymousIndividual(id);}
    throw new Error("Missing return statement in function");
  }
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////
  final public 
OWLAxiom Axiom() throws ParseException {OWLAxiom ax = null;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case SUBCLASSOF:
    case EQUIVALENTCLASSES:
    case DISJOINTCLASSES:
...
if(ignoreAnnotationsAndDeclarations) {
            ...
            {if ("" != null) return dataFactory.getOWLDeclarationAxiom(entity, axiomAnnos);}
        }
    throw new Error("Missing return statement in function");
  }
...
String raw = t.image.substring(1, t.image.length() - 1);
  ...
  final public String LangTag() throws ParseException {String lang = "";
        Token t;
...
{if ("" != null) return dataFactory.getSWRLRule(body, head, annos);}
  ...
  final public SWRLAtom Atom() throws ParseException {SWRLAtom atom;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case CLASSATOM:{
      atom = ClassAtom();
      break;
...
{if ("" != null) return dataFactory.getSWRLIndividualArgument(ind);}
  ...
  final public SWRLDArgument DArg() throws ParseException {OWLLiteral literal;
    IRI iri;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case VARIABLE:{
      jj_consume_token(VARIABLE);
