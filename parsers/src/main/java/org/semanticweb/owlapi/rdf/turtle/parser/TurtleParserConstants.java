...
interface TurtleParserConstants {
    ...
    String[] tokenImage = {"<EOF>", "\" \"", "\"\\n\"", "\"\\t\"", "\"\\r\"", "<COMMENT>",
                    ...
                    "<token of kind 11>", "<token of kind 12>", "\"\\\'\"", "\"\\\"\\\"\\\"\"",
                    "<token of kind 15>", "<token of kind 16>", "\"\\\"\\\"\\\"\"",
                    "\"\\\'\\\'\\\'\"", "<token of kind 19>", "<token of kind 20>",
                    "\"\\\'\\\'\\\'\"", "<DIGIT>", "<INTEGER>", "<DOUBLE>", "<DECIMAL>",
                    "<EXPONENT>", "\"(\"", "\")\"", "\"[\"", "\"]\"", "\",\"", "\".\"", "\";\"",
                    "\"@prefix\"", "\"^^\"", "\"@base\"", "\"@\"", "\"a\"", "<EMPTY_BLANK_NODE>",
                    "\"_:\"", "\"true\"", "\"false\"", "\"SELECT\"", "\"WHERE\"", "\"FILTER\"",
                    "<LETTER>", "<FULLIRI>", "<PNAME_NS>", "<PN_LOCAL>", "<PNAME_LN>",
                    "<PN_PREFIX>", "<PN_CHARS_BASE>", "<PN_CHARS>", "<PN_CHARS_U>", "<NODEID>",
                    "<ERROR>",};
