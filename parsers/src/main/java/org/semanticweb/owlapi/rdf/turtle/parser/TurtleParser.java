...
public class TurtleParser implements TurtleParserConstants {
  ...
  private static void jj_la1_init_0() {
    jj_la1_0 = new int[]{0x28000000, 0x28000000, 0x0, 0x0, 0x28000000, 0x0, 0x0, 0x28000000, 0x0,
        0x0, 0x0, 0x80000000, 0x28000000, 0x2be22200, 0x2be22200, 0x0, 0x0, 0x3e22200, 0xc00000,
        0x0, 0x222200,};
  }

  private static void jj_la1_init_1() {
    jj_la1_1 = new int[]{0x858094, 0x858094, 0x14, 0x58040, 0x858080, 0x1, 0x58040, 0x800080, 0x2,
        0x58040, 0x8000, 0x0, 0x858080, 0x858680, 0x858680, 0x28, 0x28, 0x600, 0x0, 0x600, 0x0,};
  }
  ...
  public IRI getIRI(String s) {
    ...
    if (iri == null) {
      ...
      if (!iri.isAbsolute()) {
        iri = IRI
            .create(base.getNamespace().substring(0, base.getNamespace().lastIndexOf('/') + 1), s);
      }
