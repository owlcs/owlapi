...
public class TurtleParser implements TurtleParserConstants {
    ...
    public IRI getIRI(String s) {
        ...
        if (iri == null) {
            iri = IRI.create(s);
            if (!iri.isAbsolute()) {
                iri = IRI.create(base.getNamespace().substring(0,
    ...
    final public IRI parseItemList() throws ParseException {// _x rdf:type rdf:List
        ...
        label_4: while (true) {
            ...
            if (prevSubject != null) {
                handler.statementWithResourceValue(prevSubject, rest, subject);
            } else {
                firstSubject = subject;
            }
            if (subject != null) {
                handler.statementWithResourceValue(subject, type, list);
            }
            parseObject(subject, first);
        }
        // Terminate list
        if (subject != null) {
            handler.statementWithResourceValue(subject, rest, nil);
        }
        return firstSubject;
    }
    ...
    final public void parseLiteral(IRI subject, IRI predicate) throws ParseException {
        ...
        switch ((jj_ntk == -1) ? jj_ntk_f() : jj_ntk) {
            ...
            case LONG_SINGLESTRING: {
                ...
                if (datatype != null) {
                    handler.statementWithLiteralValue(subject, predicate, literal, null, datatype);
                } else if (lang != null) {
                    handler.statementWithLiteralValue(subject, predicate, literal, lang, null);
                } else {
                    handler.statementWithLiteralValue(subject, predicate, literal, null, null);
                }
                break;
            }
            case DIGIT:
            case INTEGER: {
                ...
                handler.statementWithLiteralValue(subject, predicate, literal, null,
    ...
    private static void jj_la1_init_0() {
        jj_la1_0 = new int[] {0x28000000, 0x28000000, 0x0, 0x0, 0x28000000, 0x0, 0x0, 0x28000000,
                        0x0, 0x0, 0x0, 0x80000000, 0x28000000, 0x2be22200, 0x2be22200, 0x0, 0x0,
                        0x3e22200, 0xc00000, 0x0, 0x222200,};
    }

    private static void jj_la1_init_1() {
        jj_la1_1 = new int[] {0x858094, 0x858094, 0x14, 0x58040, 0x858080, 0x1, 0x58040, 0x800080,
                        0x2, 0x58040, 0x8000, 0x0, 0x858080, 0x858680, 0x858680, 0x28, 0x28, 0x600,
                        0x0, 0x600, 0x0,};
    }
