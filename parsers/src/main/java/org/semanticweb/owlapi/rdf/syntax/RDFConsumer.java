...
public interface RDFConsumer {
     ...
     *         sax exception
     */
    void statementWithResourceValue(String subject, String predicate,
     ...
     *         sax exception
     */
    void statementWithLiteralValue(String subject, String predicate,
     ...
     *         sax exception
     */
    void includeModel(String logicalURI, String physicalURI)
            throws SAXException;
