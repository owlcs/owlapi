...
public class BinaryOWLMetadataChunk {
    ...
    public BinaryOWLMetadataChunk(DataInput dataInput, OWLDataFactory dataFactory) throws IOException, BinaryOWLParseException {
    ...
    public void write(DataOutputStream dataOutput) throws IOException {
        ...
        metadata.write(new DataOutputStream(buffer));

        dataOutput.writeInt(buffer.size());
        dataOutput.writeInt(CHUNK_TYPE);
