...
public class SetOntologyIDDataSerializer extends OntologyChangeDataSerializer<SetOntologyIDData> {
    ...
    @Override
    public void write(SetOntologyIDData recordData, LookupTable lookupTable, DataOutput dataOutput) throws IOException {
        OWLOntologyID id = recordData.getNewId();
        BinaryOWLOntologyID serializer = new BinaryOWLOntologyID(id);
        serializer.write(dataOutput);
    }

    @Override
    public SetOntologyIDData read(DataInput dataInput, LookupTable lookupTable, OWLDataFactory dataFactory) throws IOException, BinaryOWLParseException {
        BinaryOWLOntologyID serializer = new BinaryOWLOntologyID(dataInput, dataFactory);
