...
public class BinaryOWLImportsDeclarationSet {
    ...
    public BinaryOWLImportsDeclarationSet(DataInput dataInput, OWLDataFactory dataFactory) throws IOException, BinaryOWLParseException {
        ...
        if(size == 0) {
            ...
            for(int i = 0; i < size; i++) {
                BinaryOWLImportsDeclaration binDecl = new BinaryOWLImportsDeclaration(dataInput, dataFactory);
