...
public class BinaryOWLOntologyDocumentPreamble {
    ...
    private BinaryOWLOntologyDocumentPreamble(int version) {
    ...
    private void read(DataInputStream dataInputStream) throws IOException, BinaryOWLParseException {
        ...
        if(magicNumber != MAGIC_NUMBER) {
            throw new BinaryOWLParseException("Corrupt file or invalid file format (Magic Number Not Present)");
        }
        fileFormatVersion = dataInputStream.readShort();
    }
    ...
    public void write(DataOutputStream dos) throws IOException {
        ...
        dos.writeShort(fileFormatVersion);
    }
