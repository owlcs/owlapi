...
public class OWLObjectMaxCardinalityRestrictionSerializer extends OWLObjectCardinalityRestrictionSerializer<OWLObjectMaxCardinality> {
    ...
    @Override
    protected OWLObjectMaxCardinality createRestriction(int cardinality, OWLObjectPropertyExpression property, OWLClassExpression filler, OWLDataFactory dataFactory) {
