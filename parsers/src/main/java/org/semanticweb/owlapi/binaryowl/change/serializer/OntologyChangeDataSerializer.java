...
public abstract class OntologyChangeDataSerializer<R extends OWLOntologyChangeData> {
    ...
    public abstract void write(R ontologyChangeRepresentative, LookupTable lookupTable, DataOutput dataOutput) throws IOException;
    
    public abstract R read(DataInput dataInput, LookupTable lookupTable, OWLDataFactory dataFactory) throws IOException, BinaryOWLParseException;
}
