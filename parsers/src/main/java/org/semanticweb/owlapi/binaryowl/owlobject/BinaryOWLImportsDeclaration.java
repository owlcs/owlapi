...
public class BinaryOWLImportsDeclaration {
    ...
    public BinaryOWLImportsDeclaration(DataInput dataInput, OWLDataFactory df) throws IOException, BinaryOWLParseException {
        IRISerializer serializer = new IRISerializer();
        IRI iri = serializer.read(LookupTable.emptyLookupTable(), dataInput, df);
        importsDeclaration = df.getOWLImportsDeclaration(iri);
    }
    ...
    public void write(DataOutput dataOutput) throws IOException {
        IRI iri = importsDeclaration.getIRI();
        IRISerializer serializer = new IRISerializer();
        serializer.write(iri, LookupTable.emptyLookupTable(), dataOutput);
    }
}
