...
public class OWLObjectHasValueSerializer extends OWLObjectSerializer<OWLObjectHasValue> {
    ...
    @Override
    protected void writeObject(OWLObjectHasValue object, LookupTable lookupTable, DataOutput dataOutput) throws IOException {
    ...
    @Override
    protected OWLObjectHasValue readObject(LookupTable lookupTable, DataInput dataInput, OWLDataFactory dataFactory) throws IOException, BinaryOWLParseException {
        OWLObjectPropertyExpression property = readTypeMarkedObject(lookupTable, dataInput, dataFactory);
        OWLIndividual value = readTypeMarkedObject(lookupTable, dataInput, dataFactory);
