...
public class ModuleAnnotationsTestCase extends TestBase {
    ...
    private OWLAnnotationProperty replaced = df.getOWLAnnotationProperty("urn:test:term_replaced_by");
    ...
    OWLAnnotationAssertionAxiom ax = df.getOWLAnnotationAssertionAxiom(replaced, a.getIRI(), b.getIRI());
    ...
    public void shouldNotAddAnnotations() throws OWLOntologyCreationException {
        ...
        o.add(dR, dA, dB, ax);
        Set<OWLAxiom> module = new SyntacticLocalityModuleExtractor(m, o, ModuleType.STAR).extract(e);
