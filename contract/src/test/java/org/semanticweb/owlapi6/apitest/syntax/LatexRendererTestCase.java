...
public class LatexRendererTestCase extends TestBase {
    ...
    public void shouldRenderEscapingUnderscores() throws Exception {
        OWLOntology o = loadOntologyFromString(TestFiles.latexWithUnderscores, new LatexDocumentFormat());
    ...
    public void shouldSaveInverses() throws OWLOntologyStorageException {
        OWLOntology o = loadOntologyFromString(TestFiles.latexWithInverse, new LatexDocumentFormat());
        assertEquals(TestFiles.latexExpectedOutput, saveOntology(o, new LatexDocumentFormat()).toString());
    }
}
