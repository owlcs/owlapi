...
public class LoadAnonymousTestCase extends TestBase {
    ...
    public void shouldLoad() throws OWLOntologyCreationException {
        StringDocumentSource streamDocumentSource = new StringDocumentSource(TestFiles.loadOboAnonymous,
        ...
        Set<OWLAxiom> expected = new HashSet<>(Arrays.asList(Declaration(date), Declaration(autogeneratedby),
            ...
            Declaration(createdBy), Declaration(inSubset), Declaration(savedby), Declaration(pato0001708),
            Declaration(uo0), Declaration(RDFSComment()), Declaration(RDFSLabel()), Declaration(hasOBONamespace),
            ...
            SubAnnotationPropertyOf(unitSlim, subsetProperty), comment(valueSlim.getIRI(), literal("Value slim")),
            SubAnnotationPropertyOf(absentSlim, subsetProperty), SubAnnotationPropertyOf(abnormalSlim, subsetProperty),
            ...
            SubAnnotationPropertyOf(attributeSlim, subsetProperty), label(uo0.getIRI(), literal("unit")),
            SubAnnotationPropertyOf(dispositionSlim, subsetProperty), comment(unitSlim.getIRI(), literal("unit slim")),
            ...
            label(inSubset.getIRI(), literal("in_subset")), SubAnnotationPropertyOf(valueSlim, subsetProperty),
