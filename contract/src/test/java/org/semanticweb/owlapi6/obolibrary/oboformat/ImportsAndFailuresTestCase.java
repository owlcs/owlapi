...
public class ImportsAndFailuresTestCase extends TestBase {
    ...
    @Test
    public void shouldNotFailOnEmptyImport() throws OWLOntologyCreationException, OWLOntologyStorageException {
    ...
    @Test
    public void shouldNotFailOnNoImport() throws OWLOntologyCreationException, OWLOntologyStorageException {
        String input = "ontology: uberon\n" + "[Term]\nid: X:1\nname: x1\nrelationship: part_of X:2\n\n"
            + "[Typedef]\nid: part_of\nxref: BFO:0000050";
        OWLOntology o = m1.loadOntologyFromOntologyDocument(new StringDocumentSource(input, new OBODocumentFormat()));
    ...
    @Test
    public void shouldNotFailOnPatoImport() throws OWLOntologyCreationException, OWLOntologyStorageException {
    ...
    @Test
    public void shouldNotFailOnNoPatoImport() throws OWLOntologyCreationException, OWLOntologyStorageException {
        String input = "format-version: 1.2\n" + "ontology: uberon/core\n" + "\n" + "[Term]\n" + "id: UBERON:0004138\n"
            + "name: somitomeric trunk muscle\n" + "property_value: seeAlso \"string\"\n" + "\n" + "[Typedef]\n"
            + "id: seeAlso\n" + "name: seeAlso\n" + "is_metadata_tag: true\n" + "is_class_level: true";
        OWLOntology o = m1.loadOntologyFromOntologyDocument(new StringDocumentSource(input, new OBODocumentFormat()));
