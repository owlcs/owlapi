...
public class IsAnonymousTestCase extends TestBase {
    ...
    public void shouldCheckAnonymous() throws OWLOntologyCreationException {
        ...
        SWRLClassAtom sc = df.getSWRLClassAtom(c, df.getSWRLIndividualArgument(df.getOWLNamedIndividual(j)));
        ...
        assertTrue(df.getOWLSubAnnotationPropertyOfAxiom(df.getRDFSLabel(), df.getRDFSLabel()).isAnonymous());
