...
import static org.semanticweb.owlapi6.api.test.TestEntities.areaTotal;
import static org.semanticweb.owlapi6.api.test.TestEntities.southAfrica;
...
import org.semanticweb.owlapi6.api.test.TestEntities;
...
public class TurtleTestCase extends TestBase {
    ...
    private static final OWLClass taxTerm = Class(IRI("http://schema.wolterskluwer.de/", "TaxonomyTerm"));
    private static final OWLAnnotationProperty broader = AnnotationProperty(
        IRI("http://www.w3.org/2004/02/skos/core#", "broader"));
    private static final OWLClass concept = Class(IRI("http://www.w3.org/2004/02/skos/core#", "Concept"));
    ...
    @Test
    public void shouldSaveIRIsWithCommasInTurtle() throws OWLOntologyCreationException, OWLOntologyStorageException {
    ...
    @Test
    public void shouldSaveIRIsWithCommasInRioTurtle() throws OWLOntologyCreationException, OWLOntologyStorageException {
        OWLOntology o = m.createOntology(df.getIRI(TestFiles.NS));
        OWLNamedIndividual individual = df.getOWLNamedIndividual(indXY);
        OWLAxiom axiom = df.getOWLDeclarationAxiom(individual);
        o.add(axiom);
    ...
    public void shouldParseFixedQuotesLiterals1() throws OWLOntologyCreationException {
        OWLOntology o = loadOntologyFromString(new StringDocumentSource(TestFiles.quotes1, iri, tf, null));
    ...
    public void shouldParseFixedQuotesLiterals6() throws OWLOntologyCreationException {
        OWLOntology o = loadOntologyFromString(new StringDocumentSource(TestFiles.quotes6, iri, tf, null));
        o.annotationAssertionAxioms(s)
            .forEach(ax -> assertEquals("3'''-acetate; [cut]", ((OWLLiteral) ax.getValue()).getLiteral()));
    }

    @Test
    public void shouldParseFixedQuotesLiterals2() throws OWLOntologyCreationException {
        OWLOntology o = loadOntologyFromString(new StringDocumentSource(TestFiles.quotes2, iri, tf, null));
        o.annotationAssertionAxioms(s)
    ...
    public void shouldParseFixedQuotesLiterals3() throws OWLOntologyCreationException {
        OWLOntology o = loadOntologyFromString(new StringDocumentSource(TestFiles.quotes3, iri, tf, null));
        o.annotationAssertionAxioms(s)
    ...
    public void shouldParseFixedQuotesLiterals4() throws OWLOntologyCreationException {
        OWLOntology o = loadOntologyFromString(new StringDocumentSource(TestFiles.quotes4, iri, tf, null));
        o.annotationAssertionAxioms(s).forEach(ax -> assertEquals("\"\"\"", ((OWLLiteral) ax.getValue()).getLiteral()));
    }

    @Test
    public void shouldParseFixedQuotesLiterals5() throws OWLOntologyCreationException {
        OWLOntology o = loadOntologyFromString(new StringDocumentSource(TestFiles.quotes5, iri, tf, null));
    ...
    public void shouldResolveAgainstBase() {
        // given
        // when
        OWLOntology o = loadOntologyFromString(TestFiles.resolveAgainstBase, new TurtleDocumentFormat());
        // then
    ...
    public void shouldRoundTripTurtleWithsharedBnodes() throws Exception {
        ...
        try {
            OWLOntology ontology = loadOntologyFromString(TestFiles.turtleWithShared, new TurtleDocumentFormat());
    ...
    public void shouldParseScientificNotation() {
        OWLOntology ontology = loadOntologyFromString(TestFiles.scientificNotationPlus, new TurtleDocumentFormat());
        assertTrue(ontology.annotationPropertiesInSignature().anyMatch(ap -> ap.equals(areaTotal)));
        assertTrue(ontology
            .containsAxiom(AnnotationAssertion(areaTotal, southAfrica, Literal("1.0E7", OWL2Datatype.XSD_DOUBLE))));
    }
    ...
    public void shouldParseScientificNotationWithMinus() {
        ...
        assertTrue(ontology.annotationPropertiesInSignature().anyMatch(ap -> ap.equals(areaTotal)));
        assertTrue(ontology.containsAxiom(AnnotationAssertion(areaTotal, southAfrica, TestEntities.oneMillionth)));
    }
    ...
    public void shouldParseTwo() {
        OWLOntology ontology = loadOntologyFromString(TestFiles.parseTwo, new TurtleDocumentFormat());
        assertTrue(ontology.annotationPropertiesInSignature().anyMatch(ap -> ap.equals(areaTotal)));
    ...
    public void shouldParseOne() {
        OWLOntology ontology = loadOntologyFromString(TestFiles.parseOne, new TurtleDocumentFormat());
        assertTrue(ontology.annotationPropertiesInSignature().anyMatch(ap -> ap.equals(areaTotal)));
        assertTrue(ontology
            .containsAxiom(AnnotationAssertion(areaTotal, southAfrica, Literal("1.0", OWL2Datatype.XSD_DECIMAL))));
    }

    @Test
    public void shouldParseEmptySpaceInBnode() {
        OWLOntology ontology = loadOntologyFromString(TestFiles.emptySpaceInBnode, new TurtleDocumentFormat());
    ...
    public void shouldRoundTripAxiomAnnotation() throws Exception {
        masterConfigurator.withRemapAllAnonymousIndividualsIds(false);
        try {
            OWLOntology ontology = loadOntologyFromString(TestFiles.axiomAnnotations, new TurtleDocumentFormat());
    ...
    public void shouldRoundTripAxiomAnnotationWithSlashOntologyIRI() throws Exception {
        OWLOntology in = loadOntologyFromString(TestFiles.slashOntologyIRI, new TurtleDocumentFormat());
    ...
    public void presentDeclaration() {
        // when
        OWLOntology o = loadOntologyFromString(TestFiles.presentDeclaration, new TurtleDocumentFormat());
        // then
    ...
    public void missingDeclaration() {
        // when
        OWLOntology o = loadOntologyFromString(TestFiles.missingDeclaration, new TurtleDocumentFormat());
        // then
    ...
    public void shouldReloadSamePrefixAbbreviations() throws OWLOntologyStorageException {
        OWLOntology o = loadOntologyFromString(TestFiles.prefixAbbreviations, new RioTurtleDocumentFormat());
    ...
    public void shouldFindExpectedAxiomsForBlankNodes() {
        OWLOntology o = loadOntologyFromString(TestFiles.axiomsForBlankNodes, new TurtleDocumentFormat());
        o.axioms(AxiomType.CLASS_ASSERTION).forEach(ax -> {
            OWLAxiom expected = df.getOWLObjectPropertyAssertionAxiom(anonR, ax.getIndividual(), ax.getIndividual());
    ...
    public void shouldSaveWithCorrectPrefixes() throws OWLOntologyStorageException {
        OWLOntology ont = loadOntologyFromString(TestFiles.correctPrefix, new TurtleDocumentFormat());
    ...
    public void shouldUseRightPrefixesWithPercentURLs()
        ...
        PrefixManager basePrefix = new PrefixManagerImpl().withDefaultPrefix("http://www.example.com#");
        ...
        assertTrue(string, string.contains("<http://www.example.com#has%20space> rdf:type owl:ObjectProperty"));
    }
    ...
    public void sameFileShouldParseToSameOntology() throws OWLOntologyCreationException {
        ...
        OWLOntology o1 = m1.loadOntologyFromOntologyDocument(new FileDocumentSource(file, new TurtleDocumentFormat()));
        OWLOntology o2 = m1
            .loadOntologyFromOntologyDocument(new FileDocumentSource(file, new RioTurtleDocumentFormat()));
        equal(o1, o2);
    }

    @Test
    public void shouldParseEscapedCharacters() throws OWLOntologyCreationException, OWLOntologyStorageException {
        OWLOntology ont = m1.loadOntologyFromOntologyDocument(
            new FileDocumentSource(new File(RESOURCES, "noBaseEscapedSlashes.ttl"), new TurtleDocumentFormat()));
        OWLOntology o1 = roundTrip(ont, new TurtleDocumentFormat());
        equal(ont, o1);
    }

    @Test
    public void shouldParseWithBase() throws OWLOntologyCreationException, OWLOntologyStorageException {
        OWLOntology ont = m1.loadOntologyFromOntologyDocument(
            new FileDocumentSource(new File(RESOURCES, "noBaseEscapedSlashes.ttl"), new RioTurtleDocumentFormat()));
