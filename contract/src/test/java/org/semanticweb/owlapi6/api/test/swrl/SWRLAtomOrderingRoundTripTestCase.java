package org.semanticweb.owlapi6.api.test.swrl;
...
public class SWRLAtomOrderingRoundTripTestCase extends TestBase {
    ...
    public void individualsShouldNotGetSWRLVariableTypes() throws OWLOntologyStorageException {
        OWLOntology o = loadOntologyFromString(TestFiles.individualSWRLTest, df.getIRI("urn:test#", "test"),
    ...
    @Test
    public void shouldPreserveOrderingInManchesterSyntaxRoundTrip() throws OWLOntologyStorageException {
