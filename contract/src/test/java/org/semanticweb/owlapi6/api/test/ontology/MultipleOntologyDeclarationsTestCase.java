...
public class MultipleOntologyDeclarationsTestCase extends TestBase {
    ...
    public void shouldLoadFirstOfMultipleOntologyDeclarationsRdfXml() throws Exception {
        OWLOntology o = m.loadOntologyFromOntologyDocument(
            new StringDocumentSource(TestFiles.doubleOntology, "urn:test:t1", new TurtleDocumentFormat(), null));
        assertEquals(o.getOntologyID(),
            df.getOWLOntologyID(df.getIRI("urn:test:Ontology1"), df.getIRI("urn:test:Ontology1Version1")));
    }
    ...
    public void shouldNotLoadMultipleOntologyDeclarationsRioRdfXml() throws Exception {
        m.loadOntologyFromOntologyDocument(
            new StringDocumentSource(TestFiles.doubleOntology, "urn:test:t1", new RioTurtleDocumentFormat(), null),
