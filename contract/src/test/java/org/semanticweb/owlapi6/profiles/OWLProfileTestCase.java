...
import static org.semanticweb.owlapi6.apibinding.OWLFunctionalSyntaxFactory.DataAllValuesFrom;
import static org.semanticweb.owlapi6.apibinding.OWLFunctionalSyntaxFactory.DataComplementOf;
import static org.semanticweb.owlapi6.apibinding.OWLFunctionalSyntaxFactory.DataExactCardinality;
...
import static org.semanticweb.owlapi6.apibinding.OWLFunctionalSyntaxFactory.DataMinCardinality;
import static org.semanticweb.owlapi6.apibinding.OWLFunctionalSyntaxFactory.DataOneOf;
...
import static org.semanticweb.owlapi6.apibinding.OWLFunctionalSyntaxFactory.DatatypeRestriction;
import static org.semanticweb.owlapi6.apibinding.OWLFunctionalSyntaxFactory.Declaration;
import static org.semanticweb.owlapi6.apibinding.OWLFunctionalSyntaxFactory.DifferentIndividuals;
...
import static org.semanticweb.owlapi6.apibinding.OWLFunctionalSyntaxFactory.Double;
...
import static org.semanticweb.owlapi6.apibinding.OWLFunctionalSyntaxFactory.FacetRestriction;
...
import static org.semanticweb.owlapi6.apibinding.OWLFunctionalSyntaxFactory.HasKey;
import static org.semanticweb.owlapi6.apibinding.OWLFunctionalSyntaxFactory.IRI;
import static org.semanticweb.owlapi6.apibinding.OWLFunctionalSyntaxFactory.Integer;
import static org.semanticweb.owlapi6.apibinding.OWLFunctionalSyntaxFactory.InverseFunctionalObjectProperty;
import static org.semanticweb.owlapi6.apibinding.OWLFunctionalSyntaxFactory.InverseObjectProperties;
...
import static org.semanticweb.owlapi6.apibinding.OWLFunctionalSyntaxFactory.OWLNothing;
import static org.semanticweb.owlapi6.apibinding.OWLFunctionalSyntaxFactory.OWLThing;
import static org.semanticweb.owlapi6.apibinding.OWLFunctionalSyntaxFactory.ObjectAllValuesFrom;
import static org.semanticweb.owlapi6.apibinding.OWLFunctionalSyntaxFactory.ObjectComplementOf;
import static org.semanticweb.owlapi6.apibinding.OWLFunctionalSyntaxFactory.ObjectExactCardinality;
import static org.semanticweb.owlapi6.apibinding.OWLFunctionalSyntaxFactory.ObjectHasSelf;
import static org.semanticweb.owlapi6.apibinding.OWLFunctionalSyntaxFactory.ObjectIntersectionOf;
import static org.semanticweb.owlapi6.apibinding.OWLFunctionalSyntaxFactory.ObjectInverseOf;
import static org.semanticweb.owlapi6.apibinding.OWLFunctionalSyntaxFactory.ObjectMaxCardinality;
import static org.semanticweb.owlapi6.apibinding.OWLFunctionalSyntaxFactory.ObjectMinCardinality;
import static org.semanticweb.owlapi6.apibinding.OWLFunctionalSyntaxFactory.ObjectOneOf;
...
import static org.semanticweb.owlapi6.apibinding.OWLFunctionalSyntaxFactory.SameIndividual;
import static org.semanticweb.owlapi6.apibinding.OWLFunctionalSyntaxFactory.SubAnnotationPropertyOf;
...
public class OWLProfileTestCase extends TestBase {
    ...
    private static final OWLDisjointClassesAxiom DISJOINT_TOP = DisjointClasses(ObjectComplementOf(OWLThing()),
        OWLThing());
    private static final OWLDataFactory DF = OWLManager.getOWLDataFactory();
    private static final OWLClassAssertionAxiom ANON_INDIVIDUAL = ClassAssertion(OWLThing(),
        DF.getOWLAnonymousIndividual());
    private static final OWLLiteral LW2 = Literal("wrong", DF.getOWLDatatype("urn:test:defineddatatype"));
    private static final OWLLiteral LW1 = Literal("wrong", OWL2Datatype.XSD_INTEGER);
    private static final SWRLRule SWRL_RULE = DF.getSWRLRule(Collections.emptyList(), Collections.emptyList());
    ...
    private static final OWLDatatypeDefinitionAxiom DT_BOOL_DEF = DatatypeDefinition(FAKEDT, Boolean());
    ...
    private static final OWLDataPropertyRangeAxiom ILLEGAL_DATAP_RANGE_2 = DataPropertyRange(DATAP,
        DataComplementOf(Integer()));
    private static final OWLDataPropertyRangeAxiom ONEOF_DATAP_RANGE = DataPropertyRange(DATAP, DATA_ONE_OF);
    ...
    private static final OWLFunctionalDataPropertyAxiom DATAP_FUNCTIONAL = FunctionalDataProperty(DATAP);
    ...
    private static void checkInCollection(List<OWLProfileViolation> violations, List<Class<?>> inputList) {
        inputList.sort(comp);
        assertEquals(inputList, asList(violations.stream().map(Object::getClass).sorted(comp)));
    }

    public void runAssert(OWLOntology ontology, OWLProfile profile, List<Class<?>> expectedViolations) {
    ...
    public OWLProfileTestCase(Supplier<OWLOntology> os, String name, List<OWLEntity> entities, List<OWLAxiom> axioms,
    ...
    static OWLOntology os2() {
        try {
            return OWLManager.createOWLOntologyManager()
                .createOntology(DF.getOWLOntologyID(Optional.of(RELATIVE_TEST), Optional.of(IRI("test1", ""))));
        } catch (OWLOntologyCreationException e) {
            throw new OWLRuntimeException(e);
        }
    }
    ...
    static Object[] arg(Supplier<OWLOntology> supplier, String name, List<OWLEntity> e, List<OWLAxiom> a, Profiles p,
        List<Class<?>> exceptions) {
