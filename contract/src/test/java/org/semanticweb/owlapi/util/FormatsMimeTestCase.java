...
public class FormatsMimeTestCase {
    ...
    public static List<Object[]> params() {
        ...
        //@formatter:off
            ...
            new Object[] { new org.semanticweb.owlapi.rio.RioRDFXMLParserFactory(),                                       "RDF/XML",                "application/rdf+xml",      Arrays.asList("application/rdf+xml",    "application/xml")},
            new Object[] { new org.semanticweb.owlapi.rio.RioNQuadsParserFactory(),                                       "N-Quads",                "text/x-nquads",            Arrays.asList("text/x-nquads")},
            ...
            new Object[] { new org.semanticweb.owlapi.rio.RioNTriplesParserFactory(),                                     "N-Triples",              "text/plain",               Arrays.asList("text/plain")},
            new Object[] { new org.semanticweb.owlapi.rio.RioTrigParserFactory(),                                         "TriG",                   "application/x-trig",       Arrays.asList("application/x-trig")},
