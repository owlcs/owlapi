...
import org.coode.owlapi.turtle.TurtleOntologyStorerFactory;
...
public class OWLOntologyStorerFactoryRegistryTest
{
    ...
    public void testAdd()
    {
        final List<OWLOntologyStorerFactory> initialStorerFactories = testRegistry.getStorerFactories();
        
        assertEquals(0, initialStorerFactories.size());
        
        testRegistry.add(new TurtleOntologyStorerFactory());
        
        final List<OWLOntologyStorerFactory> afterStorerFactories = testRegistry.getStorerFactories();
    ...
    public void testClearStorerFactories()
    {
        ...
        testRegistry.registerStorerFactory(new TurtleOntologyStorerFactory());
        ...
        final List<OWLOntologyStorerFactory> clearedStorerFactories = testRegistry.getStorerFactories();
    ...
    public void testGet()
    {
        ...
        final OWLOntologyStorerFactory formatStorer = testRegistry.getStorerFactory(new TurtleOntologyFormatFactory());
    ...
    public void testGetAll()
    {
        ...
        final Collection<OWLOntologyStorerFactory> getAllStorers = testRegistry.getAll();
    ...
    {
        final Set<OWLOntologyFormatFactory> initialKeys = testRegistry.getKeys();
    ...
    {
        final Collection<OWLOntologyStorerFactory> initialStorerFactories = testRegistry.getAll();
        
        assertEquals(0, initialStorerFactories.size());
        
        testRegistry.add(new TurtleOntologyStorerFactory());
        
        final Collection<OWLOntologyStorerFactory> afterStorerFactories = testRegistry.getAll();
        
        assertEquals(1, afterStorerFactories.size());
        
        testRegistry.remove(afterStorerFactories.iterator().next());
        
        final Collection<OWLOntologyStorerFactory> emptyStorerFactories = testRegistry.getAll();
    ...
    public void testUnregisterStorerFactory()
    {
        ...
        final List<OWLOntologyStorerFactory> emptyStorerFactories = testRegistry.getStorerFactories();
