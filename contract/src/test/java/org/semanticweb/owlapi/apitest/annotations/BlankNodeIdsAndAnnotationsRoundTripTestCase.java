...
class BlankNodeIdsAndAnnotationsRoundTripTestCase extends TestBase {
    ...
    static final OWLClassExpression ce1 = ObjectAllValuesFrom(OBJPROPS.op1, CLASSES.C4);
    static final OWLClassExpression ce2 = ObjectSomeValuesFrom(OBJPROPS.op1, OWLThing());
    static final OWLClassExpression ce3 = ObjectExactCardinality(1, OBJPROPS.op1, OWLThing());
    static final OWLClassExpression ce4 =
        ObjectIntersectionOf(ObjectExactCardinality(2, OBJPROPS.op1, OWLThing()),
            DataExactCardinality(3, DATAPROPS.DP), ObjectComplementOf(ce3), ce3);
    ...
    protected OWLOntology blankNodeIdsAndAnnotationsRoundTripTestCase(OWLOntology ont1) {
        ont1.add(ClassAssertion(ann1, ObjectComplementOf(CLASSES.C4), a),
            ClassAssertion(ann5, ObjectComplementOf(CLASSES.C5), a), ClassAssertion(ce1, a),
            ClassAssertion(ce2, a), ClassAssertion(ce3, a), ClassAssertion(ann6, ce3, a),
            ClassAssertion(ce4, a), ClassAssertion(ann4, ce4, a),
            ObjectPropertyAssertion(ann3, OBJPROPS.op1, a1, a2), ClassAssertion(ce1, b),
            ClassAssertion(ce2, b), ClassAssertion(CLASSES.C4, a),
            ClassAssertion(ann2, CLASSES.C4, a));
        return ont1;
    }
    ...
    public boolean equal(OWLOntology ont1, OWLOntology ont2) {
        ...
        if (singleAxiomsLost.contains(ont2.getFormat())) {
            ...
            if (annotated != null) {
                ont2.add(ClassAssertion(ce3, annotated), ClassAssertion(CLASSES.C4, annotated),
