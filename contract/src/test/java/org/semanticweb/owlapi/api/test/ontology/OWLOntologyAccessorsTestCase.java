...
public class OWLOntologyAccessorsTestCase extends AbstractOWLAPITestCase {
    ...
    public void testEquivalentObjectPropertiesAxiomAccessors() {
        ...
        OWLOntologyManager man = ont.getOWLOntologyManager();
        OWLEquivalentObjectPropertiesAxiom ax = EquivalentObjectProperties(propP, propQ,
                propR);
        man.addAxiom(ont, ax);
        performAxiomTests(ont, ax);
    ...
    public void testDisjointObjectPropertiesAxiomAccessors() {
        ...
        OWLObjectProperty propR = ObjectProperty(getIRI("r"));
        OWLOntologyManager man = ont.getOWLOntologyManager();
        OWLDisjointObjectPropertiesAxiom ax = DisjointObjectProperties(propP, propQ,
                propR);
        man.addAxiom(ont, ax);
        performAxiomTests(ont, ax);
    ...
    public void testEquivalentDataPropertiesAxiomAccessors() {
        ...
        OWLOntologyManager man = ont.getOWLOntologyManager();
        OWLEquivalentDataPropertiesAxiom ax = EquivalentDataProperties(propP, propQ,
                propR);
        man.addAxiom(ont, ax);
        performAxiomTests(ont, ax);
    ...
    public void testNegativeDataPropertyAxiomAccessors() {
        ...
        OWLLiteral lit = Literal(3);
        OWLOntologyManager man = ont.getOWLOntologyManager();
        OWLNegativeDataPropertyAssertionAxiom ax = NegativeDataPropertyAssertion(prop,
                indA, lit);
        man.addAxiom(ont, ax);
        performAxiomTests(ont, ax);
