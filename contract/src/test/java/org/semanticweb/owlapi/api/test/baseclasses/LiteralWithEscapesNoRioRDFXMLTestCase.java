...
public class LiteralWithEscapesNoRioRDFXMLTestCase extends AbstractRoundTrippingTestCase {
    ...
    protected OWLOntology createOntology() {
        ...
        OWLOntology o = getOWLOntology("http://owlapi.sourceforge.net/ontology#");
        o.getOWLOntologyManager().addAxioms(o,
            new HashSet<>(Arrays.asList(ax1, ax2, ax3, ax4, Declaration(cls))));
        return o;
    }
}
