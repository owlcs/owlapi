...
public class AxiomsRoundTrippingTestCase extends AxiomsRoundTrippingBase {
  ...
  private static final OWLAnnotation annoOuter = Annotation(AnnotationProperty(iri("myOuterLabel")),
      Literal(
  ...
  public static List<AxiomBuilder> getData() {
    return Arrays.asList(
        ...
        //
        () -> Sets
            .newHashSet(DisjointDataProperties(dpA, dpB, dpC), Declaration(dpA), Declaration(dpB),
                Declaration(dpC)),
        //
        ...
        //
        () -> Sets.newHashSet(Declaration(Class(IRI("http://www.test.com/ontology#", "Class%37A"))),
            Declaration(
