...
public class AnonymousFunctionalRoundtripTestCase extends AbstractOWLAPITestCase {
    ...
    OWLOntology loadOntologyFromString(String input) throws OWLOntologyCreationException {
        OWLOntologyManager manager = Factory.getManager();
