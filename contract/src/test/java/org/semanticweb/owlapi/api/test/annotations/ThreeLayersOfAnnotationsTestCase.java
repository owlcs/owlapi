...
public class ThreeLayersOfAnnotationsTestCase extends AbstractRoundTrippingTestCase {
    ...
    protected OWLOntology createOntology() {
        ...
        OWLObjectProperty adjacent_to = df
            .getOWLObjectProperty(IRI.create(oboInOwl, "adjacent_to"));
        OWLAnnotationProperty hasDefinition = df
            .getOWLAnnotationProperty(IRI.create(oboInOwl, "hasDefinition"));
        OWLAnnotationProperty hasdbxref = df
            .getOWLAnnotationProperty(IRI.create(oboInOwl, "hasDbXref"));
        ...
        m.addAxiom(o,
            df.getOWLDataPropertyAssertionAxiom(hasuri, ind1, df.getOWLLiteral("urn:SO:SO_ke",
