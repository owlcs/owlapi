...
public class AnonymousIndividualsNormaliser implements OWLObjectVisitorEx<OWLObject> {
     ...
     */
    public AnonymousIndividualsNormaliser(Map<OWLEntity, IRI> entityIRIReplacementMap, OWLOntologyManager m) {
     ...
     */
    public AnonymousIndividualsNormaliser(Map<OWLEntity, IRI> entityIRIReplacementMap,
     ...
     *        used to "rename" entities.
     */
    public AnonymousIndividualsNormaliser(OWLOntologyManager m, Map<IRI, IRI> iriReplacementMap) {
