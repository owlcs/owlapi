...
public class AllDifferentTestCase extends TestBase {
    ...
    public void testDistinctMembers() {
        String onto1 = "<?xml version=\"1.0\"?>\n" + "<rdf:RDF xml:base = \"http://example.org/\" "
            ...
            + "xmlns:rdf = \"http://www.w3.org/1999/02/22-rdf-syntax-ns#\"> <owl:Ontology/>" + "<owl:AllDifferent> "
            + "<owl:distinctMembers rdf:parseType=\"Collection\"> " + "<rdf:Description rdf:about=\"Peter\" /> "
            + "<rdf:Description rdf:about=\"Peter_Griffin\" /> " + "<rdf:Description rdf:about=\"Petre\" /> "
        ...
        String onto2 = "<?xml version=\"1.0\"?>\n"
            ...
            + "<owl:AllDifferent><owl:members rdf:parseType=\"Collection\">" + "<rdf:Description rdf:about=\"Peter\" />"
            + "<rdf:Description rdf:about=\"Peter_Griffin\" />" + "<rdf:Description rdf:about=\"Petre\" />"
