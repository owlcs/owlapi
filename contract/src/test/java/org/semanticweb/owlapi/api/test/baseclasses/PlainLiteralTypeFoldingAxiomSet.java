...
public class PlainLiteralTypeFoldingAxiomSet implements Set<OWLAxiom> {
    ...
    private static class OWLAxiomHashingStrategy implements HashingStrategy<OWLAxiom> {
         ...
         * <tt>hashCode</tt> method, the Java runtime's <tt>identityHashCode</tt>, or a custom
         * scheme.
         *
        ...
        /**
         * Compares o1 and o2 for equality. Strategy implementers may use the objects' own equals()
