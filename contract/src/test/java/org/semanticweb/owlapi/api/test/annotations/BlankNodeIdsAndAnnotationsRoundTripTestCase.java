...
public class BlankNodeIdsAndAnnotationsRoundTripTestCase extends AbstractRoundTrippingTestCase {
    ...
    private OWLAnnotation ann1 = comment("test for anon class in object position");
    private OWLAnnotation ann2 = comment("test for named class in object position");
    private OWLAnnotation ann3 = comment("test for anon individual in object position");
    ...
    private OWLAnnotation ann5 = comment("test for second named class in object position");
    private OWLAnnotation ann6 = comment("test for third anon class in object position");
    private OWLClass c4 = df.getOWLClass(IRI.create("urn:test:c4"));
    private OWLClass c5 = df.getOWLClass(IRI.create("urn:test:c5"));
