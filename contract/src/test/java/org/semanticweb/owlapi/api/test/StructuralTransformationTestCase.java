...
public class StructuralTransformationTestCase extends TestBase {
    ...
    public static Collection<Object[]> getData() {
        ...
        map.put(b.dDp(),
                "[DisjointDataProperties(<urn:test#dp> <urn:test#iri> )]");
        map.put(b.dOp(),
                "[DisjointObjectProperties(<urn:test#iri> <urn:test#op> )]");
        map.put(b.eDp(),
                "[DisjointDataProperties(<urn:test#dp> <urn:test#iri> )]");
        map.put(b.eOp(),
                "[DisjointObjectProperties(<urn:test#iri> <urn:test#op> )]");
        ...
        map.put(b.fop(),
                "[SubClassOf(owl:Thing ObjectMaxCardinality(1 <urn:test#op> owl:Thing))]");
        map.put(b.ifp(),
                "[SubClassOf(owl:Thing ObjectMaxCardinality(1 InverseOf(<urn:test#op>) owl:Thing))]");
        map.put(b.iop(),
                "[SubObjectPropertyOf(<urn:test#op> InverseOf(<urn:test#op>))]");
        map.put(b.irr(),
