...
public class AnnotationStreamTestCase extends TestBase{
    @Test
    public void shouldFindniqueProperties() throws OWLOntologyCreationException {
        ...
        OWLOntology ontology = loadOntologyFromString(ttl);
        assertEquals(
                ontology.annotationPropertiesInSignature().distinct().count(),
