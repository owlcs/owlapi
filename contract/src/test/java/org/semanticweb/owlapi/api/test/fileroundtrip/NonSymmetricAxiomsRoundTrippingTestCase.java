...
public class NonSymmetricAxiomsRoundTrippingTestCase extends AbstractOWLAPITestCase {
    ...
    public void shouldRoundTripAReadableVersion() throws OWLOntologyCreationException, OWLOntologyStorageException {
        ...
        m.saveOntology(output, new OWLFunctionalSyntaxOntologyFormat(), target);
        m.removeOntology(output);
        OWLOntology o = m.loadOntologyFromOntologyDocument(new StringDocumentSource(target));
