...
public class GuessRDFSPropertyTypeTestCase extends TestBase {
    ...
    private void testProperty(@Nonnull OWLObjectProperty p11property,
        ...
        assertEquals("domain should be E5_Event", prefixOWLOntologyFormat.getIRI(expectedDomain),
            domainIRI);
        ...
        assertEquals("super property ", prefixOWLOntologyFormat.getIRI(expectedSuperProperty),
            superPropertyIRI);
    }
