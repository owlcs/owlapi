...
import static org.semanticweb.owlapi.model.OWLOntologyLoaderConfiguration.MissingOntologyHeaderStrategy.*;
...
class ConfigurationOptionsTestCase {
    ...
    static Stream<Arguments> values() {
        return Stream.of(Arguments.of(ACCEPT_HTTP_COMPRESSION, Boolean.TRUE),
            ...
            Arguments.of(INDENT_SIZE, Integer.valueOf(4)),
            Arguments.of(INDENTING, Boolean.TRUE),
            ...
            Arguments.of(REMAP_IDS, Boolean.TRUE),
            Arguments.of(REPORT_STACK_TRACES, Boolean.TRUE),
