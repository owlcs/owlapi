...
class LiteralFoldingEqualityTester {
  ...
  public static boolean equals(@Nullable OWLLiteral a, @Nullable OWLLiteral b) {
    ...
    if (a.getDatatype().isRDFPlainLiteral()) {
      ...
      if (b.getDatatype().getIRI().equals(OWLRDFVocabulary.RDF_LANG_STRING.getIRI()) && !a.getLang()
          .equals("")) {
        return true;
      }
    }
    if (b.getDatatype().isRDFPlainLiteral()) {
      ...
      if (a.getDatatype().getIRI().equals(OWLRDFVocabulary.RDF_LANG_STRING.getIRI()) && !b.getLang()
          .equals("")) {
        return true;
      }
    }
