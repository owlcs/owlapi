...
class LiteralFoldingEqualityTester {
    ...
    private static boolean equalObjectPropertyExpressions(Collection<OWLObjectPropertyExpression> a,
    ...
    private static boolean equalDataPropertyExpressions(Set<OWLDataPropertyExpression> a,
        Set<OWLDataPropertyExpression> b) {
        if (a.size() != b.size()) {
            return false;
        }
    ...
    public static boolean equalAnnotations(Set<OWLAnnotation> a, Set<OWLAnnotation> b) {
        ...
        Iterator<OWLAnnotation> ai = a.iterator();
        Iterator<OWLAnnotation> bi = b.iterator();
        while (ai.hasNext()) {
            if (!equals(ai.next(), bi.next())) {
                return false;
            }
