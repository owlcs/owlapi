...
public class RelativeIRIsRoundTripTestCase extends AbstractRoundTrippingTestCase {
    private String ns = "";
    // "urn:test:ns#";
    private OWLDataProperty d = df.getOWLDataProperty(IRI.create(ns + "d"));
    private OWLObjectProperty o = df.getOWLObjectProperty(IRI.create(ns + "o"));
    private OWLAnnotationProperty x = df.getOWLAnnotationProperty(IRI.create(ns + "X"));
    private OWLAnnotationProperty y = df.getOWLAnnotationProperty(IRI.create(ns + "Y"));
