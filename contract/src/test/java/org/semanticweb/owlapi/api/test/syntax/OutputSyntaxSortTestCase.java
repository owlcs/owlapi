...
public class OutputSyntaxSortTestCase extends AbstractOWLAPITestCase {
    ...
    public OutputSyntaxSortTestCase(OWLOntologyFormat format) {
        this.format = format;
    }

    @Parameterized.Parameters(name = "{0}")
    public static Collection<Object[]> getData() {
        return Arrays.<Object[]> asList(new Object[] { new ManchesterOWLSyntaxOntologyFormat() },
            new Object[] { new OWLFunctionalSyntaxOntologyFormat() },
            new Object[] { new TurtleOntologyFormat() },
            new Object[] { new RDFXMLOntologyFormat() },
            new Object[] { new OWLXMLOntologyFormat() });
    }
    ...
    public static OWLOntology loadOntologyFromString(String ontology)
