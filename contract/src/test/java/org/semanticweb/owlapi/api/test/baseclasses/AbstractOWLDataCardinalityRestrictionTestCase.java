...
public abstract class AbstractOWLDataCardinalityRestrictionTestCase extends
    ...
    public void testCreation() throws Exception {
        ...
        OWLDataCardinalityRestriction restB = createDataRestriction(prop, cardinality,
                dataRange);
    ...
    public void testEqualsPositive() throws Exception {
        ...
        OWLDataRange dataRange = Datatype(createIRI());
        OWLDataCardinalityRestriction restC = createDataRestriction(prop, cardinality,
                dataRange);
        OWLDataCardinalityRestriction restD = createDataRestriction(prop, cardinality,
                dataRange);
    ...
    public void testEqualsNegative() throws Exception {
        ...
        OWLDataCardinalityRestriction restB = createDataRestriction(prop, 4);
        assertFalse(restA.equals(restB));
        // Different property
        OWLDataCardinalityRestriction restC = createDataRestriction(
                DataProperty(createIRI()), 3);
        OWLDataCardinalityRestriction restD = createDataRestriction(
                DataProperty(createIRI()), 3);
        assertFalse(restC.equals(restD));
        // Different filler
        OWLDataCardinalityRestriction restE = createDataRestriction(prop, 3,
                Datatype(createIRI()));
        OWLDataCardinalityRestriction restF = createDataRestriction(prop, 3,
                Datatype(createIRI()));
