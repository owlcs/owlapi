  ...
  public static List<AxiomBuilder> getData() {
    return Arrays.asList(
        ...
        () -> {
          ...
          OWLAnonymousIndividual ind = AnonymousIndividual();
          axioms.add(
              ObjectPropertyAssertion(ObjectProperty(iri("p")), NamedIndividual(iri("i1")), ind));
          axioms.add(
              ObjectPropertyAssertion(ObjectProperty(iri("p")), ind, NamedIndividual(iri("i2"))));
          return axioms;
        },
        ...
        () -> {
          ...
          OWLAnnotationAssertionAxiom annoAssertion1 = AnnotationAssertion(property, subject,
              individual1);
