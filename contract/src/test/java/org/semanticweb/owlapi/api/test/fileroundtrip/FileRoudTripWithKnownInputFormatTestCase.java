...
public class FileRoudTripWithKnownInputFormatTestCase extends AbstractFileRoundTrippingTestCase {
    private OWLDocumentFormat format = new TurtleDocumentFormat();

    @Override
    protected String getFileName() {
        return "testBlankNodesDomain.ttl";
    }
    ...
    protected OWLOntology createOntology() {
        try {
            ...
            return m.loadOntologyFromOntologyDocument(new IRIDocumentSource(iri, format, null));
