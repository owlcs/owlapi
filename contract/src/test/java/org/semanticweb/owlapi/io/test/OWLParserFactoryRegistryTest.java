...
public class OWLParserFactoryRegistryTest
{
    ...
    public void testAdd()
    {
        final List<OWLParserFactory> initialParserFactories = testRegistry.getParserFactories();
        
        assertEquals(0, initialParserFactories.size());
        
        testRegistry.add(new TurtleOntologyParserFactory());
        
        final List<OWLParserFactory> afterParserFactories = testRegistry.getParserFactories();
    ...
    public void testClearParserFactories()
    {
        ...
        testRegistry.registerParserFactory(new TurtleOntologyParserFactory());
        ...
        final List<OWLParserFactory> clearedParserFactories = testRegistry.getParserFactories();
    ...
    public void testGet()
    {
        ...
        final OWLParserFactory formatStorer = testRegistry.getParserFactory(new TurtleOntologyFormatFactory());
    ...
    /**
     * Test method for {@link org.semanticweb.owlapi.util.AbstractServiceLoader#getAll()}.
     */
    @Test
    public void testGetAll()
    {
        ...
        final Collection<OWLParserFactory> getAllStorers = testRegistry.getAll();
        
        assertEquals(1, getAllStorers.size());
    }
    
    /**
     * Test method for {@link org.semanticweb.owlapi.util.AbstractServiceLoader#getKeys()}.
     */
    @Test
    public void testGetKeys()
    {
        final Set<Set<OWLOntologyFormatFactory>> initialKeys = testRegistry.getKeys();
        
        assertEquals(0, initialKeys.size());
        
        testRegistry.add(new TurtleOntologyParserFactory());
        
        final Set<Set<OWLOntologyFormatFactory>> afterKeys = testRegistry.getKeys();
    ...
    public void testHas()
    {
        ...
        assertTrue(testRegistry.has(Collections.<OWLOntologyFormatFactory>singleton(new TurtleOntologyFormatFactory())));
    }
    ...
    {
        final Collection<OWLParserFactory> initialParserFactories = testRegistry.getAll();
        
        assertEquals(0, initialParserFactories.size());
        
        testRegistry.add(new TurtleOntologyParserFactory());
        
        final Collection<OWLParserFactory> afterParserFactories = testRegistry.getAll();
        
        assertEquals(1, afterParserFactories.size());
        
        testRegistry.remove(afterParserFactories.iterator().next());
        
        final Collection<OWLParserFactory> emptyParserFactories = testRegistry.getAll();
    ...
    public void testUnregisterParserFactory()
    {
        ...
        final List<OWLParserFactory> emptyParserFactories = testRegistry.getParserFactories();
