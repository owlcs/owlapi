...
public class ContractOwlapiIoTest {
    ...
    public void shouldTestAbstractOWLParser() throws Exception {
        ...
        OWLOntologyFormat result0 = testSubject0.parse(IRI("urn:aFake"), Utils.getMockOntology());
        String result2 = testSubject0.toString();
        OWLOntologyFormat result3 =
            testSubject0.parse(mock(OWLOntologyDocumentSource.class), Utils.getMockOntology());
        OWLOntologyFormat result4 = testSubject0.parse(mock(OWLOntologyDocumentSource.class),
    ...
    public void shouldTestDefaultOntologyFormat() throws Exception {
        ...
        boolean result4 =
            RDFOntologyFormat.isMissingType(Utils.mockOWLEntity(), Utils.getMockOntology());
        ...
        Object result12 = testSubject0.getParameter(mock(Object.class), mock(Object.class));
    ...
    public void shouldTestOntologyIRIMappingNotFoundException() throws Exception {
        OntologyIRIMappingNotFoundException testSubject0 =
            new OntologyIRIMappingNotFoundException(IRI("urn:aFake"));
    ...
    public void shouldTestOWLFunctionalSyntaxOntologyFormat() throws Exception {
        ...
        testSubject0.setParameter(mock(Object.class), mock(Object.class));
        Object result8 = testSubject0.getParameter(mock(Object.class), mock(Object.class));
    ...
    public void shouldTestOWLOntologyCreationIOException() throws Exception {
        OWLOntologyCreationIOException testSubject0 =
            new OWLOntologyCreationIOException(mock(IOException.class));
    ...
    public void shouldTestOWLOntologyInputSourceException() throws Exception {
        ...
        OWLOntologyInputSourceException testSubject1 =
            new OWLOntologyInputSourceException(new RuntimeException());
        OWLOntologyInputSourceException testSubject2 = new OWLOntologyInputSourceException("");
        OWLOntologyInputSourceException testSubject3 =
            new OWLOntologyInputSourceException("", new RuntimeException());
        Throwable result1 = testSubject0.getCause();
        String result3 = testSubject0.toString();
    ...
    public void shouldTestOWLOntologyStorageIOException() throws Exception {
        OWLOntologyStorageIOException testSubject0 =
            new OWLOntologyStorageIOException(mock(IOException.class));
    ...
    public void shouldTestInterfaceOWLParser() throws Exception {
        ...
        OWLOntologyFormat result0 = testSubject0.parse(IRI("urn:aFake"), Utils.getMockOntology());
        OWLOntologyFormat result1 =
            testSubject0.parse(mock(OWLOntologyDocumentSource.class), Utils.getMockOntology());
        OWLOntologyFormat result2 = testSubject0.parse(mock(OWLOntologyDocumentSource.class),
            Utils.getMockOntology(), new OWLOntologyLoaderConfiguration());
    }
    ...
    public void shouldTestOWLParserException() throws Exception {
        ...
        OWLParserException testSubject2 = new OWLParserException("", new RuntimeException());
        ...
        OWLParserException testSubject5 = new OWLParserException(new RuntimeException(), 0, 0);
        OWLParserException testSubject6 = new OWLParserException("", new RuntimeException(), 0, 0);
    ...
    public void shouldTestOWLParserIOException() throws Exception {
        OWLParserIOException testSubject0 = new OWLParserIOException(mock(IOException.class));
        IOException result0 = testSubject0.getCause();
        Throwable result1 = testSubject0.getCause();
        String result2 = testSubject0.getMessage();
    ...
    public void shouldTestOWLParserSAXException() throws Exception {
        OWLParserSAXException testSubject0 = new OWLParserSAXException(mock(SAXException.class));
    ...
    public void shouldTestOWLParserURISyntaxException() throws Exception {
        OWLParserURISyntaxException testSubject0 =
            new OWLParserURISyntaxException(mock(URISyntaxException.class), 0, 0);
    ...
    public void shouldTestOWLRendererException() throws Exception {
        ...
        OWLRendererException testSubject1 = new OWLRendererException("", new RuntimeException());
        OWLRendererException testSubject2 = new OWLRendererException(new RuntimeException());
        Throwable result1 = testSubject0.getCause();
        String result3 = testSubject0.toString();
        String result4 = testSubject0.getMessage();
        String result5 = testSubject0.getLocalizedMessage();
    ...
    public void shouldTestOWLRendererIOException() throws Exception {
        OWLRendererIOException testSubject0 = new OWLRendererIOException(mock(IOException.class));
        Throwable result1 = testSubject0.getCause();
        String result3 = testSubject0.toString();
        String result4 = testSubject0.getMessage();
        String result5 = testSubject0.getLocalizedMessage();
    ...
    public void shouldTestRDFOntologyFormat() throws Exception {
        ...
        testSubject0.setParameter(mock(Object.class), mock(Object.class));
        Object result11 = testSubject0.getParameter(mock(Object.class), mock(Object.class));
    ...
    public void shouldTestRDFParserMetaData() throws Exception {
        RDFParserMetaData testSubject0 = new RDFParserMetaData(mock(RDFOntologyHeaderStatus.class),
            0, Utils.mockSet(mock(RDFTriple.class)));
    ...
    public void shouldTestRDFResourceParseError() throws Exception {
        RDFResourceParseError testSubject0 = new RDFResourceParseError(Utils.mockOWLEntity(),
            mock(RDFNode.class), Utils.mockSet(mock(RDFTriple.class)));
    ...
    public void shouldTestRDFTriple() throws Exception {
        RDFTriple testSubject0 = new RDFTriple(IRI("urn:aFake"), false, IRI("urn:aFake"), false,
            IRI("urn:aFake"), false);
        RDFTriple testSubject1 =
            new RDFTriple(IRI("urn:aFake"), false, IRI("urn:aFake"), false, mock(OWLLiteral.class));
        RDFTriple testSubject2 =
            new RDFTriple(mock(RDFResource.class), mock(RDFResource.class), mock(RDFNode.class));
        String result0 = testSubject0.toString();
    ...
    public void shouldTestReaderDocumentSource() throws Exception {
        ReaderDocumentSource testSubject0 =
            new ReaderDocumentSource(mock(Reader.class), IRI("urn:aFake"));
    ...
    public void shouldTestStreamDocumentSource() throws Exception {
        StreamDocumentSource testSubject0 = new StreamDocumentSource(mock(InputStream.class));
        StreamDocumentSource testSubject1 =
    ...
    public void shouldTestStreamDocumentTarget() throws Exception {
        StreamDocumentTarget testSubject0 = new StreamDocumentTarget(mock(OutputStream.class));
        OutputStream result0 = testSubject0.getOutputStream();
        IRI result1 = testSubject0.getDocumentIRI();
        boolean result2 = testSubject0.isWriterAvailable();
        Writer result3 = testSubject0.getWriter();
