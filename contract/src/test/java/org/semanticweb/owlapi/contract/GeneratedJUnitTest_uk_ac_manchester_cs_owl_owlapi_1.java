...
public class GeneratedJUnitTest_uk_ac_manchester_cs_owl_owlapi_1 {
    @Test
    public void shouldTestAbstractInMemOWLOntologyFactory() throws Exception {
        ...
        boolean result2 = testSubject0.canCreateFromDocumentIRI(IRI.create("urn:aFake"));
    ...
    public void shouldTestEmptyInMemOWLOntologyFactory() throws Exception {
        ...
        boolean result5 = testSubject0.canCreateFromDocumentIRI(IRI.create("urn:aFake"));
    ...
    public void shouldTestImplUtils() throws Exception {
        ...
        Set<OWLAnnotation> result0 = ImplUtils.getAnnotations(Utils.mockOWLEntity(),
                Utils.mockSet(Utils.getMockOntology()));
        Set<OWLAnnotation> result1 = ImplUtils
                .getAnnotations(Utils.mockOWLEntity(), mock(OWLAnnotationProperty.class),
                        Utils.mockSet(Utils.getMockOntology()));
        Set<OWLAnnotationAssertionAxiom> result2 = ImplUtils.getAnnotationAxioms(
    ...
    public void shouldTestOWLAnnotationAssertionAxiomImpl() throws Exception {
        ...
        OWLAnnotationAssertionAxiom result8 = testSubject0.getAnnotatedAxiom(Utils
                .mockSet(mock(OWLAnnotation.class)));
        OWLAxiom result9 = testSubject0.getAnnotatedAxiom(Utils
                .mockSet(mock(OWLAnnotation.class)));
    ...
    public void shouldTestOWLAnnotationImpl() throws Exception {
        ...
        OWLAnnotation result6 = testSubject0.getAnnotatedAnnotation(Utils
                .mockSet(mock(OWLAnnotation.class)));
        boolean result7 = testSubject0.isComment();
        boolean result8 = testSubject0.isLabel();
    ...
    public void shouldTestOWLAnnotationPropertyDomainAxiomImpl() throws Exception {
        OWLAnnotationPropertyDomainAxiomImpl testSubject0 = new OWLAnnotationPropertyDomainAxiomImpl(
                mock(OWLAnnotationProperty.class), IRI.create("urn:aFake"),
                Utils.mockCollection(mock(OWLAnnotation.class)));
        OWLAnnotationProperty result0 = testSubject0.getProperty();
        testSubject0.accept(mock(OWLAxiomVisitor.class));
        testSubject0.accept(mock(OWLObjectVisitor.class));
        ...
        OWLAxiom result6 = testSubject0.getAnnotatedAxiom(Utils
                .mockSet(mock(OWLAnnotation.class)));
        OWLAnnotationPropertyDomainAxiom result7 = testSubject0.getAnnotatedAxiom(Utils
                .mockSet(mock(OWLAnnotation.class)));
    ...
    public void shouldTestOWLAnnotationPropertyImpl() throws Exception {
        ...
        Set<OWLAxiom> result5 = testSubject0
        ...
        OWLEntity result11 = testSubject0.getOWLEntity(EntityType.CLASS);
    ...
    public void shouldTestOWLAnnotationPropertyRangeAxiomImpl() throws Exception {
        ...
        OWLAxiom result5 = testSubject0.getAnnotatedAxiom(Utils
                .mockSet(mock(OWLAnnotation.class)));
        OWLAnnotationPropertyRangeAxiom result6 = testSubject0.getAnnotatedAxiom(Utils
                .mockSet(mock(OWLAnnotation.class)));
    ...
    public void shouldTestOWLAnonymousIndividualImpl() throws Exception {
        ...
        boolean result13 = testSubject0.isOWLObjectProperty();
        if (testSubject0.isOWLObjectProperty()) {
            OWLObjectProperty result14 = testSubject0.asOWLObjectProperty();
        }
        boolean result15 = testSubject0.isOWLDataProperty();
        if (testSubject0.isOWLDataProperty()) {
            OWLDataProperty result16 = testSubject0.asOWLDataProperty();
        }
        boolean result17 = testSubject0.isOWLDatatype();
        if (testSubject0.isOWLDatatype()) {
            OWLDatatype result18 = testSubject0.asOWLDatatype();
        }
        Set<OWLClassExpression> result19 = testSubject0.getTypes(Utils.getMockOntology());
        Set<OWLClassExpression> result20 = testSubject0.getTypes(Utils.mockSet(Utils
                .getMockOntology()));
        ...
        Set<OWLIndividual> result30 = testSubject0.getSameIndividuals(Utils
                .getMockOntology());
        Set<OWLIndividual> result31 = testSubject0.getDifferentIndividuals(Utils
                .getMockOntology());
    ...
    public void shouldTestOWLAsymmetricObjectPropertyAxiomImpl() throws Exception {
        ...
        OWLAxiom result4 = testSubject0.getAnnotatedAxiom(Utils
                .mockSet(mock(OWLAnnotation.class)));
        OWLAsymmetricObjectPropertyAxiom result5 = testSubject0.getAnnotatedAxiom(Utils
                .mockSet(mock(OWLAnnotation.class)));
    ...
    public void shouldTestOWLAxiomImpl() throws Exception {
        ...
        OWLAxiom result24 = testSubject0.getAnnotatedAxiom(Utils
                .mockSet(mock(OWLAnnotation.class)));
    ...
    public void shouldTestOWLClassAssertionImpl() throws Exception {
        ...
        OWLClassAssertionAxiom result4 = testSubject0.getAnnotatedAxiom(Utils
                .mockSet(mock(OWLAnnotation.class)));
        OWLAxiom result5 = testSubject0.getAnnotatedAxiom(Utils
                .mockSet(mock(OWLAnnotation.class)));
        AxiomType<?> result6 = testSubject0.getAxiomType();
    ...
    public void shouldTestOWLClassImpl() throws Exception {
        OWLClassImpl testSubject0 = new OWLClassImpl(IRI.create("urn:aFake"));
        Set<OWLAnnotation> result0 = testSubject0.getAnnotations(Utils.getMockOntology());
        Set<OWLAnnotation> result1 = testSubject0.getAnnotations(Utils.getMockOntology(),
                mock(OWLAnnotationProperty.class));
        boolean result2 = testSubject0.isDefined(Utils.getMockOntology());
        boolean result3 = testSubject0.isDefined(Utils.mockSet(Utils.getMockOntology()));
        testSubject0.accept(mock(OWLNamedObjectVisitor.class));
        testSubject0.accept(mock(OWLObjectVisitor.class));
        testSubject0.accept(mock(OWLEntityVisitor.class));
        testSubject0.accept(mock(OWLClassExpressionVisitor.class));
        ...
        Set<OWLAnnotationAssertionAxiom> result13 = testSubject0
                .getAnnotationAssertionAxioms(Utils.getMockOntology());
        Set<OWLEquivalentClassesAxiom> result14 = testSubject0
                .getEquivalentClassesAxioms(Utils.getMockOntology());
        Set<OWLDisjointClassesAxiom> result15 = testSubject0
                .getDisjointClassesAxioms(Utils.getMockOntology());
        Set<OWLDisjointUnionAxiom> result16 = testSubject0.getDisjointUnionAxioms(Utils
                .getMockOntology());
        IRI result17 = testSubject0.getIRI();
        boolean result18 = testSubject0.isBuiltIn();
        EntityType<?> result19 = testSubject0.getEntityType();
        OWLEntity result20 = testSubject0.getOWLEntity(EntityType.CLASS);
        ...
        Set<OWLClassExpression> result37 = testSubject0.getSubClasses(Utils
                .getMockOntology());
        Set<OWLClassExpression> result38 = testSubject0.getSubClasses(Utils.mockSet(Utils
                .getMockOntology()));
        Set<OWLClassExpression> result39 = testSubject0.getEquivalentClasses(Utils
                .getMockOntology());
        Set<OWLClassExpression> result40 = testSubject0.getEquivalentClasses(Utils
                .mockSet(Utils.getMockOntology()));
        Set<OWLClassExpression> result41 = testSubject0.getDisjointClasses(Utils
                .mockSet(Utils.getMockOntology()));
        Set<OWLClassExpression> result42 = testSubject0.getDisjointClasses(Utils
                .getMockOntology());
        Set<OWLIndividual> result43 = testSubject0
                .getIndividuals(Utils.getMockOntology());
        Set<OWLIndividual> result44 = testSubject0.getIndividuals(Utils.mockSet(Utils
                .getMockOntology()));
        ...
        Set<OWLSubClassOfAxiom> result54 = testSubject0.getSubClassAxioms(Utils
                .getMockOntology());
    ...
    @Test
    public void shouldTestOWLDataFactoryImpl() throws Exception {
        OWLDataFactoryImpl testSubject0 = new OWLDataFactoryImpl();
        OWLDataFactoryImpl testSubject1 = new OWLDataFactoryImpl(false, false);
        OWLEntity result1 = testSubject0.getOWLEntity(EntityType.CLASS,
                IRI.create("urn:aFake"));
        OWLClass result2 = testSubject0.getOWLClass(IRI.create("urn:aFake"));
        OWLClass result3 = testSubject0.getOWLClass("", new DefaultPrefixManager());
        ...
        OWLEquivalentClassesAxiom result7 = testSubject0.getOWLEquivalentClassesAxiom(
                Utils.mockAnonClass(), Utils.mockAnonClass(),
                Utils.mockSet(mock(OWLAnnotation.class)));
        OWLEquivalentClassesAxiom result8 = testSubject0.getOWLEquivalentClassesAxiom(
                Utils.mockSet(Utils.mockAnonClass()),
                Utils.mockSet(mock(OWLAnnotation.class)));
        OWLDisjointClassesAxiom result9 = testSubject0.getOWLDisjointClassesAxiom(
                Utils.mockSet(Utils.mockAnonClass()),
                Utils.mockSet(mock(OWLAnnotation.class)));
        OWLDisjointClassesAxiom result10 = testSubject0.getOWLDisjointClassesAxiom(Utils
                .mockAnonClass());
        OWLDisjointClassesAxiom result11 = testSubject0.getOWLDisjointClassesAxiom(Utils
                .mockSet(Utils.mockAnonClass()));
        OWLClass result12 = testSubject0.getOWLThing();
        OWLClass result13 = testSubject0.getOWLNothing();
        OWLObjectProperty result14 = testSubject0.getOWLTopObjectProperty();
        OWLDataProperty result15 = testSubject0.getOWLTopDataProperty();
        OWLObjectProperty result16 = testSubject0.getOWLBottomObjectProperty();
        OWLDataProperty result17 = testSubject0.getOWLBottomDataProperty();
        OWLDatatype result18 = testSubject0.getTopDatatype();
        OWLObjectProperty result19 = testSubject0.getOWLObjectProperty("",
                new DefaultPrefixManager());
        OWLObjectProperty result20 = testSubject0.getOWLObjectProperty(IRI
                .create("urn:aFake"));
        OWLObjectInverseOf result21 = testSubject0.getOWLObjectInverseOf(Utils
                .mockObjectProperty());
        OWLDataProperty result22 = testSubject0.getOWLDataProperty("",
                new DefaultPrefixManager());
        OWLDataProperty result23 = testSubject0.getOWLDataProperty(IRI
                .create("urn:aFake"));
        OWLNamedIndividual result24 = testSubject0.getOWLNamedIndividual(IRI
                .create("urn:aFake"));
        OWLNamedIndividual result25 = testSubject0.getOWLNamedIndividual("",
                new DefaultPrefixManager());
        OWLAnonymousIndividual result26 = testSubject0.getOWLAnonymousIndividual();
        OWLAnonymousIndividual result27 = testSubject0.getOWLAnonymousIndividual("");
        OWLAnnotationProperty result28 = testSubject0.getOWLAnnotationProperty(IRI
                .create("urn:aFake"));
        OWLAnnotationProperty result29 = testSubject0.getOWLAnnotationProperty("",
                new DefaultPrefixManager());
        OWLAnnotationProperty result30 = testSubject0.getRDFSLabel();
        OWLAnnotationProperty result31 = testSubject0.getRDFSComment();
        OWLAnnotationProperty result32 = testSubject0.getRDFSSeeAlso();
        OWLAnnotationProperty result33 = testSubject0.getRDFSIsDefinedBy();
        OWLAnnotationProperty result34 = testSubject0.getOWLVersionInfo();
        OWLAnnotationProperty result35 = testSubject0.getOWLBackwardCompatibleWith();
        OWLAnnotationProperty result36 = testSubject0.getOWLIncompatibleWith();
        OWLAnnotationProperty result37 = testSubject0.getOWLDeprecated();
        OWLDatatype result38 = testSubject0.getRDFPlainLiteral();
        OWLDatatype result39 = testSubject0
                .getOWLDatatype("", new DefaultPrefixManager());
        OWLDatatype result40 = testSubject0.getOWLDatatype(IRI.create("urn:aFake"));
        OWLDatatype result41 = testSubject0.getIntegerOWLDatatype();
        OWLDatatype result42 = testSubject0.getFloatOWLDatatype();
        OWLDatatype result43 = testSubject0.getDoubleOWLDatatype();
        OWLDatatype result44 = testSubject0.getBooleanOWLDatatype();
        OWLLiteral result45 = testSubject0.getOWLLiteral(0);
        OWLLiteral result46 = testSubject0.getOWLLiteral("", mock(OWLDatatype.class));
        OWLLiteral result47 = testSubject0.getOWLLiteral(false);
        OWLLiteral result48 = testSubject0.getOWLLiteral("");
        OWLLiteral result49 = testSubject0.getOWLLiteral("", OWL2Datatype.XSD_STRING);
        ...
        OWLDataComplementOf result64 = testSubject0
        ...
        OWLDatatypeRestriction result79 = testSubject0
        ...
        OWLFacetRestriction result83 = testSubject0.getOWLFacetRestriction(
