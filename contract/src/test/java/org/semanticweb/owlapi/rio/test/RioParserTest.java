...
public class RioParserTest
{
     ...
     */
    @Test
    public void testParse() throws OWLParserException, IOException, OWLOntologyCreationException
    {
        OWLOntology owlapiOntologyPrimer = testManager.createOntology();
        
        RDFXMLParser owlapiParser = new RDFXMLParser();
        
        OWLOntologyFormat owlapiOntologyFormat =
                owlapiParser.parse(new StreamDocumentSource(this.getClass().getResourceAsStream("/koala.owl")),
                        owlapiOntologyPrimer);
        
        assertEquals(70, owlapiOntologyPrimer.getAxiomCount());
        
        assertEquals(new RDFXMLOntologyFormat(), owlapiOntologyFormat);
        
        RioParserImpl rioParser = new RioParserImpl(new RDFXMLOntologyFormatFactory());
        ...
        OWLOntologyFormat rioOntologyFormat =
                rioParser.parse(new StreamDocumentSource(this.getClass().getResourceAsStream("/koala.owl")), ontology);
        ...
        {
            logger.error("RioParserImpl did not contain expected axiom: {}", nextMissingAxiom);
        }
        
        logger.error("RioParserImpl was missing {} expected axioms", missingAxioms.size());
        
        for(OWLAxiom nextAxiom : ontology.getAxioms())
        {
            if(!owlapiOntologyPrimer.getAxioms().contains(nextAxiom))
            {
                logger.error("RioParserImpl contained unexpected axiom: {}", nextAxiom);
            }
        }
     ...
     */
    @Test
    public void testParsePrimer() throws OWLParserException, IOException, OWLOntologyCreationException
    {
        OWLOntology owlapiOntologyPrimer = testManager.createOntology();
        ...
        OWLOntologyFormat owlapiOntologyFormat =
                owlapiParser.parse(new StreamDocumentSource(this.getClass().getResourceAsStream("/primer.rdfxml.xml")),
                        owlapiOntologyPrimer);
        ...
        OWLOntologyFormat rioOntologyFormat =
                rioParser.parse(new StreamDocumentSource(this.getClass().getResourceAsStream("/primer.rdfxml.xml")),
                        rioOntologyPrimer);
        ...
        for(OWLAxiom nextAxiom : owlapiOntologyPrimer.getAxioms())
        {
            if(!rioOntologyPrimer.getAxioms().contains(nextAxiom))
            {
                logger.error("RioParserImpl was missing an expected axiom: {}", nextAxiom);
            }
        }
    ...
    @Ignore
    @Test
    public void testParsePrimerSubset() throws OWLParserException, IOException, OWLOntologyCreationException
    {
        OWLOntology owlapiOntologyPrimer = testManager.createOntology();
        ...
        OWLOntologyFormat owlapiOntologyFormat =
                owlapiParser.parse(
                        new StreamDocumentSource(this.getClass().getResourceAsStream("/rioParserTest1.rdf")),
                        owlapiOntologyPrimer);
        ...
        OWLOntologyFormat rioOntologyFormat =
                rioParser.parse(new StreamDocumentSource(this.getClass().getResourceAsStream("/rioParserTest1.rdf")),
                        rioOntologyPrimer);
    ...
    @Ignore
    @Test
    public void testParsePrimerMinimalSubset() throws OWLParserException, IOException, OWLOntologyCreationException
    {
        OWLOntology owlapiOntologyPrimer = testManager.createOntology();
        ...
        OWLOntologyFormat owlapiOntologyFormat =
                owlapiParser.parse(
                        new StreamDocumentSource(this.getClass().getResourceAsStream("/rioParserTest1-minimal.rdf")),
                        owlapiOntologyPrimer);
