...
public class Example9 {
    ...
    public static void main(String[] args) {
        try {
            ...
            // We want to examine the restrictions on margherita pizza. To do
            // this, we
            // need to obtain a reference to the margherita pizza class. In this
            // case, we
            // know the URI for margherita pizza (it happens to be the ontology
            // URI - the base
            // URI plus #Margherita - note that this isn't always the case. A
            // class may have
            // a URI that bears no resemblance to the ontology URI which
            // contains axioms about the
            // class).
            ...
            OWLClass margheritaPizza = man.getOWLDataFactory().getOWLClass(
                    margheritaPizzaIRI);
            // Now we want to collect the properties which are used in
            // existential restrictions on the
            // class. To do this, we will create a utility class -
            // RestrictionVisitor, which acts as
            // a filter for existential restrictions. This uses the Visitor
            // Pattern (google Visitor Design
            ...
            // margherita pizza we need to obtain the subclass axioms for
            // margherita pizza.
