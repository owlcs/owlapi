 ...
 * Date: 20-Dec-2009 </p> This example shows how to specify various property
...
public class PropertyAssertions {
    ...
    public void shouldCreatePropertyAssertions() throws OWLOntologyStorageException,
        ...
        // To specify that :John is related to :Mary via the :hasWife
        // property we create an object property
        ...
        // Note that the above is a shortcut for creating a typed literal
        // and specifying this typed literal as the
        // value of the property assertion. That is,
        // Get hold of the xsd:integer datatype
        OWLDatatype integerDatatype = factory.getOWLDatatype(OWL2Datatype.XSD_INTEGER
                .getIRI());
        // Create a typed literal. We type the literal "51" with the
        // datatype
