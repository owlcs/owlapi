 ...
 * Primer. The purpose of this example is to illustrate some of the methods of
 * creating class expressions and various types of axioms. Typically, an
 * ontology wouldn't be constructed programmatically in a long drawn out fashion
 * like this, it would be constructe in an ontology editor such as Protege 4, or
 * Swoop. The OWL API would then be used to examine the asserted structure of
 * the ontology, and in conjunction with an OWL reasoner such as FaCT++ or
 * Pellet used to query the inferred ontology. */
public class OWLPrimer {
    @SuppressWarnings("javadoc")
    public static void main(String[] args) {
        try {
            // The OWLOntologyManager is at the heart of the OWL API, we can
            // create
            ...
            // We want to create an ontology that corresponds to the ontology
            // used in the OWL
            // Primer. Every ontology has a URI that uniquely identifies the
            // ontology. The
            // URI is essentially a name for the ontology. Note that the URI
            // doesn't necessarily
            // point to a location on the web - in this example, we won't
            // publish the ontology at
            ...
            // ontology.
            // Note that the create ontology method throws an
            // OWLOntologyCreationException if
            // there was a problem creating the ontology.
            OWLOntology ont = manager.createOntology(ontologyIRI);
            // We can use the manager to get a reference to an OWLDataFactory.
            // The data factory
            // provides a point for creating OWL API objects such as classes,
            // properties and
            // individuals.
            OWLDataFactory factory = manager.getOWLDataFactory();
            // We first need to create some references to individuals. All of
            // our individual must
            // have URIs. A common convention is to take the URI of an ontology,
            // append a # and then
            // a local name. For example we can create the individual 'John',
            // using the ontology URI
            // and appending #John. Note however, that there is no reuqirement
            // that a URI of a class,
            // property or individual that is used in an ontology have a
            ...
            OWLIndividual bill = factory.getOWLNamedIndividual(IRI.create(ontologyIRI
                    + "#Bill"));
            // The ontologies that we created aren't contained in any ontology
            // at the moment.
            // Individuals (or classes or properties) can't directly be added to
            // an ontology,
            // they have to be used in axioms, and then the axioms are added to
            // an ontology.
            // We now want to add some facts to the ontology. These facts are
            // otherwise known
            // as property assertions.
            // In our case, we want to say that John has a wife Mary. To do this
            // we need to
            // have a reference to the hasWife object property (object
            // properties link an individual
            // to an individual, and data properties link and individual to a
            // constant - here, we
            ...
            // this we need
            // an axiom, in this case an object property assertion axiom. This
            // can be thought of
            // as a "triple" that has a subject, john, a predicate, hasWife and
            // an object Mary
            ...
            // apply an ontology change
            // to the ontology via the OWLOntologyManager.
            // First we create the change object that will tell the manager that
            // we want to add the
            ...
            OWLAxiom axiom2 = factory.getOWLObjectPropertyAssertionAxiom(hasSon, john,
                    bill);
            // Apply the change
            ...
            OWLAxiom axiom3 = factory.getOWLObjectPropertyAssertionAxiom(hasDaughter,
                    john, susan);
            manager.applyChange(new AddAxiom(ont, axiom3));
            // John hasAge 33
            // In this case, hasAge is a data property, which we need a
            // reference to
            ...
            // In the above code, 33 is an integer, so we can just pass 33 into
            // the data factory method.
            // Behind the scenes the OWL API will create a typed constant that
            // it will use as the value
            // of the data property assertion. We could have manually created
            ...
            // We can now create the other facts/assertion for Mary. The OWL API
            // uses a change
            // object model, which means we can stack up changes (or sets of
            // axioms) and apply the
            ...
            axioms.add(factory.getOWLObjectPropertyAssertionAxiom(hasDaughter, mary,
                    susan));
            ...
            // Now add all the axioms in one go - there is a convenience method
            // on OWLOntologyManager
            // that will automatically generate the AddAxiom change objects for
            // us. We need to
            // specify the ontology that the axioms should be added to and the
            // axioms to add.
            manager.addAxioms(ont, axioms);
            // Now specify the genders of John, Mary, Bill and Susan. To do this
            // we need the male
            ...
            genders.add(factory.getOWLObjectPropertyAssertionAxiom(hasGender, susan,
                    female));
            ...
            //
            // ////////////////////////////////////////////////////////////////////////////////////////////
            // At this point, we have an ontology containing facts about several
            // individuals.
            // We now want to specify more information about the various
            // properties that we have
            // used. We want to say that the domains and ranges of hasWife,
            // hasSon and hasDaughter
            // are the class Person. To do this we need various domain and range
            // axioms, and we
            ...
            // Now we add the domain and range axioms that specify the domains
            // and ranges
            ...
            domainsAndRanges
            .add(factory.getOWLObjectPropertyDomainAxiom(hasWife, person));
            ...
            domainsAndRanges.add(factory.getOWLObjectPropertyDomainAxiom(hasDaughter,
                    person));
            domainsAndRanges.add(factory.getOWLObjectPropertyRangeAxiom(hasDaughter,
                    person));
            // We also have the domain of the data property hasAge as Person,
            // and the range as
            // integer.
            // We need the integer datatype. The XML Schema Datatype URIs are
            // used for data types.
            ...
            //
            // ////////////////////////////////////////////////////////////////////////////////////////////
            // We can also explicitly say than an individual is an instance of a
            // given class.
            ...
            // http://example.com/owlapi/families#hasHusband
            // since the URI of our ontology is
            // http://example.com/owlapi/families
            ...
            //
            // ////////////////////////////////////////////////////////////////////////////////////////////
            // OWL allows a property hierarchy to be specified. Here, hasSon and
            // hasDaughter will
            ...
            //
            // ////////////////////////////////////////////////////////////////////////////////////////////
            // Next, we want to say that the hasAge property is Functional. This
            // means that
            // something can have at most one hasAge property. We can do this
            // with a
            ...
            // Note that the asymmetric property axiom used to be called
            // antisymmetric - older versions
            ...
            hasWifeAxioms
            .add(factory.getOWLInverseFunctionalObjectPropertyAxiom(hasWife));
            ...
            //
            // ////////////////////////////////////////////////////////////////////////////////////////////
            // Now we want to start specifying something about classes in our
            // ontology. To begin with
            // we will simply say something about the relationship between named
            // classes
            // Besides the Person class that we already have, we want to say
            // something about the classes
            // Man, Woman and Parent. To say something about these classes, as
            // usual, we need references
            // to them:
            ...
            // It is important to realise that simply getting references to a
            // class via the data factory
            // does not add them to an ontology - only axioms can be added to an
            // ontology.
            ...
            //
            // ////////////////////////////////////////////////////////////////////////////////////////////
            // Now we want to say that Person has exactly 1 Age, exactly 1
            // Gender and, only has gender
            // that is male or female. We will deal with these restrictions one
            // by one and then combine
            // them as a superclass (Necessary conditions) of Person. All
            ...
            // To create this restriction, we need an OWLObjectOneOf class
            // expression since male and female are individuals
            // We can just list as many individuals as we need as the argument
            // of the method.
            ...
            manager.addAxiom(ont, factory.getOWLObjectPropertyRangeAxiom(hasDaughter,
                    rangeOfHasDaughter));
            // ////////////////////////////////////////////////////////////////////////////////////////////
            //
            ...
            // restrictions.
            OWLDataRange dataRng = factory.getOWLDatatypeRestriction(integerDatatype,
                    geq13, lt20);
            ...
            OWLClass teenager = factory
                    .getOWLClass(IRI.create(ontologyIRI + "#Teenager"));
            ...
            OWLClassExpression adultAgeRestriction = factory.getOWLDataSomeValuesFrom(
                    hasAge, geq21);
            ...
            OWLClassExpression childAgeRestriction = factory.getOWLDataSomeValuesFrom(
                    hasAge, notGeq21);
            ...
            //
            // ////////////////////////////////////////////////////////////////////////////////////////////
            // Having added axioms to out ontology we can now save it (in a
            // variety of formats).
            ...
            System.out.println("There was a problem creating the ontology: "
                    + e.getMessage());
