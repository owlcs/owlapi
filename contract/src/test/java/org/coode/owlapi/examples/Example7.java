 ...
 * <br>
 * <p/>
 * This example shows how to work with dataranges. OWL 1.1 allows data ranges to
 * be created by taking a base datatype e.g. int, string etc. and then by
 * applying facets to restrict the datarange. For example, int greater than 18 */
public class Example7 {
    ...
    public void main() throws OWLOntologyCreationException, OWLOntologyStorageException {
        ...
        // have an age greater than 18. To do this, we will create a
        // restriction
        // along a hasAge property, with a filler that corresponds to the
        // set
        ...
        OWLDataProperty hasAge = factory.getOWLDataProperty(IRI.create(base
                + "hasAge"));
        // For completeness, we will make hasAge functional by adding an
        // axiom to state this
        ...
        // Now create the data range which correponds to int greater than
        // 18. To do this, we
        // get hold of the int datatype and then restrict it with a
        ...
        // Now create our custom datarange, which is int greater than or
        // equal to 18. To do this,
        // we need the minInclusive facet
        OWLFacet facet = OWLFacet.MIN_INCLUSIVE;
        // Create the restricted data range by applying the facet
        // restriction with a value of 18 to int
        ...
        // Now we want to say all adults have an age that is greater or
        // equal to 18 - i.e. Adult is a subclass of
        // hasAge some int[>= 18]
        // Obtain a reference to the Adult class
        OWLClass adult = factory.getOWLClass(IRI.create(base + "#Adult"));
        // Now make adult a subclass of the things that have an age greater
        // to or equal to 18
