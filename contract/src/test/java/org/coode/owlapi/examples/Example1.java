...
public class Example1 {
    ...
    public void shouldLoadAndSave() throws OWLOntologyCreationException,
        ...
        // unique within an ontology manager. Each ontology knows its
        // ontology manager. To load multiple copies of an ontology,
        // multiple managers would have to be used.
        OWLOntologyManager manager = OWLManager.createOWLOntologyManager();
        // We load an ontology from a document IRI - in this case we'll load
        // the pizza ontology.
        IRI documentIRI = IRI
                .create("http://www.co-ode.org/ontologies/pizza/pizza.owl");
        // Now ask the manager to load the ontology
        OWLOntology ontology = manager.loadOntologyFromOntologyDocument(documentIRI);
        // Print out all of the classes which are contained in the signature
        // of the ontology.
        // These are the classes that are referenced by axioms in the
        // ontology.
