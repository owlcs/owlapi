...
@Ignore
 public class Example16 {
     ...
     public void main() throws OWLOntologyCreationException, OWLOntologyStorageException {
         ...
         // We therefore have to generate a seed signature that contains
         // "PizzaTopping" and its subclasses.
         ...
         // classes.
         // Ideally, it should be done using a DL reasoner, in order to take
         // inferred subclass relations into account.
         // We are using the structural reasoner of the OWL API for
         // simplicity.
         ...
         // For most reuse purposes, the module type should be STAR -- this
         // yields the smallest possible locality-based module.
         // These modules guarantee that all entailments of the original
         // ontology that can be formulated using only
         // terms from the seed signature or the module will also be
         // entailments of the module.
         // In easier words, the module preserves all knowledge of the
