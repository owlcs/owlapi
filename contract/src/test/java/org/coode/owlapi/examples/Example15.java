...
public class Example15 {
    private static IRI MGED_ONTOLOGY_IRI = IRI
            .create("http://mged.sourceforge.net/ontologies/MGEDOntology.owl");
    private static IRI PROTEGE_ONTOLOGY_IRI = IRI
            .create("http://protege.stanford.edu/plugins/owl/protege");
    private static IRI TONES_REPOSIITORY_IRI = IRI
    ...
    public void main() throws OWLOntologyCreationException {
        ...
        // Load the MGED ontology. There is a copy of the MGED ontology
        // located at the address pointed to
        // by its ontology IRI (this is good practice and is recommended in
        // the OWL 2 spec).
        ...
        // Protege ontology (that it
        // imports) from the TONES repository. To tell the ontology manager
        // to do this we need to add an IRI
        // mapper. We need an implementation of OWLOntologyIRIMapper. Given
        // and IRI and OWLOntologyIRIMapper
        // simply returns some other IRI. There are quite a few
        // implementations of IRI mapper in the OWL API,
        // here we will just use a really basic implementation that maps a
        // specific IRI to another specific IRI.
        // Create a mapper that maps the Protege ontology IRI to the
        // document IRI that points to a copy in the
        ...
        // Notice that the document IRI of the protege ontology is different
        // to the document IRI of the ontology
        // when it was loaded the first time. This is due to the mapper
        // redirecting the ontology loader.
        // For example, AutoIRIMapper:
        // An AutoIRIMapper finds ontologies in a local folder and maps
        // their IRIs to their locations in this folder
        // We specify a directory/folder where the ontologies are located.
        // In this case we've just specified the tmp
        // directory.
        File file = new File("/tmp");
        // We can also specify a flag to indicate whether the directory
        ...
        // Of course, applications (such as Protege) usually implement their
        // own mappers to deal with specific
