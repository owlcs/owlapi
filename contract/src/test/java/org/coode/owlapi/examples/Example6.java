...
public class Example6 {
    ...
    public void main() throws OWLOntologyCreationException, OWLOntologyStorageException {
        ...
        // parts that are noses (in fact, here we merely state that a Head
        // has
        // at least one nose!). We do this by creating an existential (some)
        // restriction
        // to describe the class of things which have a part that is a nose
        // (hasPart some Nose),
        // and then we use this restriction in a subclass axiom to state
        // that Head is a subclass
        // of things that have parts that are Noses SubClassOf(Head, hasPart
        // some Nose) -- in
        // other words, Heads have parts that are noses!
        // First we need to obtain references to our hasPart property and
        // our Nose class
        ...
        // We now want to state that Head is a subclass of hasPart some
        // Nose, to do this we
        // create a subclass axiom, with head as the subclass and
        // "hasPart some Nose" as the
        // superclass (remember, restrictions are also classes - they
        // describe classes of individuals
