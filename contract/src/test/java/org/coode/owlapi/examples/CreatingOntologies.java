 ...
 * Date: 20-Dec-2009 </p> These examples show how to create new ontologies */
public class CreatingOntologies {
    @SuppressWarnings("javadoc")
    @Test
    public void shouldCreateOntology() throws OWLOntologyCreationException {
        // We first need to create an OWLOntologyManager, which will provide
        // a point for creating,
        // loading and saving ontologies.
        // We can create a default ontology manager with the OWLManager
        // class. This provides a common setup
        // of an ontology manager. It registers parsers etc. for loading
        // ontologies in a variety of syntaxes
        ...
        // If we publish our ontology then we should make the location
        // coincide with the ontology IRI
        ...
        // version IRI
        // The OWL API encapsulates ontology IRI and possible version IRI
        // information in an OWLOntologyID
        // Each ontology knows about its ID
        OWLOntologyID ontologyID = ontology.getOntologyID();
        // In this case our ontology has an IRI but does not have a version
        // IRI
        System.out.println("Ontology IRI: " + ontologyID.getOntologyIRI());
        // Our version IRI will be null to indicate that we don't have a
        // version IRI
        System.out.println("Ontology Version IRI: " + ontologyID.getVersionIRI());
        // An ontology may not have a version IRI - in this case, we count
        // the ontology as an anonymous
        ...
        .println("--------------------------------------------------------------------------------");
        // ////////////////////////////////////////////////////////////////////////////////////////////////////////
        // Once an ontology has been created its ontology ID (Ontology IRI
        // and version IRI can be changed)
        // to do this we must apply a SetOntologyID change through the
        // ontology manager.
        // Lets specify a version IRI for our ontology. In our case we will
        // just "extend" our ontology IRI
        // with some version information. We could of course specify any IRI
        // for our version IRI.
        ...
        .println("--------------------------------------------------------------------------------");
        // ////////////////////////////////////////////////////////////////////////////////////////////////////////
        // We can also just specify the ontology IRI and possibly the
        // version IRI at ontology creation time
