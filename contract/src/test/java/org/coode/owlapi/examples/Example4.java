 ...
 * <br>
 * <p/>
 * This example shows how add an object property assertion (triple) of the form
 * prop(subject, object) for example hasPart(a, b) */
public class Example4 {
    ...
    public void main() throws OWLOntologyCreationException, OWLOntologyStorageException {
        ...
        // who is peter.
        // We need a subject and object - matthew is the subject and peter
        // is the
        // object. We use the data factory to obtain references to these
        // individuals
        ...
        OWLIndividual peter = dataFactory.getOWLNamedIndividual(IRI.create(base
                + "#peter"));
        // We want to link the subject and object with the hasFather
        // property, so use the data factory
        ...
        // We can also specify that matthew is an instance of Person. To do
        // this we use a ClassAssertion axiom.
        // First we need a reference to the person class
        OWLClass personClass = dataFactory.getOWLClass(IRI.create(base + "#Person"));
        // Now we will create out Class Assertion to specify that matthew is
        // an instance of Person (or rather that
        ...
        // instead of creating the AddAxiom change
        // ourselves, it will be created automatically and the change
        // applied
        man.addAxiom(ont, ax);
        // Save our ontology
