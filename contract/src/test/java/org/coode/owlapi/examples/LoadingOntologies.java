 ...
 * Date: 20-Dec-2009 </p> The examples here show how to load ontologies */
public class LoadingOntologies {
    ...
    public static void main(String[] args) {
        try {
            ...
            // We can also load ontologies from files. Download the pizza
            // ontology from
            // http://www.co-ode.org/ontologies/pizza/pizza.owl and put it
            ...
            // We can always obtain the location where an ontology was loaded
            // from
            ...
            // ontology IRI mapper can be used
            // to provide a redirection mechanism. This means that ontologies
            // can be loaded as if they were located
            // on the web.
            // In this example, we simply redirect the loading from
