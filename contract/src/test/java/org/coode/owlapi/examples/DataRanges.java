 ...
 * Date: 20-Dec-2009 </p> This example shows how to create dataranges */
public class DataRanges {
    ...
    OWLOntologyStorageException {
        ...
        // Data ranges are used as the types of literals, as the ranges for
        // data properties, as filler for data reatrictions.
        // Get hold of a manager to work with
        OWLOntologyManager manager = OWLManager.createOWLOntologyManager();
        OWLDataFactory factory = manager.getOWLDataFactory();
        // OWLDatatype represents named datatypes in OWL. These are a bit
        // like classes whose instances are data values
        ...
        // The top datatype (analgous to owl:Thing) is rdfs:Literal, which
        // can be obtained from the data factory
        OWLDatatype rdfsLiteral = factory.getTopDatatype();
        // Custom data ranges can be built up from these basic datatypes.
        // For example, it is possible to
        // restrict a datatype using facets from XML Schema Datatypes. For
        // example, lets create a data range
        // that describes integers that are greater or equal to 18
        // To do this, we restrict the xsd:integer datatype using the
        // xsd:minInclusive facet with a value of 18.
        // Get hold of a literal that is an integer value 18
        OWLLiteral eighteen = factory.getOWLLiteral(18);
        // Now create the restriction. The OWLFacet enum provides an
        // enumeration of the various facets that can be used
        ...
        // properties etc.
        // For example, if we want to restrict the range of the :hasAge data
        // property to 18 or more
        ...
        // For creating datatype restrictions on integers or doubles there
        // are some convenience methods on OWLDataFactory
        // For example:
        ...
        // For example, we could create a union of data ranges of the data
        // range integer less than 16 or integer greater or equal to 60
        OWLDataUnionOf concessionaryAge = factory.getOWLDataUnionOf(integerLT16,
                integerGE60);
        // We can also coin names for custom data ranges. To do this we use
        // an OWLDatatypeDefintionAxiom
        // Get hold of a named datarange (datatype) that will be used to
        // assign a name to our above datatype
