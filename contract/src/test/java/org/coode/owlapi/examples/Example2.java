...
public class Example2 {
    ...
    public void main() throws OWLOntologyCreationException, OWLOntologyStorageException {
        ...
        // Ontologies cna have an IRI, which is used to identify the
        // ontology. You should
        // think of the ontology IRI as the "name" of the ontology. This IRI
        // frequently
        // resembles a Web address (i.e. http://...), but it is important to
        // realise that
        // the ontology IRI might not necessarily be resolvable. In other
        // words, we
        // can't necessarily get a document from the URL corresponding to
        // the ontology
        // IRI, which represents the ontology.
        // In order to have a concrete representation of an ontology (e.g.
        // an RDF/XML
        // file), we MAP the ontology IRI to a PHYSICAL URI. We do this
        // using an IRIMapper
        // Let's create an ontology and name it
        // "http://www.co-ode.org/ontologies/testont.owl"
        // We need to set up a mapping which points to a concrete file where
        // the ontology will
        // be stored. (It's good practice to do this even if we don't intend
        // to save the ontology).
        ...
        // Now we want to specify that A is a subclass of B. To do this, we
        // add a subclass
        // axiom. A subclass axiom is simply an object that specifies that
        // one class is a
        // subclass of another class.
        // We need a data factory to create various object from. Each
        // manager has a reference
        ...
        // that
        // A is a subclass of B. To do this we create an AddAxiom change
        // object.
        // At this stage neither classes A or B, or the axiom are contained
        // in the ontology. We have to
        // add the axiom to the ontology.
        AddAxiom addAxiom = new AddAxiom(ontology, axiom);
        // We now use the manager to apply the change
        manager.applyChange(addAxiom);
        // The ontology will now contain references to class A and class B -
        // that is, class A and class B
        // are contained within the SIGNATURE of the ontology let's print
        // them out
