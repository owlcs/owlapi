...
public class Example13 {
    ...
    public static void main(String[] args) {
        try {
            // This example shows how to use an ontology walker to walk the
            // asserted structure
            // of an ontology.
            // Suppose we want to find the axioms that use a some values from
            // (existential restriction)
            // we can use the walker to do this.
            // We'll use the pizza ontology as an example. Load the ontology
            // from the web:
            IRI documentIRI = IRI
            ...
            // Now ask our walker to walk over the ontology. We specify a
            // visitor who gets visited
            // by the various objects as the walker encounters them.
            // We need to create out visitor. This can be any ordinary visitor,
            // but we will
            // extend the OWLOntologyWalkerVisitor because it provides a
            // convenience method to
            // get the current axiom being visited as we go.
            // Create an instance and override the
            // visit(OWLObjectSomeValuesFrom) method, because
            ...
            System.out.println("There was a problem loading the ontology: "
                    + e.getMessage());
        }
    }
}
