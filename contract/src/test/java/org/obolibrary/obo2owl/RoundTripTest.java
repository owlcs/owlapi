...
public class RoundTripTest extends OboFormatTestBasics {
    ...
    public List<Diff> roundTripOBODoc(@Nonnull OBODoc obodoc, boolean isExpectRoundtrip)
        throws Exception {
    ...
    public boolean roundTripOWLOOntology(@Nonnull OWLOntology oo, boolean isExpectRoundtrip)
        throws IOException {
