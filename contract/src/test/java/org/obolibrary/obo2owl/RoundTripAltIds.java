...
public class RoundTripAltIds extends RoundTripTest {
    ...
    public void testAltIds() throws Exception {
        ...
        // check owl
        // check that both alt_id is declared as deprecated class and has appropriate annotations
    ...
    private void checkAsAltId(IRI iri, OWLOntology ont, String replacedBy) {
        ...
        for (OWLAnnotationAssertionAxiom axiom : ont.getAnnotationAssertionAxioms(iri)) {
