...
public class LoadAnonymousTestCase extends TestBase {
    ...
    public void shouldLoad() throws OWLOntologyCreationException {
        ...
        OWLAnnotationProperty autogeneratedby = ap("http://www.geneontology.org/formats/oboInOwl#auto-generated-by");
        OWLAnnotationProperty hasDbXref = ap("http://www.geneontology.org/formats/oboInOwl#hasDbXref");
        OWLAnnotationProperty defaultnamespace = ap("http://www.geneontology.org/formats/oboInOwl#default-namespace");
        ...
        Set<OWLAxiom> expected = Sets.newHashSet(
            Declaration(date),
            ...
            df.getOWLAnnotationAssertionAxiom(iao0000115, uo0.getIRI(), literal(
                "A unit of measurement is a standardized quantity of a physical quality."), singleton(Annotation(
                    hasDbXref, literal))),
    ...
    private static OWLAnnotationProperty ap(String s) {
        return df.getOWLAnnotationProperty(s);
    }
}
