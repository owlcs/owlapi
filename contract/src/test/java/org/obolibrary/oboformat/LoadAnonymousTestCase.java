...
public class LoadAnonymousTestCase extends TestBase {
    ...
    public void shouldLoad() throws OWLOntologyCreationException {
        ...
        OWLOntology ontology = m1
            .loadOntologyFromOntologyDocument(streamDocumentSource, loaderConfig);
        ...
        OWLAnnotationProperty subsetProperty = ap("http://www.geneontology.org/formats/oboInOwl#",
            "SubsetProperty");
        OWLAnnotationProperty attributeSlim = ap("http://purl.obolibrary.org/obo/uo#",
            "attribute_slim");
        OWLAnnotationProperty hasOBONamespace = ap("http://www.geneontology.org/formats/oboInOwl#",
            "hasOBONamespace");
        OWLAnnotationProperty autogeneratedby = ap("http://www.geneontology.org/formats/oboInOwl#",
            "auto-generated-by");
        OWLAnnotationProperty hasDbXref = ap("http://www.geneontology.org/formats/oboInOwl#",
            "hasDbXref");
        OWLAnnotationProperty defaultnamespace = ap("http://www.geneontology.org/formats/oboInOwl#",
            "default-namespace");
        OWLAnnotationProperty hasOBOFormatVersion = ap(
            "http://www.geneontology.org/formats/oboInOwl#",
            "hasOBOFormatVersion");
        OWLAnnotationProperty iao0000115 = ap("http://purl.obolibrary.org/obo/", "IAO_0000115");
        OWLAnnotationProperty namespaceIdRule = ap("http://www.geneontology.org/formats/oboInOwl#",
            "NamespaceIdRule");
        OWLAnnotationProperty createdBy = ap("http://www.geneontology.org/formats/oboInOwl#",
            "created_by");
        OWLAnnotationProperty inSubset = ap("http://www.geneontology.org/formats/oboInOwl#",
            "inSubset");
        OWLAnnotationProperty savedby = ap("http://www.geneontology.org/formats/oboInOwl#",
            "saved-by");
        ...
        OWLAnnotationProperty abnormalSlim = ap("http://purl.obolibrary.org/obo/uo#",
            "abnormal_slim");
        ...
        OWLObjectProperty isUnitOf = ObjectProperty(
            IRI("http://purl.obolibrary.org/obo/uo#", "is_unit_of"));
        OWLAnnotationProperty cellQuality = ap("http://purl.obolibrary.org/obo/uo#",
            "cell_quality");
        OWLAnnotationProperty unitGroupSlim = ap("http://purl.obolibrary.org/obo/uo#",
            "unit_group_slim");
        ...
        OWLAnnotationProperty dispositionSlim = ap("http://purl.obolibrary.org/obo/uo#",
            "disposition_slim");
        OWLAnnotationProperty relationalSlim = ap("http://purl.obolibrary.org/obo/uo#",
            "relational_slim");
        Set<OWLAxiom> expected = Sets
            .newHashSet(Declaration(date), Declaration(autogeneratedby), Declaration(
                hasDbXref), Declaration(defaultnamespace), Declaration(subsetProperty),
                Declaration(hasOBOFormatVersion),
                Declaration(iao0000115), Declaration(namespaceIdRule), Declaration(createdBy),
                Declaration(inSubset),
                Declaration(savedby), Declaration(pato0001708), Declaration(uo0),
                Declaration(RDFSComment()), Declaration(
                    RDFSLabel()), Declaration(hasOBONamespace), Declaration(uo1), Declaration(id),
                SubAnnotationPropertyOf(
                    mpathSlim, subsetProperty),
                AnnotationAssertion(hasOBONamespace, uo1.getIRI(), literal(
                    "unit.ontology")), comment(attributeSlim.getIRI(), literal("Attribute slim")),
                label(iao0000115
                    .getIRI(), literal("definition")),
                AnnotationAssertion(hasOBONamespace, uo0.getIRI(),
                    literal("unit.ontology")), SubAnnotationPropertyOf(unitSlim, subsetProperty),
                comment(
                ...
                comment(abnormalSlim.getIRI(), literal(
                    "Abnormal/normal slim")),
                SubAnnotationPropertyOf(attributeSlim, subsetProperty), label(uo0.getIRI(),
                    literal("unit")), SubAnnotationPropertyOf(dispositionSlim, subsetProperty),
                comment(unitSlim
                    .getIRI(), literal("unit slim")),
                SubAnnotationPropertyOf(relationalSlim, subsetProperty),
                AnnotationAssertion(id, uo1.getIRI(), literal("UO:0000001")),
                comment(mpathSlim.getIRI(), literal(
                    "Pathology slim")),
                AnnotationAssertion(createdBy, uo1.getIRI(), literal("george gkoutos")), label(
                    hasDbXref.getIRI(), literal("database_cross_reference")), SubClassOf(uo1, uo0),
                label(
                    hasOBONamespace.getIRI(), literal("has_obo_namespace")),
                AnnotationAssertion(id, uo0.getIRI(),
                    literal("UO:0000000")), AnnotationAssertion(createdBy, uo0.getIRI(), literal(
                    "george gkoutos")), comment(prefixSlim.getIRI(), literal("prefix slim")),
                comment(
                ...
                comment(dispositionSlim.getIRI(), literal(
                    "Disposition slim")), label(inSubset.getIRI(), literal("in_subset")),
                SubAnnotationPropertyOf(valueSlim,
                    subsetProperty),
                AnnotationAssertion(inSubset, uo1.getIRI(), unitGroupSlim.getIRI()), df
                    .getOWLAnnotationAssertionAxiom(iao0000115, uo0.getIRI(), literal(
                        ...
                        singleton(
                            Annotation(hasDbXref, literal))),
                df.getOWLAnnotationAssertionAxiom(iao0000115, uo1
                        .getIRI(), literal(
