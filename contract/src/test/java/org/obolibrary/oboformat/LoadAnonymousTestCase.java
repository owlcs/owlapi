...
public class LoadAnonymousTestCase extends TestBase {
    ...
    private static final String UO = "http://purl.obolibrary.org/obo/uo#";
    ...
    public void shouldLoad() throws OWLOntologyCreationException {
        ...
        OWLAnnotationProperty mpathSlim = ap(UO, "mpath_slim");
        OWLAnnotationProperty subsetProperty = ap(OBO_IN_OWL, "SubsetProperty");
        OWLAnnotationProperty attributeSlim = ap(UO, "attribute_slim");
        ...
        OWLAnnotationProperty abnormalSlim = ap(UO, "abnormal_slim");
        OWLAnnotationProperty scalarSlim = ap(UO, "scalar_slim");
        OWLLiteral literal = literal("Wikipedia:Wikipedia");
        OWLAnnotationProperty unitSlim = ap(UO, "unit_slim");
        OWLAnnotationProperty absentSlim = ap(UO, "absent_slim");
        OWLObjectProperty isUnitOf = ObjectProperty(IRI(UO, "is_unit_of"));
        OWLAnnotationProperty cellQuality = ap(UO, "cell_quality");
        OWLAnnotationProperty unitGroupSlim = ap(UO, "unit_group_slim");
        OWLAnnotationProperty valueSlim = ap(UO, "value_slim");
        OWLAnnotationProperty prefixSlim = ap(UO, "prefix_slim");
        OWLAnnotationProperty dispositionSlim = ap(UO, "disposition_slim");
        OWLAnnotationProperty relationalSlim = ap(UO, "relational_slim");
