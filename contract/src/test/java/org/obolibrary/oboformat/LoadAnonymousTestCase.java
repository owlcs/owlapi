...
public class LoadAnonymousTestCase extends TestBase {
    ...
    public void shouldLoad() throws OWLOntologyCreationException {
        ...
        Set<OWLAxiom> expected = Sets.newHashSet(Declaration(date), Declaration(autogeneratedby),
            Declaration(hasDbXref), Declaration(defaultnamespace),
            Declaration(subsetProperty), Declaration(hasOBOFormatVersion),
            Declaration(iao0000115), Declaration(namespaceIdRule),
            ...
            label(hasDbXref.getIRI(), literal("database_cross_reference")),
            SubClassOf(uo1, uo0),
            ...
            df.getOWLAnnotationAssertionAxiom(iao0000115, uo0.getIRI(), literal(
