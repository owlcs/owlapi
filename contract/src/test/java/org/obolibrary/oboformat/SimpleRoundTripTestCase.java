...
class SimpleRoundTripTestCase extends RoundTripTestBasics {
    ...
    @ValueSource(strings = {"roundtrip_cardinality.obo", "caro.obo",
        "roundtrip_equivalent_to_chain.obo", "multiple_def_xref_test.obo", "namespace-id-rule.obo",
        "roundtrip_non_standard_synonyms.obo", "property_value_test.obo",
        "property_value_qualifier_test.obo", "relationship_vs_property.obo", "simplego.obo",
        "synonym_test.obo", "version_iri_test.obo", "xref_escapecolon.obo", "xref_annotation.obo",
    ...
    void roundTrip(String file) throws FrameStructureException {
