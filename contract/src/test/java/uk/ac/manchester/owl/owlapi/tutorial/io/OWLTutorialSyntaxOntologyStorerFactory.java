...
public class OWLTutorialSyntaxOntologyStorerFactory implements OWLOntologyStorerFactory
{
    ...
    public OWLOntologyStorer createStorer() {
        return new OWLTutorialSyntaxOntologyStorer();
    }
    ...
    public OWLOntologyFormatFactory getFormatFactory() {
        return new OWLTutorialSyntaxOntologyFormatFactory();
    }
