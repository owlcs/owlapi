...
class TutorialSnippetsTestCase {
    ...
    static final IRI KOALA_IRI =
        IRI.create("http://protege.stanford.edu/plugins/owl/owl-library/", "koala.owl");
    static final IRI EXAMPLE_IRI = IRI.create("http://www.semanticweb.org/ontologies/", "ont.owl");
    static final IRI EXAMPLE_SAVE_IRI =
    ...
    private static OWLOntology loadPizzaOntology(OWLOntologyManager m)
        ...
        return m.loadOntologyFromOntologyDocument(new StringDocumentSource(TestFiles.KOALA));
    }
