    ...
    public static void main(String[] args) {
        try {
            ...
            NodeSet<OWLNamedIndividual> individualsNodeSet = reasoner.getInstances(
                    country, true);
            // The reasoner returns a NodeSet again. This time the NodeSet
            ...
            // returned were explicitly stated
            // to be pets.
            // Finally, we can ask for the property values (property assertions
            // in OWL speak) for a given individual
            // and property.
            // Let's get the property values for the individual Mick, the full
            // IRI of which is
            ...
            // Get hold of the top node in the class hierarchy (containing
            // owl:Thing)
