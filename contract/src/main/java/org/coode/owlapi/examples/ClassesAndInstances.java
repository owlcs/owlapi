...
public class ClassesAndInstances {
    public static void main(String[] args) {
        try {
            // For more information on classes and instances see the OWL 2
            // Primer
            // http://www.w3.org/TR/2009/REC-owl2-primer-20091027/#Classes_and_Instances
            // In order to say that an individual is an instance of a class (in
            // an ontology), we can add a ClassAssertion
            // to the ontology.
            // For example, suppose we wanted to specify that :Mary is an
            // instance of the class :Person.
            // First we need to obtain the individual :Mary and the class
            // :Person
            ...
            // Now create a ClassAssertion to specify that :Mary is an instance
            // of :Person
