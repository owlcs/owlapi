...
public class BundleIsLoadableTest {
    ...
    @Test
    public void startBundle() throws MalformedURLException, BundleException, ClassNotFoundException {
        ...
        File file = new File("target/owlapi-osgidistribution-4.0.2-SNAPSHOT.jar");
