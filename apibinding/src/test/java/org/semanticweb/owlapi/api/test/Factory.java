...
public class Factory {
	public static
	final String SYSTEM_PARAM_NAME = "OntologyManagerFactory";
	private static OWLOntologyManagerFactory factory;
	static {
		String factoryName = System.getProperty(SYSTEM_PARAM_NAME);
        if (factoryName == null) {
        	System.out.println("Factory: using default OWLManager. To change this, set the "+SYSTEM_PARAM_NAME+" to the class name for the alternate factory");
