...
public class HasKeyAnnotatedTestCase extends AbstractAxiomsRoundTrippingTestCase {
    ...
    protected Set<? extends OWLAxiom> createAxioms() {
        ...
        OWLObjectPropertyExpression p1 = getOWLObjectProperty("p1");
        OWLObjectPropertyExpression p2 = getOWLObjectProperty("p2");
        OWLObjectPropertyExpression p3 = getOWLObjectProperty("p3");
