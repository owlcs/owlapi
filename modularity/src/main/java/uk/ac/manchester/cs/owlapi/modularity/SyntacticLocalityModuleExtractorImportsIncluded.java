...
// */
//public class SyntacticLocalityModuleExtractorImportsIncluded implements OntologySegmenter {
//
//    /**
...
//         */
//        public OntologyAxiomSet(Set<OWLLogicalAxiom> axs) {
//            ax = axs.toArray(new OWLLogicalAxiom[axs.size()]);
//        }
//
//
//        /**
...
//         */
//        public OWLLogicalAxiom getAxiom(int i) {
//            return ax[i];
//        }
//
//
...
//         */
//        public OWLLogicalAxiom[] getAllAxioms() {
//        	OWLLogicalAxiom[] toReturn=new OWLLogicalAxiom[ax.length];
...
//         */
//        public Set<OWLLogicalAxiom> getAxiomSet(boolean[] isIn) {
//            HashSet<OWLLogicalAxiom> gas = new HashSet<OWLLogicalAxiom>();
...
//         */
//        public Set<OWLLogicalAxiom> toSet(boolean[] subset) {
//            HashSet<OWLLogicalAxiom> axs = new HashSet<OWLLogicalAxiom>();
//            for (int i = 0; i < ax.length; i++) {
//                if (subset[i]) {
//                    axs.add(ax[i]);
//                }
...
//     */
//    public SyntacticLocalityModuleExtractorImportsIncluded(OWLOntologyManager man,  Set<OWLOntology> ontologies, Set<OWLLogicalAxiom> axs, ModuleType moduleType) {
//        setModuleType(moduleType);
//
//        manager = man;
//
//        ontologyClosure=ontologies;
...
//     */
//
//    Set<OWLAxiom> enrich(Set<OWLLogicalAxiom> module, Set<OWLEntity> sig, boolean verbose) {
...
//            	for(OWLOntology ontology:ontologyClosure) {
...
//        String uri = manager.getOntologyDocumentIRI(mainOntology).toString() + "#" ;
...
//        Set<OWLLogicalAxiom> moduleAsSet = ontologyAxiomSet.toSet(module);
...
//                }
//                Set<OWLLogicalAxiom> moduleAsSet = ontologyAxiomSet.toSet(subOnt);
