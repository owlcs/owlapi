...
import org.semanticweb.owlapi6.utilities.OWLAPIPreconditions;
import org.semanticweb.owlapi6.utility.OWLEntityCollector;
import org.slf4j.Logger;
import org.slf4j.LoggerFactory;

import com.clarkparsia.owlapi6.explanation.util.ExplanationProgressMonitor;
import com.clarkparsia.owlapi6.explanation.util.OntologyUtils;
import com.clarkparsia.owlapi6.explanation.util.SilentExplanationProgressMonitor;
...
public class HSTExplanationGenerator implements MultipleExplanationGenerator {
     ...
     */
    private static List<OWLAxiom> getOrderedMUPS(List<OWLAxiom> mups, Set<Set<OWLAxiom>> allMups) {
    ...
    private void constructHittingSetTree(OWLClassExpression unsatClass, Set<OWLAxiom> mups,
        ...
        while (!orderedMups.isEmpty()) {
            ...
            if (!earlyTermination) {
                recurse(unsatClass, allMups, satPaths, currentPathContents, maxExplanations,
                    orderedMups, axiom);
            }
    ...
    private void recurse(OWLClassExpression unsatClass, Set<Set<OWLAxiom>> allMups,
        ...
        if (newMUPS.isEmpty()) {
            ...
            getOrderedMUPS(orderedMups, allMups);
        }
    }
