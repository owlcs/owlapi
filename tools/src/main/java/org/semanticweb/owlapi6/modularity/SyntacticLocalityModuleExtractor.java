...
public class SyntacticLocalityModuleExtractor implements OntologySegmenter {
     ...
     * @param moduleType
     *        the type of module this extractor will construct
     * @param excludeAssertions
     *        true if assertions should be excluded
     */
    public SyntacticLocalityModuleExtractor(OWLOntologyManager man, Stream<OWLAxiom> axs, ModuleType moduleType,
     ...
     *        the manager for the associated ontology
     * @param config
     *        config object to access configuration
     * @param axs
     *        the subset of the ontology as a set of axioms
     * @param moduleType
     *        the type of module this extractor will construct
     ...
     *        true if assertions should be excluded
     */
    public SyntacticLocalityModuleExtractor(OWLOntologyManager man, OntologyConfigurator config, Stream<OWLAxiom> axs,
        ...
        Predicate<OWLAxiom> filter = ax -> excludeAssertions ? !AxiomType.ABoxAxiomTypes.contains(ax.getAxiomType())
            : true;
