...
/**
 * An ontology set provider which provides a singleton set - i.e. a set containing just one
 * ontology.
 *
...
public class OWLOntologySingletonSetProvider implements OWLOntologySetProvider {
    ...
    /**
     * Constructs an {@code OWLOntologySingletonSetProvider} which provides a singleton set contain
