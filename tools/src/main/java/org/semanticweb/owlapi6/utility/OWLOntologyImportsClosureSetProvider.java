...
import org.semanticweb.owlapi6.model.OWLOntologySetProvider;

/**
 * An {@code OWLOntologySetProvider} which provides a set of ontologies which correspond to the
 * imports closure of a given ontology. Note that the set of provided ontologies will be updated if
 * the imports closure gets updated.
 *
