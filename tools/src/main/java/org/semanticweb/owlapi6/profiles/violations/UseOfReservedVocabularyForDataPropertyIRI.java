...
package org.semanticweb.owlapi6.profiles.violations;
...
import org.semanticweb.owlapi6.profiles.OWLProfileViolationVisitor;
...
public class UseOfReservedVocabularyForDataPropertyIRI extends OWLProfileViolation {
     ...
     */
    public UseOfReservedVocabularyForDataPropertyIRI(OWLOntology ontology, @Nullable OWLAxiom axiom,
    ...
    public String toString() {
        return toString("Use of reserved vocabulary for data property IRI: %s", getExpression());
    }
}
