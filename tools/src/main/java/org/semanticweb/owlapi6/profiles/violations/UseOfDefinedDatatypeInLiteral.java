...
public class UseOfDefinedDatatypeInLiteral extends OWLProfileViolation {
     ...
     */
    public UseOfDefinedDatatypeInLiteral(OWLOntology ontology, @Nullable OWLAxiom axiom,
        OWLLiteral literal) {
    ...
    public String toString() {
        return toString("Use of defined datatype in datatype restriction %s", getExpression());
    }
}
