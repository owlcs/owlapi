...
public class DebuggerClassExpressionGenerator implements OWLAxiomVisitor {
  ...
  public void visit(OWLSubClassOfAxiom axiom) {
    ...
    desc = dataFactory
        .getOWLObjectIntersectionOf(CollectionFactory.createSet(axiom.getSubClass(), complement));
  }

  @Override
  public void visit(OWLDataPropertyDomainAxiom axiom) {
    OWLClassExpression sub = dataFactory.getOWLDataSomeValuesFrom(axiom.getProperty(), dataFactory
        .getTopDatatype());
  ...
  public void visit(OWLObjectPropertyRangeAxiom axiom) {
    ...
    OWLClassExpression sup = dataFactory
  ...
  public void visit(OWLEquivalentClassesAxiom axiom) {
    if (axiom.classExpressions().count() == 2 && contains(axiom.classExpressions(),
