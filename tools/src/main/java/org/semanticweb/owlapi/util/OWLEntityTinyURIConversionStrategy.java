...
/**
 * Provides an entity URI conversion strategy which converts entity URIs to a common base and
 * alpha-numeric fragment. The fragment is of the form An, where n is an integer (starting at 1),
 * and A is a string which depends on the type of entity:
 * <ul>
...
public class OWLEntityTinyURIConversionStrategy implements OWLEntityURIConverterStrategy {
    ...
    /**
     * Constructs an entity URI converter strategy, where the specified base is used for the base of
     * the URIs generated by the generator.
     *
