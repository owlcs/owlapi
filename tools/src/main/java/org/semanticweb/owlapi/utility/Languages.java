...
public enum Languages {
    ...
    /** ALC language */         ALC("ALC", ALE, C, U, RRESTR),
    ...
    /** ALCRr language. */    ALCRr("ALCRr",ALC, Rr),
    /** ALCRrD language. */    ALCRrD("ALCRrD",ALC, Rr, D),
    /** ALCRrF language. */    ALCRrF("ALCRrF",ALC, Rr, F),
    /** ALCRrFD language. */    ALCRrFD("ALCRrFD",ALC, Rr, F, D),
    /** ALCRrN language. */    ALCRrN("ALCRrN",ALC, Rr, N),
    /** ALCRrND language. */    ALCRrND("ALCRrND",ALC, Rr, N, D),
    /** ALCRrQ language. */    ALCRrQ("ALCRrQ",ALC, Rr, Q),
    /** ALCRrQD language. */    ALCRrQD("ALCRrQD",ALC, Rr, Q, D),
    /** ALCRrO language. */    ALCRrO("ALCRrO",ALC, Rr, O),
    /** ALCRrOD language. */    ALCRrOD("ALCRrOD",ALC, Rr, O, D),
    /** ALCRrOF language. */    ALCRrOF("ALCRrOF",ALC, Rr, O, F),
    /** ALCRrOFD language. */    ALCRrOFD("ALCRrOFD",ALC, Rr, O, F, D),
    /** ALCRrON language. */    ALCRrON("ALCRrON",ALC, Rr, O, N),
    /** ALCRrOND language. */    ALCRrOND("ALCRrOND",ALC, Rr, O, N, D),
    /** ALCRrOQ language. */    ALCRrOQ("ALCRrOQ",ALC, Rr, O, Q),
    /** ALCRrOQD language. */    ALCRrOQD("ALCRrOQD",ALC, Rr, O, Q, D),
    ...
    /** SRr language. */    SRr("SRr",S, Rr),
    /** SRrD language. */    SRrD("SRrD",S, Rr, D),
    /** SRrF language. */    SRrF("SRrF",S, Rr, F),
    /** SRrFD language. */    SRrFD("SRrFD",S, Rr, F, D),
    /** SRrN language. */    SRrN("SRrN",S, Rr, N),
    /** SRrND language. */    SRrND("SRrND",S, Rr, N, D),
    /** SRrQ language. */    SRrQ("SRrQ",S, Rr, Q),
    /** SRrQD language. */    SRrQD("SRrQD",S, Rr, Q, D),
    /** SRrO language. */    SRrO("SRrO",S, Rr, O),
    /** SRrOD language. */    SRrOD("SRrOD",S, Rr, O, D),
    /** SRrOF language. */    SRrOF("SRrOF",S, Rr, O, F),
    /** SRrOFD language. */    SRrOFD("SRrOFD",S, Rr, O, F, D),
    /** SRrON language. */    SRrON("SRrON",S, Rr, O, N),
    /** SRrOND language. */    SRrOND("SRrOND",S, Rr, O, N, D),
    /** SRrOQ language. */    SRrOQ("SRrOQ",S, Rr, O, Q),
    /** SRrOQD language. */    SRrOQD("SRrOQD",S, Rr, O, Q, D),
    ...
    /** SROIQ language. */    SROIQ("SROIQ",S, R, O, I, Q),
    /** SROIQD language. */    SROIQD("SROIQD",S, R, O, I, Q, D),
    /** EL++ - Alias ELRO. */   ELPLUSPLUS("EL++", CINT, E, R, O, TRAN, D);
    //@formatter:on
