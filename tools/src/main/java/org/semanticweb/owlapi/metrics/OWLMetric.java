...
public interface OWLMetric<M> {
   ...
   *
   * @return {@code true} if the imports closure of the current ontology is taken into account when
   * computing the value of this metric, or {@code false} if the imports closure isn't taken into
