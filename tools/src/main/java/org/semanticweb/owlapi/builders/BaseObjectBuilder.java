 ...
 */
public abstract class BaseObjectBuilder<T extends OWLObject, B>
    extends BaseObjectPropertyBuilder<T, B> implements SettableRange<OWLClassExpression, B> {
     ...
     */
    protected BaseObjectBuilder(OWLDataFactory df) {
        super(df);
    }
