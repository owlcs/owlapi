...
/**
 * Interface for classes that test whether an axiom is local with respect to a
 * signature.
 *
...
public interface LocalityEvaluator {
	 ...
	 * For efficient computation, the given collection should run
	 * {@link Collection#contains(Object)} in O(1).
	 *
	 ...
	 *         <code>false</code> otherwise
	 */
	default boolean isLocal(final OWLAxiom axiom, final Stream<OWLEntity> signature) {
