...
public interface OntologySegmenter {
    ...
    /**
     * Returns a set of axioms that is a segment of the ontology associated with this segmenter.
     * This segment is determined by a seed signature (set of entities), which is the specified
     * signature plus possibly all superclasses and/or subclasses of the classes therein.
     ...
     */
    @Nonnull
    Set<OWLAxiom> extract(@Nonnull Set<OWLEntity> signature, int superClassLevel, int subClassLevel,
    ...
    /**
     * Returns an ontology that is a segment of the ontology associated with this segmenter. This
     * segment is determined by a seed signature (set of entities), which is the specified signature
     * plus possibly all superclasses and/or subclasses of the classes therein. Sub-/superclasses
