...
public interface OntologySegmenter {
   ...
   * subClassLevel:<br> Let this value be k. If k gerater than 0, then all classes are included that
   * are (direct or indirect) super-/subclasses of some class in signature, with a distance of at
   * most k to this class in the class hierarchy computed by reasoner. If k = 0, then no
   * super-/subclasses are added. If k lesser than 0, then all direct and indirect super-/subclasses
   ...
   * superClassLevel, subClassLevel:<br> Let this value be k. If k gerater than 0, then all classes
   * are included that are (direct or indirect) super-/subclasses of some class in signature, with a
   * distance of at most k to this class in the class hierarchy computed by reasoner. If k = 0, then
