...
public class OWLOntologyAccessorsTestCase extends AbstractOWLAPITestCase {
	public void testAccessors() throws Exception {
		...
		// Class axioms
		logicalAxioms.add(df.getOWLSubClassOfAxiom(getOWLClass("A"),
				getOWLClass("B")));
		logicalAxioms.add(df.getOWLEquivalentClassesAxiom(getOWLClass("C"),
				getOWLClass("D")));
		logicalAxioms.add(df.getOWLDisjointClassesAxiom(getOWLClass("D"),
				getOWLClass("E")));
		// Object property
		OWLObjectProperty propP = getOWLObjectProperty("p");
		logicalAxioms.add(df.getOWLSubObjectPropertyOfAxiom(propP,
				getOWLObjectProperty("q")));
		logicalAxioms.add(df.getOWLEquivalentObjectPropertiesAxiom(propP,
				getOWLObjectProperty("q")));
		logicalAxioms.add(df.getOWLDisjointObjectPropertiesAxiom(propP,
				getOWLObjectProperty("q")));
		logicalAxioms.add(df.getOWLObjectPropertyDomainAxiom(propP,
				getOWLClass("A")));
		logicalAxioms.add(df.getOWLObjectPropertyRangeAxiom(propP,
				getOWLClass("A")));
		logicalAxioms.add(df.getOWLObjectPropertyAssertionAxiom(propP,
				getOWLIndividual("a"), getOWLIndividual("b")));
		...
		logicalAxioms.add(df.getOWLSubDataPropertyOfAxiom(propD,
				getOWLDataProperty("q")));
		logicalAxioms.add(df.getOWLEquivalentDataPropertiesAxiom(propD,
				getOWLDataProperty("q")));
		logicalAxioms.add(df.getOWLDisjointDataPropertiesAxiom(propD,
				getOWLDataProperty("q")));
		logicalAxioms.add(df.getOWLDataPropertyDomainAxiom(propD,
				getOWLClass("A")));
		logicalAxioms.add(df.getOWLDataPropertyRangeAxiom(propD, df
				.getIntegerOWLDatatype()));
		logicalAxioms.add(df.getOWLDataPropertyAssertionAxiom(propD,
				getOWLIndividual("a"), df.getOWLLiteral(3)));
