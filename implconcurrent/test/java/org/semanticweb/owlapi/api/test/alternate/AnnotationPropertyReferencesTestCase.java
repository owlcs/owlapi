...
public class AnnotationPropertyReferencesTestCase extends
	...
	public void testContainsReferenceForAnnotationAssertion() throws Exception {
		...
		OWLAnnotationAssertionAxiom ax = getFactory()
				.getOWLAnnotationAssertionAxiom(ap, subject, val);
	...
	public void testContainsReferenceForAxiomAnnotation() throws Exception {
		...
		OWLSubClassOfAxiom ax = getFactory().getOWLSubClassOfAxiom(
				getOWLClass("A"), getOWLClass("B"), annos);
		OWLOntology ont = getOWLOntology("Ont");
		getManager().addAxiom(ont, ax);
