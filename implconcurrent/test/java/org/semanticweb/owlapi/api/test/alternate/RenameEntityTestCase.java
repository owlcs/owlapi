...
public class RenameEntityTestCase extends AbstractOWLAPITestCase {
	public void testRenameClass() throws Exception {
		...
		axioms1.add(getFactory().getOWLObjectPropertyDomainAxiom(propA,
				clsAIRI1));
		axioms1.add(getFactory()
				.getOWLObjectPropertyRangeAxiom(propA, clsAIRI1));
		...
		axioms1.add(getFactory().getOWLAnnotationAssertionAxiom(annoProp,
				clsAIRI1.getIRI(), getFactory().getOWLLiteral("X")));
		...
		axioms2.add(getFactory().getOWLObjectPropertyDomainAxiom(propA,
				clsAIRI2));
		axioms2.add(getFactory()
				.getOWLObjectPropertyRangeAxiom(propA, clsAIRI2));
		...
		axioms2.add(getFactory().getOWLAnnotationAssertionAxiom(annoProp,
				clsAIRI2.getIRI(), getFactory().getOWLLiteral("X")));
		...
		List<OWLOntologyChange> changes2 = entityRenamer.changeIRI(clsAIRI2
				.getIRI(), clsAIRI1.getIRI());
	...
	public void testRenameObjectProperty() throws Exception {
		...
		axioms1.add(getFactory().getOWLEquivalentObjectPropertiesAxiom(propA,
				propB));
		axioms1.add(getFactory().getOWLDisjointObjectPropertiesAxiom(propA,
				propB));
		...
		axioms1.add(getFactory().getOWLInverseFunctionalObjectPropertyAxiom(
				propA));
		...
		axioms1.add(getFactory().getOWLObjectPropertyAssertionAxiom(propA,
				indA, indB));
		axioms1.add(getFactory().getOWLNegativeObjectPropertyAssertionAxiom(
				propA, indA, indB));
		axioms1.add(getFactory().getOWLAnnotationAssertionAxiom(annoProp,
				propA.getIRI(), getFactory().getOWLLiteral("X")));
		getManager().addAxioms(ont, axioms1);
		Set<OWLAxiom> axioms2 = new HashSet<OWLAxiom>();
		axioms2.add(getFactory().getOWLSubObjectPropertyOfAxiom(propA2, propB));
		axioms2.add(getFactory().getOWLEquivalentObjectPropertiesAxiom(propA2,
				propB));
		axioms2.add(getFactory().getOWLDisjointObjectPropertiesAxiom(propA2,
				propB));
		...
		axioms2.add(getFactory().getOWLInverseFunctionalObjectPropertyAxiom(
				propA2));
		...
		axioms2.add(getFactory().getOWLObjectPropertyAssertionAxiom(propA2,
				indA, indB));
		axioms2.add(getFactory().getOWLNegativeObjectPropertyAssertionAxiom(
				propA2, indA, indB));
		axioms2.add(getFactory().getOWLAnnotationAssertionAxiom(annoProp,
				propA2.getIRI(), getFactory().getOWLLiteral("X")));
		OWLEntityRenamer entityRenamer = new OWLEntityRenamer(getManager(),
				Collections.singleton(ont));
		List<OWLOntologyChange> changes = entityRenamer.changeIRI(propA, propA2
				.getIRI());
		getManager().applyChanges(changes);
		assertEquals(ont.getAxioms(), axioms2);
		List<OWLOntologyChange> changes2 = entityRenamer.changeIRI(propA2
				.getIRI(), propA.getIRI());
		getManager().applyChanges(changes2);
		assertEquals(ont.getAxioms(), axioms1);
	}
	...
	public void testRenameDataProperty() throws Exception {
		...
		axioms1.add(getFactory().getOWLEquivalentDataPropertiesAxiom(propA,
				propB));
		axioms1.add(getFactory()
				.getOWLDisjointDataPropertiesAxiom(propA, propB));
		axioms1.add(getFactory().getOWLDataPropertyDomainAxiom(propA, clsA));
		axioms1.add(getFactory().getOWLDataPropertyRangeAxiom(propA,
				getFactory().getTopDatatype()));
		axioms1.add(getFactory().getOWLFunctionalDataPropertyAxiom(propA));
		axioms1.add(getFactory().getOWLDataPropertyAssertionAxiom(propA, indA,
				getFactory().getOWLLiteral(33)));
		axioms1.add(getFactory().getOWLNegativeDataPropertyAssertionAxiom(
				propA, indA, getFactory().getOWLLiteral(44)));
		axioms1.add(getFactory().getOWLAnnotationAssertionAxiom(annoProp,
				propA.getIRI(), getFactory().getOWLLiteral("X")));
		getManager().addAxioms(ont, axioms1);
		Set<OWLAxiom> axioms2 = new HashSet<OWLAxiom>();
		axioms2.add(getFactory().getOWLSubDataPropertyOfAxiom(propA2, propB));
		axioms2.add(getFactory().getOWLEquivalentDataPropertiesAxiom(propA2,
				propB));
		axioms2.add(getFactory().getOWLDisjointDataPropertiesAxiom(propA2,
				propB));
		axioms2.add(getFactory().getOWLDataPropertyDomainAxiom(propA2, clsA));
		axioms2.add(getFactory().getOWLDataPropertyRangeAxiom(propA2,
				getFactory().getTopDatatype()));
		axioms2.add(getFactory().getOWLFunctionalDataPropertyAxiom(propA2));
		axioms2.add(getFactory().getOWLDataPropertyAssertionAxiom(propA2, indA,
				getFactory().getOWLLiteral(33)));
		axioms2.add(getFactory().getOWLNegativeDataPropertyAssertionAxiom(
				propA2, indA, getFactory().getOWLLiteral(44)));
		axioms2.add(getFactory().getOWLAnnotationAssertionAxiom(annoProp,
				propA2.getIRI(), getFactory().getOWLLiteral("X")));
		OWLEntityRenamer entityRenamer = new OWLEntityRenamer(getManager(),
				Collections.singleton(ont));
	...
	public void testRenameIndividual() throws Exception {
		...
		axioms1.add(getFactory().getOWLAnnotationAssertionAxiom(annoProp,
				propA.getIRI(), getFactory().getOWLLiteral("X")));
		axioms1.add(getFactory().getOWLObjectPropertyAssertionAxiom(propB,
				indA, indB));
		axioms1.add(getFactory().getOWLNegativeObjectPropertyAssertionAxiom(
				propB, indA, indB));
		getManager().addAxioms(ont, axioms1);
		...
		axioms2.add(getFactory().getOWLDataPropertyAssertionAxiom(propA, indB,
				getFactory().getOWLLiteral(33)));
		axioms2.add(getFactory().getOWLNegativeDataPropertyAssertionAxiom(
				propA, indB, getFactory().getOWLLiteral(44)));
		axioms2.add(getFactory().getOWLAnnotationAssertionAxiom(annoProp,
				propA.getIRI(), getFactory().getOWLLiteral("X")));
		axioms2.add(getFactory().getOWLObjectPropertyAssertionAxiom(propB,
				indB, indB));
		axioms2.add(getFactory().getOWLNegativeObjectPropertyAssertionAxiom(
				propB, indB, indB));
		OWLEntityRenamer entityRenamer = new OWLEntityRenamer(getManager(),
				Collections.singleton(ont));
		List<OWLOntologyChange> changes = entityRenamer.changeIRI(indA, indB
				.getIRI());
		getManager().applyChanges(changes);
		assertEquals(ont.getAxioms(), axioms2);
		List<OWLOntologyChange> changes2 = entityRenamer.changeIRI(indB
				.getIRI(), indA.getIRI());
		getManager().applyChanges(changes2);
		assertEquals(ont.getAxioms(), axioms1);
	}
