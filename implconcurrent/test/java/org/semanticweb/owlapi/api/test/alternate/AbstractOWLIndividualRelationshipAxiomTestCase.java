...
public abstract class AbstractOWLIndividualRelationshipAxiomTestCase<P extends OWLPropertyExpression, O extends OWLObject>
	...
	protected abstract OWLIndividualAxiom createAxiom(OWLIndividual subject,
			P property, O object) throws OWLException;

	@Override
	public void testCreation() throws Exception {
		assertNotNull(createAxiom(createOWLIndividual(), createProperty(),
				createObject()));
	}
	...
	public void testEqualsNegative() throws Exception {
		...
		P property = createProperty();
		O object = createObject();
		OWLIndividualAxiom axiomA = createAxiom(createOWLIndividual(),
				property, object);
		OWLIndividualAxiom axiomB = createAxiom(createOWLIndividual(),
				property, object);
		assertNotEquals(axiomA, axiomB);
		// Different property
		OWLIndividual subject = createOWLIndividual();
		OWLIndividualAxiom axiomC = createAxiom(subject, createProperty(),
				object);
		OWLIndividualAxiom axiomD = createAxiom(subject, createProperty(),
				object);
		assertNotEquals(axiomC, axiomD);
		// Different object
		OWLIndividualAxiom axiomE = createAxiom(subject, property,
				createObject());
		OWLIndividualAxiom axiomF = createAxiom(subject, property,
				createObject());
