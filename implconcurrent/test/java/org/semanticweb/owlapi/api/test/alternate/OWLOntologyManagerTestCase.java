...
public class OWLOntologyManagerTestCase extends TestCase {
	...
	public void testCreateOntologyWithIRIAndVersionIRI() throws Exception {
		...
		IRI ontologyIRI = IRI
				.create("http://www.semanticweb.org/ontologies/ontology");
		IRI versionIRI = IRI
				.create("http://www.semanticweb.org/ontologies/ontology/version");
	...
	public void testCreateDuplicateOntologyWithIRI() throws Exception {
		try {
			...
			System.out.println("Caught OWLOntologyAlreadyExistsException: "
					+ e.getMessage());
		}
	}
	...
	public void testCreateDuplicatedDocumentIRI() throws Exception {
		try {
			...
			IRI ontologyIRI2 = IRI
					.create("http://www.semanticweb.org/ontologies/ontology2");
			IRI documentIRI = IRI.create("file:documentIRI");
			...
			System.out
					.println("Caught OWLOntologyDocumentAlreadyExistsException: "
							+ e.getMessage());
		}
	}
}
