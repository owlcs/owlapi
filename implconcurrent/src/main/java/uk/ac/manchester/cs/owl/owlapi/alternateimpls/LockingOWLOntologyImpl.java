 ...
 * 26-Oct-2006<br><br>
 */
public class LockingOWLOntologyImpl extends OWLObjectImpl implements OWLMutableOntology {
...
//    private Map<IRI, Set<OWLAnnotationAxiom>> annotationAxiomsByAnnotationURI = createMap();
    ...
    private class OWLEntityReferenceChecker implements OWLEntityVisitor {
        ...
        public void visit(OWLClass cls) {
            ref = LockingOWLOntologyImpl.this.containsReference(cls);
        }


        public void visit(OWLDatatype datatype) {
            ref = LockingOWLOntologyImpl.this.containsReference(datatype);
        }


        public void visit(OWLNamedIndividual individual) {
            ref = LockingOWLOntologyImpl.this.containsReference(individual);
        }


        public void visit(OWLDataProperty property) {
            ref = LockingOWLOntologyImpl.this.containsReference(property);
        }
