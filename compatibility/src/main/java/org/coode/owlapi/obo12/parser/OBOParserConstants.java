...
interface OBOParserConstants {
    ...
    String[] tokenImage = {"<EOF>", "<token of kind 1>", "<LINE_COMMENTED_OUT>", "\"[\"",
                    "<STANZA_TYPE>", "\"]\"", "<TAG_NAME>", "<TAG_COLON>", "\"\\\"\"",
                    "<QUOTED_STRING>", "<QUOTED_STRING_DBL_QUOTE_TERMINATOR>",
                    "<QUOTED_STRING_NEW_LINE_TERMINATOR>", "<STRING>", "<TAG_VALUE_WS>",
                    "<TAG_END>", "\"!\"", "<COMMENT>", "<COMMENT_END>", "<ERROR>",};
