...
public enum OBOVocabulary implements HasIRI {
  ...
  private static final List<OBOVocabulary> typeDefStanzaTags = Arrays
      .asList(ID, NAME, NAMESPACE, ALT_ID, DEF,
          ...
          IS_SYMMETRIC,
          IS_TRANSITIVE, IS_A, INVERSE, TRANSITIVE_OVER, RELATIONSHIP, IS_METADATA_TAG, IS_OBSOLETE,
          REPLACED_BY,
          CONSIDER);
   ...
   * @param idSpaceManager An {@link IDSpaceManager} which can be used to customise the IRI prefixes
