...
public class Example7 {
    ...
    public static void main(String[] args) {
        try {
            ...
            OWLDataRange intGreaterThan18 = factory.getDatatypeRestriction(intDatatype,
                    facet,
                    eighteenConstant);
            // Now we can use this in our datatype restriction on hasAge
            OWLClassExpression thingsWithAgeGreaterOrEqualTo18 = factory.getDataSomeValuesFrom(hasAge, intGreaterThan18);
            ...
            OWLSubClassOfAxiom ax = factory.getSubClassOf(adult, thingsWithAgeGreaterOrEqualTo18);
